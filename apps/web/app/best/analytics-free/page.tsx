...
export const metadata: Metadata = {
  title: 'Best Free Analytics Software (November 30, 2025) | Harbor',
  ...
  "@graph": [
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://useharbor.io/best/analytics-free"
      }
    },
    {
      "@type": "ItemList",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-300">
              Discover the top free analytics tools with generous free tiers. Perfect for startups and small teams.
            </p>
          </header>
