...
// Alternative to: Wellthy Therapeutics (acquired by TruDoc)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Best Wellthy Therapeutics (acquired by TruDoc) Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Wellthy Therapeutics (acquired by TruDoc) for Digital Health. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Wellthy Therapeutics (acquired by TruDoc) Alternatives',
    description: 'Top alternatives to Wellthy Therapeutics (acquired by TruDoc) for Digital Health.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/wellthy-therapeutics-acquired-by-trudoc#article",
      "headline": "Best Wellthy Therapeutics (acquired by TruDoc) Alternatives",
      "description": "Top alternatives to Wellthy Therapeutics (acquired by TruDoc) for Digital Health. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/wellthy-therapeutics-acquired-by-trudoc#list",
      "name": "Wellthy Therapeutics (acquired by TruDoc) Alternatives",
      "numberOfItems": 3,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        },
        {
          ...
          "item": {
            ...
            "description": "Leading provider of evidence-based digital health solutions for substance use disorder.",
            "applicationCategory": "Digital Health"
          }
        }
      ]
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Best Wellthy Therapeutics (acquired by TruDoc) Alternatives
            </h1>
            <p className="text-lg text-gray-300">
              Looking for an alternative to Wellthy Therapeutics (acquired by TruDoc)? Here are the top Digital Health solutions that compete with Wellthy Therapeutics (acquired by TruDoc), 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/wellthy-therapeutics-acquired-by-trudoc" className="text-[#FF6B4A] hover:underline">Wellthy Therapeutics (acquired by TruDoc) profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/wellthy-therapeutics-acquired-by-trudoc-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Wellthy Therapeutics (acquired by TruDoc) &rarr;
                    </Link>
                  </div>
                </article>
              ))}
