...
export const metadata: Metadata = {
  title: 'Best Cobalt Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Cobalt for Cybersecurity. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Cobalt Alternatives',
    description: 'Top alternatives to Cobalt for Cybersecurity.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/cobalt#article",
      "headline": "Best Cobalt Alternatives",
      "description": "Top alternatives to Cobalt for Cybersecurity. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/cobalt#list",
      "name": "Cobalt Alternatives",
      "numberOfItems": 15,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-300">
              Looking for an alternative to Cobalt? Here are the top Cybersecurity solutions that compete with Cobalt, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/cobalt" className="text-[#FF6B4A] hover:underline">Cobalt profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/cobalt-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Cobalt &rarr;
                    </Link>
                  </div>
                </article>
              ))}
