...
export const metadata: Metadata = {
  title: 'Best Data Works Alternatives (November 30, 2025) | Harbor',
...
const schemaOrg = {
  ...
  "@graph": [
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/data-works#list",
      "name": "Data Works Alternatives",
      "numberOfItems": 4,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-300">
              Looking for an alternative to Data Works? Here are the top Inventory Management solutions that compete with Data Works, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/data-works" className="text-[#FF6B4A] hover:underline">Data Works profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/data-works-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Data Works &rarr;
                    </Link>
                  </div>
                </article>
              ))}
