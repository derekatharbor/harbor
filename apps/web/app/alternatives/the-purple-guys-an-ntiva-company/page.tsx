...
// Alternative to: The Purple Guys, An Ntiva Company

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Best The Purple Guys, An Ntiva Company Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to The Purple Guys, An Ntiva Company for IT Services. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best The Purple Guys, An Ntiva Company Alternatives',
    description: 'Top alternatives to The Purple Guys, An Ntiva Company for IT Services.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/the-purple-guys-an-ntiva-company#article",
      "headline": "Best The Purple Guys, An Ntiva Company Alternatives",
      "description": "Top alternatives to The Purple Guys, An Ntiva Company for IT Services. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/the-purple-guys-an-ntiva-company#list",
      "name": "The Purple Guys, An Ntiva Company Alternatives",
      "numberOfItems": 15,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Best The Purple Guys, An Ntiva Company Alternatives
            </h1>
            <p className="text-lg text-gray-300">
              Looking for an alternative to The Purple Guys, An Ntiva Company? Here are the top IT Services solutions that compete with The Purple Guys, An Ntiva Company, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/the-purple-guys-an-ntiva-company" className="text-[#FF6B4A] hover:underline">The Purple Guys, An Ntiva Company profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/the-purple-guys-an-ntiva-company-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with The Purple Guys, An Ntiva Company &rarr;
                    </Link>
                  </div>
                </article>
              ))}
