...
// Alternative to: Zwift

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Best Zwift Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Zwift for Fitness. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Zwift Alternatives',
    description: 'Top alternatives to Zwift for Fitness.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/zwift#article",
      "headline": "Best Zwift Alternatives",
      "description": "Top alternatives to Zwift for Fitness. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/zwift#list",
      "name": "Zwift Alternatives",
      "numberOfItems": 3,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-300">
              Looking for an alternative to Zwift? Here are the top Fitness solutions that compete with Zwift, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/zwift" className="text-[#FF6B4A] hover:underline">Zwift profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/zwift-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Zwift &rarr;
                    </Link>
                  </div>
                </article>
              ))}
