...
// Alternative to: Incode

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Best Incode Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Incode for Identity Verification. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Incode Alternatives',
    description: 'Top alternatives to Incode for Identity Verification.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/incode#article",
      "headline": "Best Incode Alternatives",
      "description": "Top alternatives to Incode for Identity Verification. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/incode#list",
      "name": "Incode Alternatives",
      "numberOfItems": 4,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Best Incode Alternatives
            </h1>
            <p className="text-lg text-gray-300">
              Looking for an alternative to Incode? Here are the top Identity Verification solutions that compete with Incode, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/incode" className="text-[#FF6B4A] hover:underline">Incode profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/incode-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Incode &rarr;
                    </Link>
                  </div>
                </article>
              ))}
