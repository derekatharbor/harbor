...
export const metadata: Metadata = {
  title: 'Best Cii Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Cii for IT Services. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Cii Alternatives',
    description: 'Top alternatives to Cii for IT Services.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/cii#article",
      "headline": "Best Cii Alternatives",
      "description": "Top alternatives to Cii for IT Services. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/cii#list",
      "name": "Cii Alternatives",
      "numberOfItems": 15,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Best Cii Alternatives
            </h1>
            <p className="text-lg text-gray-300">
              Looking for an alternative to Cii? Here are the top IT Services solutions that compete with Cii, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/cii" className="text-[#FF6B4A] hover:underline">Cii profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/cii-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Cii &rarr;
                    </Link>
                  </div>
                </article>
              ))}
