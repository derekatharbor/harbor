...
export const metadata: Metadata = {
  title: 'Best Scratchpad Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Scratchpad for Sales Technology. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Scratchpad Alternatives',
    description: 'Top alternatives to Scratchpad for Sales Technology.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/scratchpad#article",
      "headline": "Best Scratchpad Alternatives",
      "description": "Top alternatives to Scratchpad for Sales Technology. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/scratchpad#list",
      "name": "Scratchpad Alternatives",
      "numberOfItems": 8,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <p className="text-lg text-gray-300">
              Looking for an alternative to Scratchpad? Here are the top Sales Technology solutions that compete with Scratchpad, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/scratchpad" className="text-[#FF6B4A] hover:underline">Scratchpad profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/scratchpad-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Scratchpad &rarr;
                    </Link>
                  </div>
                </article>
              ))}
