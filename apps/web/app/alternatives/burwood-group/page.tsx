...
// Alternative to: Burwood Group

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Best Burwood Group Alternatives (November 30, 2025) | Harbor',
  description: 'Top alternatives to Burwood Group for IT Consulting. Compare features, pricing, and integrations.',
  openGraph: {
    title: 'Best Burwood Group Alternatives',
    description: 'Top alternatives to Burwood Group for IT Consulting.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://useharbor.io/alternatives/burwood-group#article",
      "headline": "Best Burwood Group Alternatives",
      "description": "Top alternatives to Burwood Group for IT Consulting. Compare features, pricing, and integrations.",
    ...
    {
      "@type": "ItemList",
      "@id": "https://useharbor.io/alternatives/burwood-group#list",
      "name": "Burwood Group Alternatives",
      "numberOfItems": 15,
      "itemListElement": [
        {
          "@type": "ListItem",
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <header className="mb-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Best Burwood Group Alternatives
            </h1>
            <p className="text-lg text-gray-300">
              Looking for an alternative to Burwood Group? Here are the top IT Consulting solutions that compete with Burwood Group, 
              ranked by visibility and feature coverage.
            </p>
            <p className="mt-4 text-sm text-gray-400">
              Compare with: <Link href="/brands/burwood-group" className="text-[#FF6B4A] hover:underline">Burwood Group profile &rarr;</Link>
            </p>
          </header>
              ...
              {alternatives.map((alt, index) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex justify-between items-center">
                    ...
                    <Link
                      href={`/compare/burwood-group-vs-${alt.slug}`}
                      className="text-[#2979FF] hover:underline text-sm"
                    >
                      Compare with Burwood Group &rarr;
                    </Link>
                  </div>
                </article>
              ))}
