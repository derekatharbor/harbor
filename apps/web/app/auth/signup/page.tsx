...
// Split-screen signup - white desktop, dark mobile with marquee
        ...
        <div className="w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="text-black/60">Start tracking your AI visibility in minutes</p>
            </div>
              ...
              <div>
                ...
                {showRequirements && (
                  <div className="flex items-center gap-4 mt-2">
                    <div className={`flex items-center gap-1.5 text-xs ${hasMinLength ? 'text-emerald-600' : 'text-black/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>8+ chars</span>
                    </div>
                    <div className={`flex items-center gap-1.5 text-xs ${hasUppercase ? 'text-emerald-600' : 'text-black/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>Uppercase</span>
                    </div>
                    <div className={`flex items-center gap-1.5 text-xs ${hasNumber ? 'text-emerald-600' : 'text-black/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>Number</span>
                    </div>
                  </div>
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="text-white/60">Start tracking your AI visibility in minutes</p>
            </div>
