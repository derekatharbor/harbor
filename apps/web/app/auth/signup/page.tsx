      ...
      <div className="hidden lg:flex min-h-screen bg-white">
        ...
        <div className="w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-2xl font-semibold text-black mb-2 font-source-sans">Create your account</h1>
              <p className="text-black/60 font-source-code">Start tracking your AI visibility in minutes</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div>
                ...
                {showRequirements && (
                  <div className="flex items-center gap-4 mt-2">
                    <div className={`flex items-center gap-1.5 text-xs font-source-code ${hasMinLength ? 'text-emerald-600' : 'text-black/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>8+ chars</span>
                    </div>
                    <div className={`flex items-center gap-1.5 text-xs font-source-code ${hasUppercase ? 'text-emerald-600' : 'text-black/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>Uppercase</span>
                    </div>
                    <div className={`flex items-center gap-1.5 text-xs font-source-code ${hasNumber ? 'text-emerald-600' : 'text-black/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>Number</span>
                    </div>
                  </div>
              ...
              <p className="text-xs text-black/40 text-center font-source-code">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8 text-center">
              <h1 className="text-2xl font-semibold text-white mb-2 font-source-sans">Create your account</h1>
              <p className="text-white/60 font-source-code">Start tracking your AI visibility in minutes</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div>
                ...
                {showRequirements && (
                  <div className="flex items-center gap-4 mt-2">
                    <div className={`flex items-center gap-1.5 text-xs font-source-code ${hasMinLength ? 'text-emerald-400' : 'text-white/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>8+ chars</span>
                    </div>
                    <div className={`flex items-center gap-1.5 text-xs font-source-code ${hasUppercase ? 'text-emerald-400' : 'text-white/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>Uppercase</span>
                    </div>
                    <div className={`flex items-center gap-1.5 text-xs font-source-code ${hasNumber ? 'text-emerald-400' : 'text-white/30'}`}>
                      <Check className="w-3 h-3" />
                      <span>Number</span>
                    </div>
                  </div>
              ...
              <p className="text-xs text-white/30 text-center font-source-code">
                By creating an account, you agree to our{' '}
