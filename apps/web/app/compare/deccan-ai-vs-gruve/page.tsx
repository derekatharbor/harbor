...
// Generated: 2025-11-30T19:44:54.040Z
// Comparing: Deccan AI vs Gruve

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Deccan AI vs Gruve (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Deccan AI and Gruve. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Deccan AI vs Gruve',
    description: 'Detailed comparison of Deccan AI and Gruve.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.040Z',
    modifiedTime: '2025-11-30T19:44:54.040Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/deccan-ai-vs-gruve#article",
  "headline": "Deccan AI vs Gruve: Comparison",
  "description": "Detailed comparison of Deccan AI and Gruve. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.040Z",
  "dateModified": "2025-11-30T19:44:54.040Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.040Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.040Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
