...
// Comparing: Hedera vs Solana Labs

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Hedera vs Solana Labs (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Hedera and Solana Labs. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Hedera vs Solana Labs',
    description: 'Detailed comparison of Hedera and Solana Labs.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hedera-vs-solana-labs#article",
  "headline": "Hedera vs Solana Labs: Comparison",
  "description": "Detailed comparison of Hedera and Solana Labs. Features, pricing, and integrations compared side-by-side.",
