...
// Comparing: Cprime, Inc vs Project Insight

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cprime, Inc vs Project Insight (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cprime, Inc and Project Insight. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cprime, Inc vs Project Insight',
    description: 'Detailed comparison of Cprime, Inc and Project Insight.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cprime-inc-vs-project-insight#article",
  "headline": "Cprime, Inc vs Project Insight: Comparison",
  "description": "Detailed comparison of Cprime, Inc and Project Insight. Features, pricing, and integrations compared side-by-side.",
