...
// Generated: 2025-11-30T19:44:53.438Z
// Comparing: Olark Accessible AI Chatbots vs Re:amaze

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Olark Accessible AI Chatbots vs Re:amaze (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Olark Accessible AI Chatbots and Re:amaze. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Olark Accessible AI Chatbots vs Re:amaze',
    description: 'Detailed comparison of Olark Accessible AI Chatbots and Re:amaze.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.438Z',
    modifiedTime: '2025-11-30T19:44:53.438Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/olark-accessible-ai-chatbots-vs-reamaze#article",
  "headline": "Olark Accessible AI Chatbots vs Re:amaze: Comparison",
  "description": "Detailed comparison of Olark Accessible AI Chatbots and Re:amaze. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.438Z",
  "dateModified": "2025-11-30T19:44:53.438Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.438Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.438Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
