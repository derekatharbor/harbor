...
// Generated: 2025-11-30T19:36:57.585Z
// Comparing: Kaia Health vs Wellthy Therapeutics (acquired by TruDoc)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Kaia Health vs Wellthy Therapeutics (acquired by TruDoc) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Kaia Health and Wellthy Therapeutics (acquired by TruDoc). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Kaia Health vs Wellthy Therapeutics (acquired by TruDoc)',
    description: 'Detailed comparison of Kaia Health and Wellthy Therapeutics (acquired by TruDoc).',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.585Z',
    modifiedTime: '2025-11-30T19:36:57.585Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/kaia-health-vs-wellthy-therapeutics-acquired-by-trudoc#article",
  "headline": "Kaia Health vs Wellthy Therapeutics (acquired by TruDoc): Comparison",
  "description": "Detailed comparison of Kaia Health and Wellthy Therapeutics (acquired by TruDoc). Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.585Z",
  "dateModified": "2025-11-30T19:36:57.585Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.585Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.585Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
