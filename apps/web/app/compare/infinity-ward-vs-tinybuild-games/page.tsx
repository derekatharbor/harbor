...
// Comparing: Infinity Ward vs tinyBuild GAMES

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Infinity Ward vs tinyBuild GAMES (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Infinity Ward and tinyBuild GAMES. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Infinity Ward vs tinyBuild GAMES',
    description: 'Detailed comparison of Infinity Ward and tinyBuild GAMES.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infinity-ward-vs-tinybuild-games#article",
  "headline": "Infinity Ward vs tinyBuild GAMES: Comparison",
  "description": "Detailed comparison of Infinity Ward and tinyBuild GAMES. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Infinity Ward",
      "url": "https://useharbor.io/brands/infinity-ward"
    },
    {
      "@type": "SoftwareApplication",
      "name": "tinyBuild GAMES",
      "url": "https://useharbor.io/brands/tinybuild-games"
    }
  ]
}
...
const brand1 = {
  "slug": "infinity-ward",
  "brand_name": "Infinity Ward",
  "domain": "infinityward.com",
  "category": "Video Games",
  "summary": "A leading video game studio known for the Call of Duty franchise.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "tinybuild-games",
  "brand_name": "tinyBuild GAMES",
  "domain": "tinybuild.com",
  "category": "Video Games",
  "summary": "An indie game developer and publisher known for innovative partnerships and popular titles.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
