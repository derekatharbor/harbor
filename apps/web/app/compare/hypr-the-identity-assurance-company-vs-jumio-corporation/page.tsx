...
// Comparing: HYPR | The Identity Assurance Company vs Jumio Corporation

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'HYPR | The Identity Assurance Company vs Jumio Corporation (November 30, 2025) | Harbor',
  description: 'Detailed comparison of HYPR | The Identity Assurance Company and Jumio Corporation. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'HYPR | The Identity Assurance Company vs Jumio Corporation',
    description: 'Detailed comparison of HYPR | The Identity Assurance Company and Jumio Corporation.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hypr-the-identity-assurance-company-vs-jumio-corporation#article",
  "headline": "HYPR | The Identity Assurance Company vs Jumio Corporation: Comparison",
  "description": "Detailed comparison of HYPR | The Identity Assurance Company and Jumio Corporation. Features, pricing, and integrations compared side-by-side.",
