...
// Comparing: 8am vs TruGolf

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '8am vs TruGolf (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 8am and TruGolf. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '8am vs TruGolf',
    description: 'Detailed comparison of 8am and TruGolf.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/8am-vs-trugolf#article",
  "headline": "8am vs TruGolf: Comparison",
  "description": "Detailed comparison of 8am and TruGolf. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "8am",
      "url": "https://useharbor.io/brands/8am"
    },
    {
      "@type": "SoftwareApplication",
      "name": "TruGolf",
      "url": "https://useharbor.io/brands/trugolf"
    }
  ]
}
...
const brand1 = {
  ...
  "domain": "8amgolf.com",
  "category": "Golf",
  "summary": "Empowering golfers with tools and experiences.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "trugolf.com",
  "category": "Golf",
  "summary": "TruGolf provides advanced golf simulation and launch monitor solutions.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
