...
// Comparing: Halo Media vs Konrad

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Halo Media vs Konrad (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Halo Media and Konrad. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Halo Media vs Konrad',
    description: 'Detailed comparison of Halo Media and Konrad.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/halo-media-vs-konrad#article",
  "headline": "Halo Media vs Konrad: Comparison",
  "description": "Detailed comparison of Halo Media and Konrad. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Halo Media",
      "url": "https://useharbor.io/brands/halo-media"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Konrad",
      "url": "https://useharbor.io/brands/konrad"
    }
  ]
}
...
const brand1 = {
  "slug": "halo-media",
  "brand_name": "Halo Media",
  "domain": "halopowered.com",
  "category": "Digital Agency",
  "summary": "A global digital agency specializing in software design, strategy, and AI-powered platforms.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "konrad.com",
  "category": "Digital Agency",
  "summary": "A leading digital agency specializing in strategy, design, and technology.",
  "pricing": {
    "price_model": "custom",
