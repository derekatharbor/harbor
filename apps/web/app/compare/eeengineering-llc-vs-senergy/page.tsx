...
// Comparing: EEEngineering, LLC vs SEnergy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'EEEngineering, LLC vs SEnergy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of EEEngineering, LLC and SEnergy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'EEEngineering, LLC vs SEnergy',
    description: 'Detailed comparison of EEEngineering, LLC and SEnergy.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/eeengineering-llc-vs-senergy#article",
  "headline": "EEEngineering, LLC vs SEnergy: Comparison",
  "description": "Detailed comparison of EEEngineering, LLC and SEnergy. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Electric System Planning Studies"
  ],
  "integrations": []
}
