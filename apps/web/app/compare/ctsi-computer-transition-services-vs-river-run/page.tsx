...
// Comparing: CTSI | Computer Transition Services vs River Run

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CTSI | Computer Transition Services vs River Run (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CTSI | Computer Transition Services and River Run. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CTSI | Computer Transition Services vs River Run',
    description: 'Detailed comparison of CTSI | Computer Transition Services and River Run.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ctsi-computer-transition-services-vs-river-run#article",
  "headline": "CTSI | Computer Transition Services vs River Run: Comparison",
  "description": "Detailed comparison of CTSI | Computer Transition Services and River Run. Features, pricing, and integrations compared side-by-side.",
