...
// Comparing: Hylaine vs iTech AG

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Hylaine vs iTech AG (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Hylaine and iTech AG. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Hylaine vs iTech AG',
    description: 'Detailed comparison of Hylaine and iTech AG.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hylaine-vs-itech-ag#article",
  "headline": "Hylaine vs iTech AG: Comparison",
  "description": "Detailed comparison of Hylaine and iTech AG. Features, pricing, and integrations compared side-by-side.",
