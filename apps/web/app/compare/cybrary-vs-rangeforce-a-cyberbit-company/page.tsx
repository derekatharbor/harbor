...
// Comparing: Cybrary vs RangeForce, a Cyberbit company

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cybrary vs RangeForce, a Cyberbit company (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cybrary and RangeForce, a Cyberbit company. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cybrary vs RangeForce, a Cyberbit company',
    description: 'Detailed comparison of Cybrary and RangeForce, a Cyberbit company.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cybrary-vs-rangeforce-a-cyberbit-company#article",
  "headline": "Cybrary vs RangeForce, a Cyberbit company: Comparison",
  "description": "Detailed comparison of Cybrary and RangeForce, a Cyberbit company. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Cybrary",
      "url": "https://useharbor.io/brands/cybrary"
    },
    {
      "@type": "SoftwareApplication",
...
const brand1 = {
  ...
  "summary": "A leading platform for cybersecurity training and education.",
  "pricing": {
    "price_model": "per_user",
    "price_notes": "Free tier available with limited access; paid plans offer full access.",
    "has_free_tier": true,
    "starting_price": "$24.58/mo"
  },
  "features": [
    "Career Paths",
    "Skill Paths",
