...
// Comparing: Infobahn Softworld Inc vs Software Design Partners

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Infobahn Softworld Inc vs Software Design Partners (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Infobahn Softworld Inc and Software Design Partners. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Infobahn Softworld Inc vs Software Design Partners',
    description: 'Detailed comparison of Infobahn Softworld Inc and Software Design Partners.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infobahn-softworld-inc-vs-software-design-partners#article",
  "headline": "Infobahn Softworld Inc vs Software Design Partners: Comparison",
  "description": "Detailed comparison of Infobahn Softworld Inc and Software Design Partners. Features, pricing, and integrations compared side-by-side.",
