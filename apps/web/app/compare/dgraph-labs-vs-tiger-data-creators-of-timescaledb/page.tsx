...
// Generated: 2025-11-30T20:05:20.328Z
// Comparing: Dgraph Labs vs Tiger Data (creators of TimescaleDB)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Dgraph Labs vs Tiger Data (creators of TimescaleDB) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Dgraph Labs and Tiger Data (creators of TimescaleDB). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Dgraph Labs vs Tiger Data (creators of TimescaleDB)',
    description: 'Detailed comparison of Dgraph Labs and Tiger Data (creators of TimescaleDB).',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.328Z',
    modifiedTime: '2025-11-30T20:05:20.328Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dgraph-labs-vs-tiger-data-creators-of-timescaledb#article",
  "headline": "Dgraph Labs vs Tiger Data (creators of TimescaleDB): Comparison",
  "description": "Detailed comparison of Dgraph Labs and Tiger Data (creators of TimescaleDB). Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.328Z",
  "dateModified": "2025-11-30T20:05:20.328Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.328Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.328Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
