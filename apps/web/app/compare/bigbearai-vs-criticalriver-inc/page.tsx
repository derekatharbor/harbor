...
// Generated: 2025-11-30T19:44:53.511Z
// Comparing: BigBear.ai vs CriticalRiver Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BigBear.ai vs CriticalRiver Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BigBear.ai and CriticalRiver Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BigBear.ai vs CriticalRiver Inc.',
    description: 'Detailed comparison of BigBear.ai and CriticalRiver Inc..',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.511Z',
    modifiedTime: '2025-11-30T19:44:53.511Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bigbearai-vs-criticalriver-inc#article",
  "headline": "BigBear.ai vs CriticalRiver Inc.: Comparison",
  "description": "Detailed comparison of BigBear.ai and CriticalRiver Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.511Z",
  "dateModified": "2025-11-30T19:44:53.511Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.511Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.511Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
