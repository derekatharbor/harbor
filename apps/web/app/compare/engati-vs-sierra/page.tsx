...
// Comparing: Engati vs Sierra

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Engati vs Sierra (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Engati and Sierra. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Engati vs Sierra',
    description: 'Detailed comparison of Engati and Sierra.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/engati-vs-sierra#article",
  "headline": "Engati vs Sierra: Comparison",
  "description": "Detailed comparison of Engati and Sierra. Features, pricing, and integrations compared side-by-side.",
