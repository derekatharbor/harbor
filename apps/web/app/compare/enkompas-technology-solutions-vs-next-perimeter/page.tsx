...
// Comparing: enkompas Technology Solutions vs Next Perimeter

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'enkompas Technology Solutions vs Next Perimeter (November 30, 2025) | Harbor',
  description: 'Detailed comparison of enkompas Technology Solutions and Next Perimeter. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'enkompas Technology Solutions vs Next Perimeter',
    description: 'Detailed comparison of enkompas Technology Solutions and Next Perimeter.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/enkompas-technology-solutions-vs-next-perimeter#article",
  "headline": "enkompas Technology Solutions vs Next Perimeter: Comparison",
  "description": "Detailed comparison of enkompas Technology Solutions and Next Perimeter. Features, pricing, and integrations compared side-by-side.",
