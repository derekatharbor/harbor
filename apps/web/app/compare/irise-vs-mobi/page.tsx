...
// Comparing: iRise vs mobi

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'iRise vs mobi (November 30, 2025) | Harbor',
  description: 'Detailed comparison of iRise and mobi. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'iRise vs mobi',
    description: 'Detailed comparison of iRise and mobi.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/irise-vs-mobi#article",
  "headline": "iRise vs mobi: Comparison",
  "description": "Detailed comparison of iRise and mobi. Features, pricing, and integrations compared side-by-side.",
