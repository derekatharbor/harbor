...
// Comparing: Abacus.AI vs Moveworks

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Abacus.AI vs Moveworks (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Abacus.AI and Moveworks. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Abacus.AI vs Moveworks',
    description: 'Detailed comparison of Abacus.AI and Moveworks.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/abacusai-vs-moveworks#article",
  "headline": "Abacus.AI vs Moveworks: Comparison",
  "description": "Detailed comparison of Abacus.AI and Moveworks. Features, pricing, and integrations compared side-by-side.",
