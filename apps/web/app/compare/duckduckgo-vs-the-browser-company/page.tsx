...
// Comparing: DuckDuckGo vs The Browser Company

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DuckDuckGo vs The Browser Company (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DuckDuckGo and The Browser Company. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DuckDuckGo vs The Browser Company',
    description: 'Detailed comparison of DuckDuckGo and The Browser Company.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/duckduckgo-vs-the-browser-company#article",
  "headline": "DuckDuckGo vs The Browser Company: Comparison",
  "description": "Detailed comparison of DuckDuckGo and The Browser Company. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "DuckDuckGo",
      "url": "https://useharbor.io/brands/duckduckgo"
    },
    {
      "@type": "SoftwareApplication",
      "name": "The Browser Company",
      "url": "https://useharbor.io/brands/the-browser-company"
    }
  ]
}
...
const brand1 = {
  "slug": "duckduckgo",
  "brand_name": "DuckDuckGo",
  "domain": "duckduckgo.com",
  "category": "Web Browser",
  "summary": "A privacy-focused search engine and browser.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": "The browser is free and funded by privacy-respecting search ads.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
    ...
    "Chat privately with popular AI chatbots",
...
const brand2 = {
  ...
  "brand_name": "The Browser Company",
  "domain": "thebrowser.company",
  "category": "Web Browser",
  "summary": "A company focused on improving internet usage through innovative browsers.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
