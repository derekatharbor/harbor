...
// Comparing: Pavlov Media vs Socket Fiber

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Pavlov Media vs Socket Fiber (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Pavlov Media and Socket Fiber. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Pavlov Media vs Socket Fiber',
    description: 'Detailed comparison of Pavlov Media and Socket Fiber.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/pavlov-media-vs-socket-fiber#article",
  "headline": "Pavlov Media vs Socket Fiber: Comparison",
  "description": "Detailed comparison of Pavlov Media and Socket Fiber. Features, pricing, and integrations compared side-by-side.",
