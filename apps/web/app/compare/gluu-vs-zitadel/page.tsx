...
// Comparing: Gluu vs ZITADEL

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Gluu vs ZITADEL (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Gluu and ZITADEL. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Gluu vs ZITADEL',
    description: 'Detailed comparison of Gluu and ZITADEL.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gluu-vs-zitadel#article",
  "headline": "Gluu vs ZITADEL: Comparison",
  "description": "Detailed comparison of Gluu and ZITADEL. Features, pricing, and integrations compared side-by-side.",
