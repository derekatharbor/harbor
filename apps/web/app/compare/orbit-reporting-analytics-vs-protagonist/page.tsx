...
// Comparing: Orbit Reporting + Analytics vs Protagonist

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Orbit Reporting + Analytics vs Protagonist (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Orbit Reporting + Analytics and Protagonist. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Orbit Reporting + Analytics vs Protagonist',
    description: 'Detailed comparison of Orbit Reporting + Analytics and Protagonist.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/orbit-reporting-analytics-vs-protagonist#article",
  "headline": "Orbit Reporting + Analytics vs Protagonist: Comparison",
  "description": "Detailed comparison of Orbit Reporting + Analytics and Protagonist. Features, pricing, and integrations compared side-by-side.",
