...
// Generated: 2025-11-30T19:44:53.545Z
// Comparing: Network World vs UniFi

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Network World vs UniFi (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Network World and UniFi. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Network World vs UniFi',
    description: 'Detailed comparison of Network World and UniFi.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.545Z',
    modifiedTime: '2025-11-30T19:44:53.545Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/network-world-vs-unifi#article",
  "headline": "Network World vs UniFi: Comparison",
  "description": "Detailed comparison of Network World and UniFi. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.545Z",
  "dateModified": "2025-11-30T19:44:53.545Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.545Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.545Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
