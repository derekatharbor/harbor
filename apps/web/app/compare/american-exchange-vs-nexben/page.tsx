...
// Comparing: American Exchange vs Nexben

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'American Exchange vs Nexben (November 30, 2025) | Harbor',
  description: 'Detailed comparison of American Exchange and Nexben. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'American Exchange vs Nexben',
    description: 'Detailed comparison of American Exchange and Nexben.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/american-exchange-vs-nexben#article",
  "headline": "American Exchange vs Nexben: Comparison",
  "description": "Detailed comparison of American Exchange and Nexben. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "url": "https://useharbor.io/brands/american-exchange"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Nexben",
      "url": "https://useharbor.io/brands/nexben"
    }
  ]
}

const brand1 = {
  "slug": "american-exchange",
  "brand_name": "American Exchange",
  "domain": "americanexchange.com",
  "category": "Health Insurance",
  "summary": "A health insurance broker specializing in ACA and Medicare enrollment.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Medicare plan selection support",
    "Revenue cycle management",
    "Year-round policy management",
...
const brand2 = {
  ...
  "domain": "nexben.com",
  "category": "Health Insurance",
  "summary": "Nexben is a comprehensive benefits utility hub focused on defined contribution and ICHRA strategies.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Contact for pricing information",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
    "End-to-end benefits utility hub",
    "Defined contribution strategy support",
    "Turnkey enrollment and marketplace solution",
    "Comprehensive onboarding and training",
    "White-labeled platform customization"
  ],
  "integrations": []
}
