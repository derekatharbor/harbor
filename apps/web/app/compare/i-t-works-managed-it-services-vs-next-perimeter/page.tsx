...
// Comparing: I.T.WORKS! Managed IT Services vs Next Perimeter

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'I.T.WORKS! Managed IT Services vs Next Perimeter (November 30, 2025) | Harbor',
  description: 'Detailed comparison of I.T.WORKS! Managed IT Services and Next Perimeter. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'I.T.WORKS! Managed IT Services vs Next Perimeter',
    description: 'Detailed comparison of I.T.WORKS! Managed IT Services and Next Perimeter.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/i-t-works-managed-it-services-vs-next-perimeter#article",
  "headline": "I.T.WORKS! Managed IT Services vs Next Perimeter: Comparison",
  "description": "Detailed comparison of I.T.WORKS! Managed IT Services and Next Perimeter. Features, pricing, and integrations compared side-by-side.",
