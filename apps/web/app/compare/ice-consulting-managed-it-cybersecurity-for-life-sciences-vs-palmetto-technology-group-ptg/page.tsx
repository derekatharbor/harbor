...
// Comparing: ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Palmetto Technology Group (PTG)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Palmetto Technology Group (PTG) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and Palmetto Technology Group (PTG). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Palmetto Technology Group (PTG)',
    description: 'Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and Palmetto Technology Group (PTG).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ice-consulting-managed-it-cybersecurity-for-life-sciences-vs-palmetto-technology-group-ptg#article",
  "headline": "ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Palmetto Technology Group (PTG): Comparison",
  "description": "Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and Palmetto Technology Group (PTG). Features, pricing, and integrations compared side-by-side.",
