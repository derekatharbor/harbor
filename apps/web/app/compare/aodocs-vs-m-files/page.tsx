...
// Comparing: AODocs vs M-Files

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AODocs vs M-Files (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AODocs and M-Files. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AODocs vs M-Files',
    description: 'Detailed comparison of AODocs and M-Files.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aodocs-vs-m-files#article",
  "headline": "AODocs vs M-Files: Comparison",
  "description": "Detailed comparison of AODocs and M-Files. Features, pricing, and integrations compared side-by-side.",
