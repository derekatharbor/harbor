...
// Generated: 2025-11-30T20:05:20.319Z
// Comparing: Hydrolix vs Manta, an IBM Company

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Hydrolix vs Manta, an IBM Company (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Hydrolix and Manta, an IBM Company. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Hydrolix vs Manta, an IBM Company',
    description: 'Detailed comparison of Hydrolix and Manta, an IBM Company.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.319Z',
    modifiedTime: '2025-11-30T20:05:20.319Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hydrolix-vs-manta-an-ibm-company#article",
  "headline": "Hydrolix vs Manta, an IBM Company: Comparison",
  "description": "Detailed comparison of Hydrolix and Manta, an IBM Company. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.319Z",
  "dateModified": "2025-11-30T20:05:20.319Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.319Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.319Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
