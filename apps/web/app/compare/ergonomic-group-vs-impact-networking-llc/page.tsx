...
// Generated: 2025-11-30T20:05:20.195Z
// Comparing: Ergonomic Group vs Impact Networking, LLC

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Ergonomic Group vs Impact Networking, LLC (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Ergonomic Group and Impact Networking, LLC. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Ergonomic Group vs Impact Networking, LLC',
    description: 'Detailed comparison of Ergonomic Group and Impact Networking, LLC.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.195Z',
    modifiedTime: '2025-11-30T20:05:20.195Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ergonomic-group-vs-impact-networking-llc#article",
  "headline": "Ergonomic Group vs Impact Networking, LLC: Comparison",
  "description": "Detailed comparison of Ergonomic Group and Impact Networking, LLC. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.195Z",
  "dateModified": "2025-11-30T20:05:20.195Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.195Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.195Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
