...
// Comparing: OrderMyGear (OMG) vs Weedmaps

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'OrderMyGear (OMG) vs Weedmaps (November 30, 2025) | Harbor',
  description: 'Detailed comparison of OrderMyGear (OMG) and Weedmaps. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'OrderMyGear (OMG) vs Weedmaps',
    description: 'Detailed comparison of OrderMyGear (OMG) and Weedmaps.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ordermygear-omg-vs-weedmaps#article",
  "headline": "OrderMyGear (OMG) vs Weedmaps: Comparison",
  "description": "Detailed comparison of OrderMyGear (OMG) and Weedmaps. Features, pricing, and integrations compared side-by-side.",
