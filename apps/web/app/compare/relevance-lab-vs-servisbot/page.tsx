...
// Generated: 2025-11-30T19:44:53.499Z
// Comparing: Relevance Lab vs ServisBOT

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Relevance Lab vs ServisBOT (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Relevance Lab and ServisBOT. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Relevance Lab vs ServisBOT',
    description: 'Detailed comparison of Relevance Lab and ServisBOT.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.499Z',
    modifiedTime: '2025-11-30T19:44:53.499Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/relevance-lab-vs-servisbot#article",
  "headline": "Relevance Lab vs ServisBOT: Comparison",
  "description": "Detailed comparison of Relevance Lab and ServisBOT. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.499Z",
  "dateModified": "2025-11-30T19:44:53.499Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand1 = {
  ...
  "features": [
    ...
    "Operational agents for AIOps",
    "GenAI Research Copilot"
  ],
  "integrations": [
    "AWS"
  ]
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.499Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.499Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
