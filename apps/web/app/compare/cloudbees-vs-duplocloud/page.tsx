...
// Comparing: CloudBees vs DuploCloud

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CloudBees vs DuploCloud (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CloudBees and DuploCloud. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CloudBees vs DuploCloud',
    description: 'Detailed comparison of CloudBees and DuploCloud.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cloudbees-vs-duplocloud#article",
  "headline": "CloudBees vs DuploCloud: Comparison",
  "description": "Detailed comparison of CloudBees and DuploCloud. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "CloudBees",
      "url": "https://useharbor.io/brands/cloudbees"
    },
    {
      "@type": "SoftwareApplication",
      "name": "DuploCloud",
      "url": "https://useharbor.io/brands/duplocloud"
    }
  ]
}
...
const brand1 = {
  "slug": "cloudbees",
  "brand_name": "CloudBees",
  "domain": "cloudbees.com",
  "category": "DevOps",
  "summary": "CloudBees is a leader in AI-native software delivery solutions for enterprises.",
  "pricing": {
    "price_model": "custom",
...
const brand2 = {
  "slug": "duplocloud",
  "brand_name": "DuploCloud",
  "domain": "duplocloud.com",
  "category": "DevOps",
  "summary": "AI-powered DevOps automation platform.",
  "pricing": {
    "price_model": "tiered",
    "price_notes": "Three pricing tiers: Core, Advanced, and Scale, with additional add-ons available.",
    "has_free_tier": false,
    "starting_price": "$3,000/mo"
  },
  "features": [
    "Automated security patching",
    "Infrastructure-as-code via an IDE Extension",
    "Comprehensive observability & monitoring",
    "Migration to and from Cloud PaaS Services",
