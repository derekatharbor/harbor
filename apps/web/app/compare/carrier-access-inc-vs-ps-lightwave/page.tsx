...
// Generated: 2025-11-30T20:05:20.178Z
// Comparing: Carrier Access, Inc. vs PS LIGHTWAVE

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Carrier Access, Inc. vs PS LIGHTWAVE (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Carrier Access, Inc. and PS LIGHTWAVE. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Carrier Access, Inc. vs PS LIGHTWAVE',
    description: 'Detailed comparison of Carrier Access, Inc. and PS LIGHTWAVE.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.178Z',
    modifiedTime: '2025-11-30T20:05:20.178Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/carrier-access-inc-vs-ps-lightwave#article",
  "headline": "Carrier Access, Inc. vs PS LIGHTWAVE: Comparison",
  "description": "Detailed comparison of Carrier Access, Inc. and PS LIGHTWAVE. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.178Z",
  "dateModified": "2025-11-30T20:05:20.178Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.178Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.178Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
