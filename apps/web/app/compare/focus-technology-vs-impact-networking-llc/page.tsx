...
// Comparing: Focus Technology vs Impact Networking, LLC

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Focus Technology vs Impact Networking, LLC (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Focus Technology and Impact Networking, LLC. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Focus Technology vs Impact Networking, LLC',
    description: 'Detailed comparison of Focus Technology and Impact Networking, LLC.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/focus-technology-vs-impact-networking-llc#article",
  "headline": "Focus Technology vs Impact Networking, LLC: Comparison",
  "description": "Detailed comparison of Focus Technology and Impact Networking, LLC. Features, pricing, and integrations compared side-by-side.",
