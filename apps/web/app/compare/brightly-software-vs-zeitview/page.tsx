...
// Comparing: Brightly Software vs Zeitview

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Brightly Software vs Zeitview (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Brightly Software and Zeitview. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Brightly Software vs Zeitview',
    description: 'Detailed comparison of Brightly Software and Zeitview.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/brightly-software-vs-zeitview#article",
  "headline": "Brightly Software vs Zeitview: Comparison",
  "description": "Detailed comparison of Brightly Software and Zeitview. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "Zeitview",
      "url": "https://useharbor.io/brands/zeitview"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "zeitview.com",
  "category": "Asset Management",
  "summary": "AI-powered asset intelligence and visualization solutions for critical infrastructure.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Pricing is provided upon request through the sales team.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
    ...
    "Customizable filters for data visualization",
