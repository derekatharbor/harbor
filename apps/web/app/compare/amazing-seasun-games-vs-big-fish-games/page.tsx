...
// Comparing: Amazing Seasun Games vs Big Fish Games

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Amazing Seasun Games vs Big Fish Games (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Amazing Seasun Games and Big Fish Games. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Amazing Seasun Games vs Big Fish Games',
    description: 'Detailed comparison of Amazing Seasun Games and Big Fish Games.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amazing-seasun-games-vs-big-fish-games#article",
  "headline": "Amazing Seasun Games vs Big Fish Games: Comparison",
  "description": "Detailed comparison of Amazing Seasun Games and Big Fish Games. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Amazing Seasun Games",
      "url": "https://useharbor.io/brands/amazing-seasun-games"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Big Fish Games",
...
const brand1 = {
  "slug": "amazing-seasun-games",
  "brand_name": "Amazing Seasun Games",
  "domain": "seasungames.com",
  "category": "Gaming",
  "summary": "A paradise for gamers.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
