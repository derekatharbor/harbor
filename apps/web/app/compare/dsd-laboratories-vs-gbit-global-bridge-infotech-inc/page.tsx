...
// Comparing: DSD Laboratories vs GBIT (Global Bridge InfoTech Inc)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DSD Laboratories vs GBIT (Global Bridge InfoTech Inc) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DSD Laboratories and GBIT (Global Bridge InfoTech Inc). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DSD Laboratories vs GBIT (Global Bridge InfoTech Inc)',
    description: 'Detailed comparison of DSD Laboratories and GBIT (Global Bridge InfoTech Inc).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dsd-laboratories-vs-gbit-global-bridge-infotech-inc#article",
  "headline": "DSD Laboratories vs GBIT (Global Bridge InfoTech Inc): Comparison",
  "description": "Detailed comparison of DSD Laboratories and GBIT (Global Bridge InfoTech Inc). Features, pricing, and integrations compared side-by-side.",
