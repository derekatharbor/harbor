...
// Comparing: NUKG Business Solutions vs PlanSource

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NUKG Business Solutions vs PlanSource (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NUKG Business Solutions and PlanSource. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NUKG Business Solutions vs PlanSource',
    description: 'Detailed comparison of NUKG Business Solutions and PlanSource.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/nukg-business-solutions-vs-plansource#article",
  "headline": "NUKG Business Solutions vs PlanSource: Comparison",
  "description": "Detailed comparison of NUKG Business Solutions and PlanSource. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "NUKG Business Solutions",
      "url": "https://useharbor.io/brands/nukg-business-solutions"
    },
    {
      "@type": "SoftwareApplication",
      "name": "PlanSource",
      "url": "https://useharbor.io/brands/plansource"
    }
  ]
}

const brand1 = {
  "slug": "nukg-business-solutions",
  "brand_name": "NUKG Business Solutions",
  "domain": "nukg.com",
  "category": "Employee Benefits Administration",
  "summary": "A comprehensive solution for employee benefits administration and data management.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Artificial Intelligence-driven Machine Learning Bot",
    "24/7 support desk availability",
    "Flexible hosting options (cloud-based or on-premises)",
    "Web interface for benefits setup",
    "Life event management",
    "Streamlined workflows",
    "Tracking of providers and benefit plans"
  ],
  "integrations": []
}
...
const brand2 = {
  "slug": "plansource",
  "brand_name": "PlanSource",
  "domain": "plansource.com",
  "category": "Employee Benefits Administration",
  "summary": "PlanSource provides comprehensive employee benefits administration software.",
  "pricing": {
    "price_model": "custom",
