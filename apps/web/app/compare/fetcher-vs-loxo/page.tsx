...
// Comparing: Fetcher vs Loxo

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Fetcher vs Loxo (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Fetcher and Loxo. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Fetcher vs Loxo',
    description: 'Detailed comparison of Fetcher and Loxo.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/fetcher-vs-loxo#article",
  "headline": "Fetcher vs Loxo: Comparison",
  "description": "Detailed comparison of Fetcher and Loxo. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Fetcher",
      "url": "https://useharbor.io/brands/fetcher"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Loxo",
      "url": "https://useharbor.io/brands/loxo"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "AI-powered candidate sourcing tools for recruiters.",
  "pricing": {
    "price_model": "tiered",
    "price_notes": "Monthly pricing for different plans available.",
    "has_free_tier": false,
    "starting_price": "$379/mo"
  },
  "features": [
...
const brand2 = {
  ...
  "domain": "loxo.co",
  "category": "Recruitment",
  "summary": "Loxo is a Talent Intelligence Platform designed to streamline the recruitment process.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": true,
  ...
  "features": [
    "Real-time verification of personal and work contact information",
    "Centralized historical activities and communications",
    "Talent Intelligence Platform for seamless recruitment workflow",
