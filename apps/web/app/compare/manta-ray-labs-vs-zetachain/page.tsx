...
// Comparing: Manta Ray Labs vs ZetaChain

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Manta Ray Labs vs ZetaChain (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Manta Ray Labs and ZetaChain. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Manta Ray Labs vs ZetaChain',
    description: 'Detailed comparison of Manta Ray Labs and ZetaChain.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/manta-ray-labs-vs-zetachain#article",
  "headline": "Manta Ray Labs vs ZetaChain: Comparison",
  "description": "Detailed comparison of Manta Ray Labs and ZetaChain. Features, pricing, and integrations compared side-by-side.",
