...
// Generated: 2025-11-30T19:44:53.831Z
// Comparing: DISCO vs eBrevia

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DISCO vs eBrevia (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DISCO and eBrevia. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DISCO vs eBrevia',
    description: 'Detailed comparison of DISCO and eBrevia.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.831Z',
    modifiedTime: '2025-11-30T19:44:53.831Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/disco-vs-ebrevia#article",
  "headline": "DISCO vs eBrevia: Comparison",
  "description": "Detailed comparison of DISCO and eBrevia. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.831Z",
  "dateModified": "2025-11-30T19:44:53.831Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand2 = {
  ...
  "features": [
    ...
    "Access relevant clauses directly from the Clause Library",
    "10x Faster Drafting",
    "90% time savings"
  ],
  "integrations": [
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.831Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.831Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
