...
// Comparing: LeagueApps vs TeamSnap

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'LeagueApps vs TeamSnap (November 30, 2025) | Harbor',
  description: 'Detailed comparison of LeagueApps and TeamSnap. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'LeagueApps vs TeamSnap',
    description: 'Detailed comparison of LeagueApps and TeamSnap.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/leagueapps-vs-teamsnap#article",
  "headline": "LeagueApps vs TeamSnap: Comparison",
  "description": "Detailed comparison of LeagueApps and TeamSnap. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "LeagueApps",
      "url": "https://useharbor.io/brands/leagueapps"
    },
    {
      "@type": "SoftwareApplication",
      "name": "TeamSnap",
      "url": "https://useharbor.io/brands/teamsnap"
    }
  ]
}
...
const brand1 = {
  "slug": "leagueapps",
  "brand_name": "LeagueApps",
  "domain": "leagueapps.com",
  "category": "Youth Sports Management",
  "summary": "LeagueApps provides comprehensive youth sports management software.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "Pay a small fee as a percentage of each payment transaction; no subscription fees or contract lock-ins.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
...
const brand2 = {
  ...
  "domain": "teamsnap.com",
  "category": "Youth Sports Management",
  "summary": "TeamSnap is a leading platform for youth sports team, club, and league management.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
