...
// Comparing: NewStore vs OrderMyGear (OMG)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NewStore vs OrderMyGear (OMG) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NewStore and OrderMyGear (OMG). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NewStore vs OrderMyGear (OMG)',
    description: 'Detailed comparison of NewStore and OrderMyGear (OMG).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/newstore-vs-ordermygear-omg#article",
  "headline": "NewStore vs OrderMyGear (OMG): Comparison",
  "description": "Detailed comparison of NewStore and OrderMyGear (OMG). Features, pricing, and integrations compared side-by-side.",
