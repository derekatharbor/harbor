...
// Comparing: NewStore vs PlanetArt

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NewStore vs PlanetArt (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NewStore and PlanetArt. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NewStore vs PlanetArt',
    description: 'Detailed comparison of NewStore and PlanetArt.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/newstore-vs-planetart#article",
  "headline": "NewStore vs PlanetArt: Comparison",
  "description": "Detailed comparison of NewStore and PlanetArt. Features, pricing, and integrations compared side-by-side.",
