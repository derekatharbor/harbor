...
// Generated: 2025-11-30T19:44:53.929Z
// Comparing: 22Miles vs Yodeck

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '22Miles vs Yodeck (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 22Miles and Yodeck. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '22Miles vs Yodeck',
    description: 'Detailed comparison of 22Miles and Yodeck.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.929Z',
    modifiedTime: '2025-11-30T19:44:53.929Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/22miles-vs-yodeck#article",
  "headline": "22Miles vs Yodeck: Comparison",
  "description": "Detailed comparison of 22Miles and Yodeck. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.929Z",
  "dateModified": "2025-11-30T19:44:53.929Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.929Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.929Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
