...
// Comparing: Emitrr vs TotalCX

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Emitrr vs TotalCX (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Emitrr and TotalCX. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Emitrr vs TotalCX',
    description: 'Detailed comparison of Emitrr and TotalCX.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/emitrr-vs-totalcx#article",
  "headline": "Emitrr vs TotalCX: Comparison",
  "description": "Detailed comparison of Emitrr and TotalCX. Features, pricing, and integrations compared side-by-side.",
