...
// Generated: 2025-11-30T20:05:20.173Z
// Comparing: AIDS Healthcare Foundation vs Kitsap Physical Therapy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AIDS Healthcare Foundation vs Kitsap Physical Therapy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AIDS Healthcare Foundation and Kitsap Physical Therapy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AIDS Healthcare Foundation vs Kitsap Physical Therapy',
    description: 'Detailed comparison of AIDS Healthcare Foundation and Kitsap Physical Therapy.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.173Z',
    modifiedTime: '2025-11-30T20:05:20.173Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aids-healthcare-foundation-vs-kitsap-physical-therapy#article",
  "headline": "AIDS Healthcare Foundation vs Kitsap Physical Therapy: Comparison",
  "description": "Detailed comparison of AIDS Healthcare Foundation and Kitsap Physical Therapy. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.173Z",
  "dateModified": "2025-11-30T20:05:20.173Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.173Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.173Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
