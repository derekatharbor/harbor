...
// Comparing: IDW Publishing vs New Harbinger Publications

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'IDW Publishing vs New Harbinger Publications (November 30, 2025) | Harbor',
  description: 'Detailed comparison of IDW Publishing and New Harbinger Publications. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'IDW Publishing vs New Harbinger Publications',
    description: 'Detailed comparison of IDW Publishing and New Harbinger Publications.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/idw-publishing-vs-new-harbinger-publications#article",
  "headline": "IDW Publishing vs New Harbinger Publications: Comparison",
  "description": "Detailed comparison of IDW Publishing and New Harbinger Publications. Features, pricing, and integrations compared side-by-side.",
