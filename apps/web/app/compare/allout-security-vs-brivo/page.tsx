...
// Comparing: ALLOut Security vs Brivo

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALLOut Security vs Brivo (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALLOut Security and Brivo. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALLOut Security vs Brivo',
    description: 'Detailed comparison of ALLOut Security and Brivo.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allout-security-vs-brivo#article",
  "headline": "ALLOut Security vs Brivo: Comparison",
  "description": "Detailed comparison of ALLOut Security and Brivo. Features, pricing, and integrations compared side-by-side.",
