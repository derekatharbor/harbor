...
// Comparing: Genetic Engineering & Biotechnology News vs IDW Publishing

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Genetic Engineering & Biotechnology News vs IDW Publishing (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Genetic Engineering & Biotechnology News and IDW Publishing. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Genetic Engineering & Biotechnology News vs IDW Publishing',
    description: 'Detailed comparison of Genetic Engineering & Biotechnology News and IDW Publishing.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/genetic-engineering-biotechnology-news-vs-idw-publishing#article",
  "headline": "Genetic Engineering & Biotechnology News vs IDW Publishing: Comparison",
  "description": "Detailed comparison of Genetic Engineering & Biotechnology News and IDW Publishing. Features, pricing, and integrations compared side-by-side.",
