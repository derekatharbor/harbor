...
// Generated: 2025-11-30T19:36:57.577Z
// Comparing: Aroha Technologies, Inc vs Wooqer

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Aroha Technologies, Inc vs Wooqer (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Aroha Technologies, Inc and Wooqer. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Aroha Technologies, Inc vs Wooqer',
    description: 'Detailed comparison of Aroha Technologies, Inc and Wooqer.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.577Z',
    modifiedTime: '2025-11-30T19:36:57.577Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aroha-technologies-inc-vs-wooqer#article",
  "headline": "Aroha Technologies, Inc vs Wooqer: Comparison",
  "description": "Detailed comparison of Aroha Technologies, Inc and Wooqer. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.577Z",
  "dateModified": "2025-11-30T19:36:57.577Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand2 = {
  ...
  "features": [
    ...
    "Health and safety checklist implementation",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.577Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.577Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
