...
// Comparing: Genetic Engineering & Biotechnology News vs Scribe Media

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Genetic Engineering & Biotechnology News vs Scribe Media (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Genetic Engineering & Biotechnology News and Scribe Media. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Genetic Engineering & Biotechnology News vs Scribe Media',
    description: 'Detailed comparison of Genetic Engineering & Biotechnology News and Scribe Media.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/genetic-engineering-biotechnology-news-vs-scribe-media#article",
  "headline": "Genetic Engineering & Biotechnology News vs Scribe Media: Comparison",
  "description": "Detailed comparison of Genetic Engineering & Biotechnology News and Scribe Media. Features, pricing, and integrations compared side-by-side.",
