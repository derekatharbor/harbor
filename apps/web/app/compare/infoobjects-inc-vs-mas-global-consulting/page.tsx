...
// Generated: 2025-11-30T19:36:57.528Z
// Comparing: InfoObjects Inc. vs MAS Global Consulting

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'InfoObjects Inc. vs MAS Global Consulting (November 30, 2025) | Harbor',
  description: 'Detailed comparison of InfoObjects Inc. and MAS Global Consulting. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'InfoObjects Inc. vs MAS Global Consulting',
    description: 'Detailed comparison of InfoObjects Inc. and MAS Global Consulting.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.528Z',
    modifiedTime: '2025-11-30T19:36:57.528Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infoobjects-inc-vs-mas-global-consulting#article",
  "headline": "InfoObjects Inc. vs MAS Global Consulting: Comparison",
  "description": "Detailed comparison of InfoObjects Inc. and MAS Global Consulting. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.528Z",
  "dateModified": "2025-11-30T19:36:57.528Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.528Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.528Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
