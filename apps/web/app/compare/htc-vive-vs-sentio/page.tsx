...
// Generated: 2025-11-30T19:44:54.054Z
// Comparing: HTC Vive vs Sentio

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'HTC Vive vs Sentio (November 30, 2025) | Harbor',
  description: 'Detailed comparison of HTC Vive and Sentio. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'HTC Vive vs Sentio',
    description: 'Detailed comparison of HTC Vive and Sentio.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.054Z',
    modifiedTime: '2025-11-30T19:44:54.054Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/htc-vive-vs-sentio#article",
  "headline": "HTC Vive vs Sentio: Comparison",
  "description": "Detailed comparison of HTC Vive and Sentio. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.054Z",
  "dateModified": "2025-11-30T19:44:54.054Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "HTC Vive",
      "url": "https://useharbor.io/brands/htc-vive"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Sentio",
      "url": "https://useharbor.io/brands/sentio"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "HTC Vive specializes in virtual reality (VR), augmented reality (AR), and mixed reality (MR) headsets and experiences.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "Standalone and PC VR experiences",
    "High-resolution displays",
    "Versatile tracking features",
    "Immersive applications",
    "Exceptional graphics and high-resolution passthrough",
    "Crisp stereoscopic audio",
...
const brand2 = {
  ...
  "domain": "sentiovr.com",
  "category": "Virtual Reality",
  "summary": "Sentio VR provides an all-in-one platform for transforming 3D designs into immersive virtual reality experiences.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.054Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.054Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
