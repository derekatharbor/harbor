...
// Comparing: Security Magazine vs The Cavalier Daily

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Security Magazine vs The Cavalier Daily (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Security Magazine and The Cavalier Daily. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Security Magazine vs The Cavalier Daily',
    description: 'Detailed comparison of Security Magazine and The Cavalier Daily.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/security-magazine-vs-the-cavalier-daily#article",
  "headline": "Security Magazine vs The Cavalier Daily: Comparison",
  "description": "Detailed comparison of Security Magazine and The Cavalier Daily. Features, pricing, and integrations compared side-by-side.",
