...
// Generated: 2025-11-30T19:36:57.473Z
// Comparing: Big Fish Games vs Statespace

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Big Fish Games vs Statespace (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Big Fish Games and Statespace. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Big Fish Games vs Statespace',
    description: 'Detailed comparison of Big Fish Games and Statespace.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.473Z',
    modifiedTime: '2025-11-30T19:36:57.473Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/big-fish-games-vs-statespace#article",
  "headline": "Big Fish Games vs Statespace: Comparison",
  "description": "Detailed comparison of Big Fish Games and Statespace. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.473Z",
  "dateModified": "2025-11-30T19:36:57.473Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "Big Fish Games",
      "url": "https://useharbor.io/brands/big-fish-games"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Statespace",
      "url": "https://useharbor.io/brands/statespace"
    }
  ]
}
...
const brand1 = {
  "slug": "big-fish-games",
  "brand_name": "Big Fish Games",
  "domain": "bigfishgames.com",
  "category": "Gaming",
  "summary": "A leading provider of casual games for various platforms.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": "Offers a 'Try Before You Buy' model for games.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
    "Thousands of downloadable games",
    "Try before you buy",
    "Game Club perks",
    "Exclusive access to new releases",
    "Variety of genres including Hidden Object, Adventure, Time Management, Match 3"
  ],
  "integrations": []
}
...
const brand2 = {
  "slug": "statespace",
  "brand_name": "Statespace",
  "domain": "statespace.gg",
  "category": "Gaming",
  "summary": "The leading AI-powered aim trainer for FPS gamers.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": true,
  ...
  "features": [
    "50K+ tasks and playlists",
    "AI Powered coach",
    "500 FPS game profiles",
    "Aim analysis with tailored tips",
    "Sensitivity Finder 2.0",
    "Guided training plans with daily missions",
    "Adaptive Tasks",
    "Valorant Training Center",
    "Premium courses Academy",
    "Community events"
  ],
  "integrations": [
    "Valorant",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.473Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.473Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
