...
// Generated: 2025-11-30T19:36:57.520Z
// Comparing: Skybox Security vs Tigera

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Skybox Security vs Tigera (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Skybox Security and Tigera. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Skybox Security vs Tigera',
    description: 'Detailed comparison of Skybox Security and Tigera.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.520Z',
    modifiedTime: '2025-11-30T19:36:57.520Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/skybox-security-vs-tigera#article",
  "headline": "Skybox Security vs Tigera: Comparison",
  "description": "Detailed comparison of Skybox Security and Tigera. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.520Z",
  "dateModified": "2025-11-30T19:36:57.520Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.520Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.520Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
