...
// Generated: 2025-11-30T20:05:20.308Z
// Comparing: Castle vs Ekata, a Mastercard company

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Castle vs Ekata, a Mastercard company (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Castle and Ekata, a Mastercard company. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Castle vs Ekata, a Mastercard company',
    description: 'Detailed comparison of Castle and Ekata, a Mastercard company.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.308Z',
    modifiedTime: '2025-11-30T20:05:20.308Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/castle-vs-ekata-a-mastercard-company#article",
  "headline": "Castle vs Ekata, a Mastercard company: Comparison",
  "description": "Detailed comparison of Castle and Ekata, a Mastercard company. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.308Z",
  "dateModified": "2025-11-30T20:05:20.308Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand1 = {
  ...
  "features": [
    ...
    "Session monitoring",
    "Network analysis",
    "Customization of fraud detection"
  ],
  "integrations": [
    "Cloudflare",
    "Slack"
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.308Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.308Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
