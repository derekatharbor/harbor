...
// Comparing: Order.co vs Scoutbee

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Order.co vs Scoutbee (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Order.co and Scoutbee. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Order.co vs Scoutbee',
    description: 'Detailed comparison of Order.co and Scoutbee.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/orderco-vs-scoutbee#article",
  "headline": "Order.co vs Scoutbee: Comparison",
  "description": "Detailed comparison of Order.co and Scoutbee. Features, pricing, and integrations compared side-by-side.",
