...
// Comparing: CARI.net vs oXya - USA

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CARI.net vs oXya - USA (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CARI.net and oXya - USA. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CARI.net vs oXya - USA',
    description: 'Detailed comparison of CARI.net and oXya - USA.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cari-net-vs-oxya-usa#article",
  "headline": "CARI.net vs oXya - USA: Comparison",
  "description": "Detailed comparison of CARI.net and oXya - USA. Features, pricing, and integrations compared side-by-side.",
