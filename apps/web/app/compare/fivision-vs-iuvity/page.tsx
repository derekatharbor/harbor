...
// Comparing: fiVISION vs iuvity

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'fiVISION vs iuvity (November 30, 2025) | Harbor',
  description: 'Detailed comparison of fiVISION and iuvity. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'fiVISION vs iuvity',
    description: 'Detailed comparison of fiVISION and iuvity.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/fivision-vs-iuvity#article",
  "headline": "fiVISION vs iuvity: Comparison",
  "description": "Detailed comparison of fiVISION and iuvity. Features, pricing, and integrations compared side-by-side.",
