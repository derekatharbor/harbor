...
// Generated: 2025-11-30T19:44:54.077Z
// Comparing: Altibase vs AMSYS Innovative Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Altibase vs AMSYS Innovative Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Altibase and AMSYS Innovative Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Altibase vs AMSYS Innovative Solutions',
    description: 'Detailed comparison of Altibase and AMSYS Innovative Solutions.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.077Z',
    modifiedTime: '2025-11-30T19:44:54.077Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/altibase-vs-amsys-innovative-solutions#article",
  "headline": "Altibase vs AMSYS Innovative Solutions: Comparison",
  "description": "Detailed comparison of Altibase and AMSYS Innovative Solutions. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.077Z",
  "dateModified": "2025-11-30T19:44:54.077Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.077Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.077Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
