...
// Comparing: For The Record (FTR) vs LEAP Legal Software US

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'For The Record (FTR) vs LEAP Legal Software US (November 30, 2025) | Harbor',
  description: 'Detailed comparison of For The Record (FTR) and LEAP Legal Software US. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'For The Record (FTR) vs LEAP Legal Software US',
    description: 'Detailed comparison of For The Record (FTR) and LEAP Legal Software US.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/for-the-record-ftr-vs-leap-legal-software-us#article",
  "headline": "For The Record (FTR) vs LEAP Legal Software US: Comparison",
  "description": "Detailed comparison of For The Record (FTR) and LEAP Legal Software US. Features, pricing, and integrations compared side-by-side.",
