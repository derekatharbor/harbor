...
// Comparing: GreenGeeks vs WestHost

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'GreenGeeks vs WestHost (November 30, 2025) | Harbor',
  description: 'Detailed comparison of GreenGeeks and WestHost. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'GreenGeeks vs WestHost',
    description: 'Detailed comparison of GreenGeeks and WestHost.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/greengeeks-vs-westhost#article",
  "headline": "GreenGeeks vs WestHost: Comparison",
  "description": "Detailed comparison of GreenGeeks and WestHost. Features, pricing, and integrations compared side-by-side.",
