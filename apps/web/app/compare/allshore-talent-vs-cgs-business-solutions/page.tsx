...
// Generated: 2025-11-30T19:44:53.568Z
// Comparing: Allshore Talent vs CGS Business Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Allshore Talent vs CGS Business Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Allshore Talent and CGS Business Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Allshore Talent vs CGS Business Solutions',
    description: 'Detailed comparison of Allshore Talent and CGS Business Solutions.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.568Z',
    modifiedTime: '2025-11-30T19:44:53.568Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allshore-talent-vs-cgs-business-solutions#article",
  "headline": "Allshore Talent vs CGS Business Solutions: Comparison",
  "description": "Detailed comparison of Allshore Talent and CGS Business Solutions. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.568Z",
  "dateModified": "2025-11-30T19:44:53.568Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.568Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.568Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
