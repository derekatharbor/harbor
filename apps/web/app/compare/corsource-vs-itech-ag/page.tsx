...
// Comparing: CorSource vs iTech AG

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CorSource vs iTech AG (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CorSource and iTech AG. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CorSource vs iTech AG',
    description: 'Detailed comparison of CorSource and iTech AG.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/corsource-vs-itech-ag#article",
  "headline": "CorSource vs iTech AG: Comparison",
  "description": "Detailed comparison of CorSource and iTech AG. Features, pricing, and integrations compared side-by-side.",
