...
// Comparing: TiDB, powered by PingCAP vs Tiger Data (creators of TimescaleDB)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'TiDB, powered by PingCAP vs Tiger Data (creators of TimescaleDB) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of TiDB, powered by PingCAP and Tiger Data (creators of TimescaleDB). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'TiDB, powered by PingCAP vs Tiger Data (creators of TimescaleDB)',
    description: 'Detailed comparison of TiDB, powered by PingCAP and Tiger Data (creators of TimescaleDB).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/tidb-powered-by-pingcap-vs-tiger-data-creators-of-timescaledb#article",
  "headline": "TiDB, powered by PingCAP vs Tiger Data (creators of TimescaleDB): Comparison",
  "description": "Detailed comparison of TiDB, powered by PingCAP and Tiger Data (creators of TimescaleDB). Features, pricing, and integrations compared side-by-side.",
