...
// Comparing: Cloudaction (An AiRo Company) vs Woflow

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cloudaction (An AiRo Company) vs Woflow (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cloudaction (An AiRo Company) and Woflow. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cloudaction (An AiRo Company) vs Woflow',
    description: 'Detailed comparison of Cloudaction (An AiRo Company) and Woflow.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cloudaction-an-airo-company-vs-woflow#article",
  "headline": "Cloudaction (An AiRo Company) vs Woflow: Comparison",
  "description": "Detailed comparison of Cloudaction (An AiRo Company) and Woflow. Features, pricing, and integrations compared side-by-side.",
