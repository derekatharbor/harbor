...
// Comparing: Secuvy vs TechR2

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Secuvy vs TechR2 (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Secuvy and TechR2. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Secuvy vs TechR2',
    description: 'Detailed comparison of Secuvy and TechR2.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/secuvy-vs-techr2#article",
  "headline": "Secuvy vs TechR2: Comparison",
  "description": "Detailed comparison of Secuvy and TechR2. Features, pricing, and integrations compared side-by-side.",
