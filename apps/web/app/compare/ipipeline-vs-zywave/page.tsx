...
// Comparing: iPipeline vs Zywave

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'iPipeline vs Zywave (November 30, 2025) | Harbor',
  description: 'Detailed comparison of iPipeline and Zywave. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'iPipeline vs Zywave',
    description: 'Detailed comparison of iPipeline and Zywave.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ipipeline-vs-zywave#article",
  "headline": "iPipeline vs Zywave: Comparison",
  "description": "Detailed comparison of iPipeline and Zywave. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "iPipeline",
      "url": "https://useharbor.io/brands/ipipeline"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Zywave",
      "url": "https://useharbor.io/brands/zywave"
    }
  ]
}
...
const brand1 = {
  "slug": "ipipeline",
  "brand_name": "iPipeline",
  "domain": "ipipeline.com",
  "category": "Insurance Technology",
  "summary": "iPipeline provides software solutions for the life insurance and annuities industry.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "AgencyIntegrator™",
    "AlphaTrust® e-Sign",
    "DocFast® Document Delivery",
    "IFS Onboarding",
    "iGO® Intelligent e-App",
    "WELiS® Illustrations",
    "InsureSight®",
...
const brand2 = {
  ...
  "domain": "zywave.com",
  "category": "Insurance Technology",
  "summary": "Zywave provides leading insurance technology solutions for insurers.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
