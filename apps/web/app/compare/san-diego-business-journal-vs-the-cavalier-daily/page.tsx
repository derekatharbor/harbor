...
// Comparing: San Diego Business Journal vs The Cavalier Daily

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'San Diego Business Journal vs The Cavalier Daily (November 30, 2025) | Harbor',
  description: 'Detailed comparison of San Diego Business Journal and The Cavalier Daily. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'San Diego Business Journal vs The Cavalier Daily',
    description: 'Detailed comparison of San Diego Business Journal and The Cavalier Daily.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/san-diego-business-journal-vs-the-cavalier-daily#article",
  "headline": "San Diego Business Journal vs The Cavalier Daily: Comparison",
  "description": "Detailed comparison of San Diego Business Journal and The Cavalier Daily. Features, pricing, and integrations compared side-by-side.",
