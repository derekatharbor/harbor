...
// Comparing: Caliza vs iuvity

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Caliza vs iuvity (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Caliza and iuvity. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Caliza vs iuvity',
    description: 'Detailed comparison of Caliza and iuvity.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/caliza-vs-iuvity#article",
  "headline": "Caliza vs iuvity: Comparison",
  "description": "Detailed comparison of Caliza and iuvity. Features, pricing, and integrations compared side-by-side.",
