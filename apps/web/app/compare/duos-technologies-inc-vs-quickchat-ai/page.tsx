...
// Generated: 2025-11-30T20:05:20.243Z
// Comparing: Duos Technologies, Inc. vs Quickchat AI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Duos Technologies, Inc. vs Quickchat AI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Duos Technologies, Inc. and Quickchat AI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Duos Technologies, Inc. vs Quickchat AI',
    description: 'Detailed comparison of Duos Technologies, Inc. and Quickchat AI.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.243Z',
    modifiedTime: '2025-11-30T20:05:20.243Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/duos-technologies-inc-vs-quickchat-ai#article",
  "headline": "Duos Technologies, Inc. vs Quickchat AI: Comparison",
  "description": "Detailed comparison of Duos Technologies, Inc. and Quickchat AI. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.243Z",
  "dateModified": "2025-11-30T20:05:20.243Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.243Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.243Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
