...
// Comparing: Consensus vs Tools for Humanity

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Consensus vs Tools for Humanity (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Consensus and Tools for Humanity. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Consensus vs Tools for Humanity',
    description: 'Detailed comparison of Consensus and Tools for Humanity.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/consensus-vs-tools-for-humanity#article",
  "headline": "Consensus vs Tools for Humanity: Comparison",
  "description": "Detailed comparison of Consensus and Tools for Humanity. Features, pricing, and integrations compared side-by-side.",
