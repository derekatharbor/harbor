...
// Comparing: A2Go - Agentic AI for Supply Chain Operations vs Softeon

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'A2Go - Agentic AI for Supply Chain Operations vs Softeon (November 30, 2025) | Harbor',
  description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Softeon. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'A2Go - Agentic AI for Supply Chain Operations vs Softeon',
    description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Softeon.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/a2go-agentic-ai-for-supply-chain-operations-vs-softeon#article",
  "headline": "A2Go - Agentic AI for Supply Chain Operations vs Softeon: Comparison",
  "description": "Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Softeon. Features, pricing, and integrations compared side-by-side.",
