...
// Generated: 2025-11-30T20:05:20.286Z
// Comparing: CuroGens - A Hoalani Group Company vs Merit Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CuroGens - A Hoalani Group Company vs Merit Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CuroGens - A Hoalani Group Company and Merit Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CuroGens - A Hoalani Group Company vs Merit Solutions',
    description: 'Detailed comparison of CuroGens - A Hoalani Group Company and Merit Solutions.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.286Z',
    modifiedTime: '2025-11-30T20:05:20.286Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/curogens-a-hoalani-group-company-vs-merit-solutions#article",
  "headline": "CuroGens - A Hoalani Group Company vs Merit Solutions: Comparison",
  "description": "Detailed comparison of CuroGens - A Hoalani Group Company and Merit Solutions. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.286Z",
  "dateModified": "2025-11-30T20:05:20.286Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "CuroGens - A Hoalani Group Company",
      "url": "https://useharbor.io/brands/curogens-a-hoalani-group-company"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Merit Solutions",
      "url": "https://useharbor.io/brands/merit-solutions"
    }
  ]
}

const brand1 = {
  "slug": "curogens-a-hoalani-group-company",
  "brand_name": "CuroGens - A Hoalani Group Company",
  "domain": "curogens.com",
  "category": "ERP Solutions",
  "summary": "CuroGens specializes in ERP solutions and digital transformation services.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Offers a free consultation and a free downloadable tool for assessing digital transformation complexity.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
...
const brand2 = {
  "slug": "merit-solutions",
  "brand_name": "Merit Solutions",
  "domain": "meritsolutions.com",
  "category": "ERP Solutions",
  "summary": "Cloud-first ERP solutions tailored for life science organizations.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Offers a free-to-use app for specific use cases.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
    "Real-time tracking of equipment use and status",
    "Streamlined workflows via task-based apps",
    "Biometric authentication for safety and security",
    "Quality management processes including deviations and CAPAs",
    "Automated quality audits and compliance management"
  ],
  "integrations": [
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.286Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.286Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
