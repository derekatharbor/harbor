...
// Comparing: MANDEX INC vs SEnergy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'MANDEX INC vs SEnergy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of MANDEX INC and SEnergy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'MANDEX INC vs SEnergy',
    description: 'Detailed comparison of MANDEX INC and SEnergy.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/mandex-inc-vs-senergy#article",
  "headline": "MANDEX INC vs SEnergy: Comparison",
  "description": "Detailed comparison of MANDEX INC and SEnergy. Features, pricing, and integrations compared side-by-side.",
