...
// Generated: 2025-11-30T20:05:20.361Z
// Comparing: Bass Computers, Inc. vs INDUS Corporation

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Bass Computers, Inc. vs INDUS Corporation (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Bass Computers, Inc. and INDUS Corporation. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Bass Computers, Inc. vs INDUS Corporation',
    description: 'Detailed comparison of Bass Computers, Inc. and INDUS Corporation.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.361Z',
    modifiedTime: '2025-11-30T20:05:20.361Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bass-computers-inc-vs-indus-corporation#article",
  "headline": "Bass Computers, Inc. vs INDUS Corporation: Comparison",
  "description": "Detailed comparison of Bass Computers, Inc. and INDUS Corporation. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.361Z",
  "dateModified": "2025-11-30T20:05:20.361Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "Bass Computers, Inc.",
      "url": "https://useharbor.io/brands/bass-computers-inc"
    },
    {
      "@type": "SoftwareApplication",
      "name": "INDUS Corporation",
      "url": "https://useharbor.io/brands/indus-corporation"
    }
  ]
}

const brand1 = {
  "slug": "bass-computers-inc",
  "brand_name": "Bass Computers, Inc.",
  "domain": "basscomputers.com",
  "category": "Wholesale Distribution",
  "summary": "A leading distributor of computers and IT solutions.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Price listed for NVIDIA DGX A100 640GB",
    "has_free_tier": false,
    "starting_price": "$99,000"
  },
  "features": [
    "Wholesale distribution of computers and parts",
    "Refurbished systems with a 3-year warranty",
...
const brand2 = {
  "slug": "indus-corporation",
  "brand_name": "INDUS Corporation",
  "domain": "indus-corporation.com",
  "category": "Wholesale Distribution",
  "summary": "A leading distributor of industrial automation products.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "Wholesale distribution of industrial automation products",
    "High-quality Honeywell products",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.361Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.361Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
