...
// Comparing: Deepgram vs Wispr Flow

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Deepgram vs Wispr Flow (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Deepgram and Wispr Flow. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Deepgram vs Wispr Flow',
    description: 'Detailed comparison of Deepgram and Wispr Flow.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/deepgram-vs-wispr-flow#article",
  "headline": "Deepgram vs Wispr Flow: Comparison",
  "description": "Detailed comparison of Deepgram and Wispr Flow. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "Wispr Flow",
      "url": "https://useharbor.io/brands/wispr-flow"
    }
  ]
}
...
const brand2 = {
  "slug": "wispr-flow",
  "brand_name": "Wispr Flow",
  "domain": "wisprflow.ai",
  "category": "Voice Technology",
  "summary": "Wispr Flow is a voice dictation platform that enhances productivity through effortless voice-to-text technology.",
  "pricing": {
  ...
  "features": [
    ...
    "Advanced security and compliance features (Enterprise)"
  ],
  "integrations": [
    "Arc",
    "Cursor",
