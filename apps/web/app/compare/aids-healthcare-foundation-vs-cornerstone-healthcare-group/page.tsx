...
// Comparing: AIDS Healthcare Foundation vs Cornerstone Healthcare Group

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AIDS Healthcare Foundation vs Cornerstone Healthcare Group (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AIDS Healthcare Foundation and Cornerstone Healthcare Group. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AIDS Healthcare Foundation vs Cornerstone Healthcare Group',
    description: 'Detailed comparison of AIDS Healthcare Foundation and Cornerstone Healthcare Group.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aids-healthcare-foundation-vs-cornerstone-healthcare-group#article",
  "headline": "AIDS Healthcare Foundation vs Cornerstone Healthcare Group: Comparison",
  "description": "Detailed comparison of AIDS Healthcare Foundation and Cornerstone Healthcare Group. Features, pricing, and integrations compared side-by-side.",
