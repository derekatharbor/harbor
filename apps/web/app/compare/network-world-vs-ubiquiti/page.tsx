...
// Comparing: Network World vs Ubiquiti

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Network World vs Ubiquiti (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Network World and Ubiquiti. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Network World vs Ubiquiti',
    description: 'Detailed comparison of Network World and Ubiquiti.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/network-world-vs-ubiquiti#article",
  "headline": "Network World vs Ubiquiti: Comparison",
  "description": "Detailed comparison of Network World and Ubiquiti. Features, pricing, and integrations compared side-by-side.",
