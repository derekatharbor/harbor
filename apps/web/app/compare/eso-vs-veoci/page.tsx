...
// Comparing: ESO vs Veoci

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ESO vs Veoci (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ESO and Veoci. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ESO vs Veoci',
    description: 'Detailed comparison of ESO and Veoci.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/eso-vs-veoci#article",
  "headline": "ESO vs Veoci: Comparison",
  "description": "Detailed comparison of ESO and Veoci. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "Veoci",
      "url": "https://useharbor.io/brands/veoci"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "veoci.com",
  "category": "Emergency Management Software",
  "summary": "Veoci provides software solutions for emergency management and business continuity.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
