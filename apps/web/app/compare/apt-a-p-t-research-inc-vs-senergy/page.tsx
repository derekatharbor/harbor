...
// Comparing: APT (A-P-T Research, Inc.) vs SEnergy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'APT (A-P-T Research, Inc.) vs SEnergy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of APT (A-P-T Research, Inc.) and SEnergy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'APT (A-P-T Research, Inc.) vs SEnergy',
    description: 'Detailed comparison of APT (A-P-T Research, Inc.) and SEnergy.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/apt-a-p-t-research-inc-vs-senergy#article",
  "headline": "APT (A-P-T Research, Inc.) vs SEnergy: Comparison",
  "description": "Detailed comparison of APT (A-P-T Research, Inc.) and SEnergy. Features, pricing, and integrations compared side-by-side.",
