...
// Comparing: Fetcher vs XOR

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Fetcher vs XOR (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Fetcher and XOR. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Fetcher vs XOR',
    description: 'Detailed comparison of Fetcher and XOR.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/fetcher-vs-xor#article",
  "headline": "Fetcher vs XOR: Comparison",
  "description": "Detailed comparison of Fetcher and XOR. Features, pricing, and integrations compared side-by-side.",
