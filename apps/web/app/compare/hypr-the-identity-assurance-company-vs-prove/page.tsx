...
// Generated: 2025-11-30T19:44:53.990Z
// Comparing: HYPR | The Identity Assurance Company vs Prove

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'HYPR | The Identity Assurance Company vs Prove (November 30, 2025) | Harbor',
  description: 'Detailed comparison of HYPR | The Identity Assurance Company and Prove. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'HYPR | The Identity Assurance Company vs Prove',
    description: 'Detailed comparison of HYPR | The Identity Assurance Company and Prove.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.990Z',
    modifiedTime: '2025-11-30T19:44:53.990Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hypr-the-identity-assurance-company-vs-prove#article",
  "headline": "HYPR | The Identity Assurance Company vs Prove: Comparison",
  "description": "Detailed comparison of HYPR | The Identity Assurance Company and Prove. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.990Z",
  "dateModified": "2025-11-30T19:44:53.990Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.990Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.990Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
