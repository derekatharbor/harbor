...
// Comparing: For The Record (FTR) vs Legora

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'For The Record (FTR) vs Legora (November 30, 2025) | Harbor',
  description: 'Detailed comparison of For The Record (FTR) and Legora. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'For The Record (FTR) vs Legora',
    description: 'Detailed comparison of For The Record (FTR) and Legora.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/for-the-record-ftr-vs-legora#article",
  "headline": "For The Record (FTR) vs Legora: Comparison",
  "description": "Detailed comparison of For The Record (FTR) and Legora. Features, pricing, and integrations compared side-by-side.",
