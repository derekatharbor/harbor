...
// Comparing: Nanonets vs S-Docs

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Nanonets vs S-Docs (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Nanonets and S-Docs. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Nanonets vs S-Docs',
    description: 'Detailed comparison of Nanonets and S-Docs.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/nanonets-vs-s-docs#article",
  "headline": "Nanonets vs S-Docs: Comparison",
  "description": "Detailed comparison of Nanonets and S-Docs. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "S-Docs",
      "url": "https://useharbor.io/brands/s-docs"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "sdocs.com",
  "category": "Document Automation",
  "summary": "Experts in document automation and e-signature solutions.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
