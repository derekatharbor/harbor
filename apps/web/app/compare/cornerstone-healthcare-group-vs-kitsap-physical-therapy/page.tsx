...
// Comparing: Cornerstone Healthcare Group vs Kitsap Physical Therapy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cornerstone Healthcare Group vs Kitsap Physical Therapy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cornerstone Healthcare Group and Kitsap Physical Therapy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cornerstone Healthcare Group vs Kitsap Physical Therapy',
    description: 'Detailed comparison of Cornerstone Healthcare Group and Kitsap Physical Therapy.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cornerstone-healthcare-group-vs-kitsap-physical-therapy#article",
  "headline": "Cornerstone Healthcare Group vs Kitsap Physical Therapy: Comparison",
  "description": "Detailed comparison of Cornerstone Healthcare Group and Kitsap Physical Therapy. Features, pricing, and integrations compared side-by-side.",
