...
// Comparing: EvenUp vs Legora

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'EvenUp vs Legora (November 30, 2025) | Harbor',
  description: 'Detailed comparison of EvenUp and Legora. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'EvenUp vs Legora',
    description: 'Detailed comparison of EvenUp and Legora.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/evenup-vs-legora#article",
  "headline": "EvenUp vs Legora: Comparison",
  "description": "Detailed comparison of EvenUp and Legora. Features, pricing, and integrations compared side-by-side.",
