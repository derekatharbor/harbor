...
// Comparing: Clear Rate vs PS LIGHTWAVE

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Clear Rate vs PS LIGHTWAVE (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Clear Rate and PS LIGHTWAVE. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Clear Rate vs PS LIGHTWAVE',
    description: 'Detailed comparison of Clear Rate and PS LIGHTWAVE.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/clear-rate-vs-ps-lightwave#article",
  "headline": "Clear Rate vs PS LIGHTWAVE: Comparison",
  "description": "Detailed comparison of Clear Rate and PS LIGHTWAVE. Features, pricing, and integrations compared side-by-side.",
