...
// Comparing: Amnet vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Amnet vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Amnet and ICE Consulting - Managed IT & Cybersecurity for Life Sciences. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Amnet vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences',
    description: 'Detailed comparison of Amnet and ICE Consulting - Managed IT & Cybersecurity for Life Sciences.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amnet-vs-ice-consulting-managed-it-cybersecurity-for-life-sciences#article",
  "headline": "Amnet vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences: Comparison",
  "description": "Detailed comparison of Amnet and ICE Consulting - Managed IT & Cybersecurity for Life Sciences. Features, pricing, and integrations compared side-by-side.",
