...
// Generated: 2025-11-30T20:05:20.281Z
// Comparing: Acoustic vs Cordial

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Acoustic vs Cordial (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Acoustic and Cordial. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Acoustic vs Cordial',
    description: 'Detailed comparison of Acoustic and Cordial.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.281Z',
    modifiedTime: '2025-11-30T20:05:20.281Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/acoustic-vs-cordial#article",
  "headline": "Acoustic vs Cordial: Comparison",
  "description": "Detailed comparison of Acoustic and Cordial. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.281Z",
  "dateModified": "2025-11-30T20:05:20.281Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand2 = {
  ...
  "features": [
    ...
    "Triggered messaging",
    "Message insights and assistant",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.281Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.281Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
