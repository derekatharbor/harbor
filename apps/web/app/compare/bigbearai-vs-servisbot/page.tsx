...
// Generated: 2025-11-30T19:36:57.594Z
// Comparing: BigBear.ai vs ServisBOT

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BigBear.ai vs ServisBOT (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BigBear.ai and ServisBOT. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BigBear.ai vs ServisBOT',
    description: 'Detailed comparison of BigBear.ai and ServisBOT.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.594Z',
    modifiedTime: '2025-11-30T19:36:57.594Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bigbearai-vs-servisbot#article",
  "headline": "BigBear.ai vs ServisBOT: Comparison",
  "description": "Detailed comparison of BigBear.ai and ServisBOT. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.594Z",
  "dateModified": "2025-11-30T19:36:57.594Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand1 = {
  ...
  "features": [
    ...
    "Enterprise Automation and Professional Services"
  ],
  "integrations": []
}
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.594Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.594Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
