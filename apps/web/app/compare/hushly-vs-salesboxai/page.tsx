...
// Comparing: Hushly vs SalesboxAI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Hushly vs SalesboxAI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Hushly and SalesboxAI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Hushly vs SalesboxAI',
    description: 'Detailed comparison of Hushly and SalesboxAI.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hushly-vs-salesboxai#article",
  "headline": "Hushly vs SalesboxAI: Comparison",
  "description": "Detailed comparison of Hushly and SalesboxAI. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Hushly",
      "url": "https://useharbor.io/brands/hushly"
    },
    {
      "@type": "SoftwareApplication",
      "name": "SalesboxAI",
...
const brand1 = {
  ...
  "summary": "A B2B experience and conversion platform designed for marketers.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
