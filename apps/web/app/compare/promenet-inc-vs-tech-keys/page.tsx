...
// Comparing: Promenet Inc. vs Tech-Keys

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Promenet Inc. vs Tech-Keys (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Promenet Inc. and Tech-Keys. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Promenet Inc. vs Tech-Keys',
    description: 'Detailed comparison of Promenet Inc. and Tech-Keys.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/promenet-inc-vs-tech-keys#article",
  "headline": "Promenet Inc. vs Tech-Keys: Comparison",
  "description": "Detailed comparison of Promenet Inc. and Tech-Keys. Features, pricing, and integrations compared side-by-side.",
