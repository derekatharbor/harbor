...
// Comparing: Manta, an IBM Company vs Quantum

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Manta, an IBM Company vs Quantum (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Manta, an IBM Company and Quantum. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Manta, an IBM Company vs Quantum',
    description: 'Detailed comparison of Manta, an IBM Company and Quantum.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/manta-an-ibm-company-vs-quantum#article",
  "headline": "Manta, an IBM Company vs Quantum: Comparison",
  "description": "Detailed comparison of Manta, an IBM Company and Quantum. Features, pricing, and integrations compared side-by-side.",
