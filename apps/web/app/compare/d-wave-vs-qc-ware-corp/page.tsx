...
// Comparing: D-Wave vs QC Ware Corp.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'D-Wave vs QC Ware Corp. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of D-Wave and QC Ware Corp.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'D-Wave vs QC Ware Corp.',
    description: 'Detailed comparison of D-Wave and QC Ware Corp..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/d-wave-vs-qc-ware-corp#article",
  "headline": "D-Wave vs QC Ware Corp.: Comparison",
  "description": "Detailed comparison of D-Wave and QC Ware Corp.. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "QC Ware Corp.",
      "url": "https://useharbor.io/brands/qc-ware-corp"
    }
  ]
}
...
const brand2 = {
  "slug": "qc-ware-corp",
  "brand_name": "QC Ware Corp.",
  "domain": "qcware.com",
  "category": "Quantum Computing",
  "summary": "A leader in quantum computing solutions for molecular discovery.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Highly-accurate DFT calculations",
    "Easy-to-use drag-and-drop GUI",
    "Custom workflows with API",
    "Handles large systems previously intractable with quantum methods"
  ],
  "integrations": []
}
