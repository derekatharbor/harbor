...
// Comparing: DNSFilter vs NetCentrics

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DNSFilter vs NetCentrics (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DNSFilter and NetCentrics. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DNSFilter vs NetCentrics',
    description: 'Detailed comparison of DNSFilter and NetCentrics.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dnsfilter-vs-netcentrics#article",
  "headline": "DNSFilter vs NetCentrics: Comparison",
  "description": "Detailed comparison of DNSFilter and NetCentrics. Features, pricing, and integrations compared side-by-side.",
