...
// Comparing: 5Q vs MartinFed

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '5Q vs MartinFed (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 5Q and MartinFed. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '5Q vs MartinFed',
    description: 'Detailed comparison of 5Q and MartinFed.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/5q-vs-martinfed#article",
  "headline": "5Q vs MartinFed: Comparison",
  "description": "Detailed comparison of 5Q and MartinFed. Features, pricing, and integrations compared side-by-side.",
