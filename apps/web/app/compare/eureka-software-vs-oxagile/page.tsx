...
// Comparing: Eureka Software vs Oxagile

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Eureka Software vs Oxagile (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Eureka Software and Oxagile. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Eureka Software vs Oxagile',
    description: 'Detailed comparison of Eureka Software and Oxagile.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/eureka-software-vs-oxagile#article",
  "headline": "Eureka Software vs Oxagile: Comparison",
  "description": "Detailed comparison of Eureka Software and Oxagile. Features, pricing, and integrations compared side-by-side.",
