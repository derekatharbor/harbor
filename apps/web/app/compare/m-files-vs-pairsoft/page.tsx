...
// Comparing: M-Files vs PairSoft

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'M-Files vs PairSoft (November 30, 2025) | Harbor',
  description: 'Detailed comparison of M-Files and PairSoft. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'M-Files vs PairSoft',
    description: 'Detailed comparison of M-Files and PairSoft.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/m-files-vs-pairsoft#article",
  "headline": "M-Files vs PairSoft: Comparison",
  "description": "Detailed comparison of M-Files and PairSoft. Features, pricing, and integrations compared side-by-side.",
