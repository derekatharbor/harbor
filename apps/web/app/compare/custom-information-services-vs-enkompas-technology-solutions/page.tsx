...
// Comparing: Custom Information Services vs enkompas Technology Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Custom Information Services vs enkompas Technology Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Custom Information Services and enkompas Technology Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Custom Information Services vs enkompas Technology Solutions',
    description: 'Detailed comparison of Custom Information Services and enkompas Technology Solutions.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/custom-information-services-vs-enkompas-technology-solutions#article",
  "headline": "Custom Information Services vs enkompas Technology Solutions: Comparison",
  "description": "Detailed comparison of Custom Information Services and enkompas Technology Solutions. Features, pricing, and integrations compared side-by-side.",
