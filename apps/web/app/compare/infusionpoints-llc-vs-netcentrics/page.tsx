...
// Comparing: InfusionPoints, LLC vs NetCentrics

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'InfusionPoints, LLC vs NetCentrics (November 30, 2025) | Harbor',
  description: 'Detailed comparison of InfusionPoints, LLC and NetCentrics. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'InfusionPoints, LLC vs NetCentrics',
    description: 'Detailed comparison of InfusionPoints, LLC and NetCentrics.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infusionpoints-llc-vs-netcentrics#article",
  "headline": "InfusionPoints, LLC vs NetCentrics: Comparison",
  "description": "Detailed comparison of InfusionPoints, LLC and NetCentrics. Features, pricing, and integrations compared side-by-side.",
