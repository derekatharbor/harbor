...
// Comparing: DMSi Software vs Smart ERP Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DMSi Software vs Smart ERP Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DMSi Software and Smart ERP Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DMSi Software vs Smart ERP Solutions',
    description: 'Detailed comparison of DMSi Software and Smart ERP Solutions.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dmsi-software-vs-smart-erp-solutions#article",
  "headline": "DMSi Software vs Smart ERP Solutions: Comparison",
  "description": "Detailed comparison of DMSi Software and Smart ERP Solutions. Features, pricing, and integrations compared side-by-side.",
