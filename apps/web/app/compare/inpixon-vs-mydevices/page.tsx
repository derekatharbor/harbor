...
// Comparing: Inpixon vs myDevices

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Inpixon vs myDevices (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Inpixon and myDevices. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Inpixon vs myDevices',
    description: 'Detailed comparison of Inpixon and myDevices.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/inpixon-vs-mydevices#article",
  "headline": "Inpixon vs myDevices: Comparison",
  "description": "Detailed comparison of Inpixon and myDevices. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Inpixon",
      "url": "https://useharbor.io/brands/inpixon"
    },
    {
      "@type": "SoftwareApplication",
      "name": "myDevices",
      "url": "https://useharbor.io/brands/mydevices"
    }
  ]
}
...
const brand1 = {
  ...
  "domain": "inpixon.com",
  "category": "IoT",
  "summary": "Innovator of Indoor Intelligence and Real-Time Location Systems.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "mydevices",
  "brand_name": "myDevices",
  "domain": "mydevices.com",
  "category": "IoT",
  "summary": "myDevices provides comprehensive IoT solutions for sensor deployment and management.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "Free tier available for up to 5 devices on the POC Plan.",
    "has_free_tier": true,
    "starting_price": "$5/mo"
  },
  "features": [
    "Quick deployment of IoT sensor solutions",
    "Support for over 1,000 pre-provisioned sensors",
    "Single integration for connecting sensors to any platform",
    "Middleware for visualization and management",
    "Support for various connectivity options (LoRa, Cellular, NBIoT, Modbus, SCADA)"
  ],
  "integrations": [
    "Salesforce",
    "AWS Kinesis",
