...
// Comparing: ENA by Zayo vs Nitel

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ENA by Zayo vs Nitel (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ENA by Zayo and Nitel. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ENA by Zayo vs Nitel',
    description: 'Detailed comparison of ENA by Zayo and Nitel.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ena-by-zayo-vs-nitel#article",
  "headline": "ENA by Zayo vs Nitel: Comparison",
  "description": "Detailed comparison of ENA by Zayo and Nitel. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "ENA by Zayo",
      "url": "https://useharbor.io/brands/ena-by-zayo"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Nitel",
      "url": "https://useharbor.io/brands/nitel"
    }
  ]
}
...
const brand1 = {
  "slug": "ena-by-zayo",
  "brand_name": "ENA by Zayo",
  "domain": "zayoeducation.com",
  "category": "Network Services",
  "summary": "Global internet backbone service provider specializing in connectivity solutions.",
  "pricing": {
    "price_model": "custom",
...
const brand2 = {
  ...
  "domain": "nitelusa.com",
  "category": "Network Services",
  "summary": "Nitel is a leading provider of network-as-a-service solutions.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Pricing is highly competitive and tailored for partners.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
    "Global Managed NaaS Solutions",
    "SD-WAN",
    ...
    "Satellite MPLS",
    "Private Line Cloud Connection Service"
  ],
  "integrations": [
    "SD-WAN",
    "voice",
