...
// Comparing: AMAX vs Outdefine

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AMAX vs Outdefine (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AMAX and Outdefine. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AMAX vs Outdefine',
    description: 'Detailed comparison of AMAX and Outdefine.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amax-vs-outdefine#article",
  "headline": "AMAX vs Outdefine: Comparison",
  "description": "Detailed comparison of AMAX and Outdefine. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "AMAX",
      "url": "https://useharbor.io/brands/amax"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Outdefine",
      "url": "https://useharbor.io/brands/outdefine"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "Experts in AI and HPC Infrastructure.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "Designs and builds high-performance AI infrastructure",
    "Advanced air or liquid-cooling solutions",
    "End-to-end services for AI development",
    "Custom solutions for actionable insights",
    "Supports multi-tenant environments for cloud services"
  ],
  "integrations": []
}
...
const brand2 = {
  "slug": "outdefine",
  "brand_name": "Outdefine",
  "domain": "outdefine.com",
  "category": "AI Infrastructure",
  "summary": "Outdefine provides AI infrastructure for healthcare and life sciences.",
  "pricing": {
    "price_model": "custom",
  ...
  "features": [
    "Agentic Intelligence Matrix for AI coordination",
    "Synthetic Data Engine for privacy-preserving data generation",
    "Generative Model Fabric for explainable AI systems",
    "Automated recruitment and validation processes",
    "Compliance with HIPAA, FDA GxP, SOC 2, and IRB standards"
  ],
  "integrations": [
    "Accenture",
    "Baylor Health",
