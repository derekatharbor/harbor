...
// Generated: 2025-11-30T19:36:57.619Z
// Comparing: ALOIS Solutions vs Arkhya Tech. Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALOIS Solutions vs Arkhya Tech. Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALOIS Solutions and Arkhya Tech. Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALOIS Solutions vs Arkhya Tech. Inc.',
    description: 'Detailed comparison of ALOIS Solutions and Arkhya Tech. Inc..',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.619Z',
    modifiedTime: '2025-11-30T19:36:57.619Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/alois-solutions-vs-arkhya-tech-inc#article",
  "headline": "ALOIS Solutions vs Arkhya Tech. Inc.: Comparison",
  "description": "Detailed comparison of ALOIS Solutions and Arkhya Tech. Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.619Z",
  "dateModified": "2025-11-30T19:36:57.619Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.619Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.619Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
