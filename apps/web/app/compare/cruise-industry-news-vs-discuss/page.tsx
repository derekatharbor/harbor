...
// Generated: 2025-11-30T19:44:54.063Z
// Comparing: Cruise Industry News vs Discuss

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cruise Industry News vs Discuss (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cruise Industry News and Discuss. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cruise Industry News vs Discuss',
    description: 'Detailed comparison of Cruise Industry News and Discuss.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.063Z',
    modifiedTime: '2025-11-30T19:44:54.063Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cruise-industry-news-vs-discuss#article",
  "headline": "Cruise Industry News vs Discuss: Comparison",
  "description": "Detailed comparison of Cruise Industry News and Discuss. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.063Z",
  "dateModified": "2025-11-30T19:44:54.063Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.063Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.063Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
