  ...
  "about": [
    {
      ...
      "name": "Society for Medical Decision Making (SMDM)",
      "url": "https://useharbor.io/brands/society-for-medical-decision-making-smdm"
    },
    {
      "@type": "SoftwareApplication",
      "name": "St. Luke's Health System",
      "url": "https://useharbor.io/brands/st-lukes-health-system"
    }
  ]
}

const brand1 = {
  "slug": "society-for-medical-decision-making-smdm",
  "brand_name": "Society for Medical Decision Making (SMDM)",
  "domain": "smdm.org",
  "category": "Health Care",
  "summary": "An international organization dedicated to improving health care decision making.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Training in decision science methods",
    "Collaboration opportunities",
    "Professional growth and networking",
    "Support for health policy development"
  ],
  "integrations": []
}

const brand2 = {
  "slug": "st-lukes-health-system",
  "brand_name": "St. Luke's Health System",
  "domain": "stlukesonline.org",
  "category": "Health Care",
  "summary": "A not-for-profit health system serving Idaho and Eastern Oregon.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
