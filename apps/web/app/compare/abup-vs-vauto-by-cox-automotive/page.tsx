...
// Comparing: ABUP vs vAuto by Cox Automotive

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ABUP vs vAuto by Cox Automotive (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ABUP and vAuto by Cox Automotive. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ABUP vs vAuto by Cox Automotive',
    description: 'Detailed comparison of ABUP and vAuto by Cox Automotive.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/abup-vs-vauto-by-cox-automotive#article",
  "headline": "ABUP vs vAuto by Cox Automotive: Comparison",
  "description": "Detailed comparison of ABUP and vAuto by Cox Automotive. Features, pricing, and integrations compared side-by-side.",
