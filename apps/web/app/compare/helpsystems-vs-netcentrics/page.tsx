...
// Comparing: HelpSystems vs NetCentrics

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'HelpSystems vs NetCentrics (November 30, 2025) | Harbor',
  description: 'Detailed comparison of HelpSystems and NetCentrics. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'HelpSystems vs NetCentrics',
    description: 'Detailed comparison of HelpSystems and NetCentrics.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/helpsystems-vs-netcentrics#article",
  "headline": "HelpSystems vs NetCentrics: Comparison",
  "description": "Detailed comparison of HelpSystems and NetCentrics. Features, pricing, and integrations compared side-by-side.",
