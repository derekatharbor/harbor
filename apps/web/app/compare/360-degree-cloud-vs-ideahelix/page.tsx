...
// Generated: 2025-11-30T20:05:20.289Z
// Comparing: 360 Degree Cloud vs ideaHelix

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '360 Degree Cloud vs ideaHelix (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 360 Degree Cloud and ideaHelix. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '360 Degree Cloud vs ideaHelix',
    description: 'Detailed comparison of 360 Degree Cloud and ideaHelix.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.289Z',
    modifiedTime: '2025-11-30T20:05:20.289Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/360-degree-cloud-vs-ideahelix#article",
  "headline": "360 Degree Cloud vs ideaHelix: Comparison",
  "description": "Detailed comparison of 360 Degree Cloud and ideaHelix. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.289Z",
  "dateModified": "2025-11-30T20:05:20.289Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.289Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.289Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
