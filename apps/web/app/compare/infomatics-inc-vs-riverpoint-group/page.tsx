...
// Generated: 2025-11-30T20:05:20.450Z
// Comparing: Infomatics, Inc vs RiverPoint Group

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Infomatics, Inc vs RiverPoint Group (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Infomatics, Inc and RiverPoint Group. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Infomatics, Inc vs RiverPoint Group',
    description: 'Detailed comparison of Infomatics, Inc and RiverPoint Group.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.450Z',
    modifiedTime: '2025-11-30T20:05:20.450Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infomatics-inc-vs-riverpoint-group#article",
  "headline": "Infomatics, Inc vs RiverPoint Group: Comparison",
  "description": "Detailed comparison of Infomatics, Inc and RiverPoint Group. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.450Z",
  "dateModified": "2025-11-30T20:05:20.450Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.450Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.450Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
