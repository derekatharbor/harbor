...
// Comparing: ServisBOT vs ShimentoX Technologies

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ServisBOT vs ShimentoX Technologies (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ServisBOT and ShimentoX Technologies. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ServisBOT vs ShimentoX Technologies',
    description: 'Detailed comparison of ServisBOT and ShimentoX Technologies.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/servisbot-vs-shimentox-technologies#article",
  "headline": "ServisBOT vs ShimentoX Technologies: Comparison",
  "description": "Detailed comparison of ServisBOT and ShimentoX Technologies. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Enterprise Search & Product Discovery",
    "Supply Chain Optimization",
    "Personalized Shopping Experiences",
    "AI Technology Assistance Center (TAC)"
  ],
  "integrations": []
}
