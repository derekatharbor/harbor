...
// Comparing: 3GC Group vs MicroAge

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '3GC Group vs MicroAge (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 3GC Group and MicroAge. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '3GC Group vs MicroAge',
    description: 'Detailed comparison of 3GC Group and MicroAge.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/3gc-group-vs-microage#article",
  "headline": "3GC Group vs MicroAge: Comparison",
  "description": "Detailed comparison of 3GC Group and MicroAge. Features, pricing, and integrations compared side-by-side.",
