...
// Generated: 2025-11-30T20:05:20.160Z
// Comparing: Ryan Consulting Group, Inc. vs Trillion Technology Solutions, Inc

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Ryan Consulting Group, Inc. vs Trillion Technology Solutions, Inc (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Ryan Consulting Group, Inc. and Trillion Technology Solutions, Inc. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Ryan Consulting Group, Inc. vs Trillion Technology Solutions, Inc',
    description: 'Detailed comparison of Ryan Consulting Group, Inc. and Trillion Technology Solutions, Inc.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.160Z',
    modifiedTime: '2025-11-30T20:05:20.160Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ryan-consulting-group-inc-vs-trillion-technology-solutions-inc#article",
  "headline": "Ryan Consulting Group, Inc. vs Trillion Technology Solutions, Inc: Comparison",
  "description": "Detailed comparison of Ryan Consulting Group, Inc. and Trillion Technology Solutions, Inc. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.160Z",
  "dateModified": "2025-11-30T20:05:20.160Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.160Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.160Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
