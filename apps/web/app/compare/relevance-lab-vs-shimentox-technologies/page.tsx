...
// Generated: 2025-11-30T19:44:53.500Z
// Comparing: Relevance Lab vs ShimentoX Technologies

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Relevance Lab vs ShimentoX Technologies (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Relevance Lab and ShimentoX Technologies. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Relevance Lab vs ShimentoX Technologies',
    description: 'Detailed comparison of Relevance Lab and ShimentoX Technologies.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.500Z',
    modifiedTime: '2025-11-30T19:44:53.500Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/relevance-lab-vs-shimentox-technologies#article",
  "headline": "Relevance Lab vs ShimentoX Technologies: Comparison",
  "description": "Detailed comparison of Relevance Lab and ShimentoX Technologies. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.500Z",
  "dateModified": "2025-11-30T19:44:53.500Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.500Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.500Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
