...
// Comparing: Gala vs HUBX

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Gala vs HUBX (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Gala and HUBX. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Gala vs HUBX',
    description: 'Detailed comparison of Gala and HUBX.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gala-vs-hubx#article",
  "headline": "Gala vs HUBX: Comparison",
  "description": "Detailed comparison of Gala and HUBX. Features, pricing, and integrations compared side-by-side.",
