...
// Generated: 2025-11-30T19:44:54.032Z
// Comparing: Practice Fusion vs Prescryptive Health, Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Practice Fusion vs Prescryptive Health, Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Practice Fusion and Prescryptive Health, Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Practice Fusion vs Prescryptive Health, Inc.',
    description: 'Detailed comparison of Practice Fusion and Prescryptive Health, Inc..',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.032Z',
    modifiedTime: '2025-11-30T19:44:54.032Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/practice-fusion-vs-prescryptive-health-inc#article",
  "headline": "Practice Fusion vs Prescryptive Health, Inc.: Comparison",
  "description": "Detailed comparison of Practice Fusion and Prescryptive Health, Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.032Z",
  "dateModified": "2025-11-30T19:44:54.032Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.032Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.032Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
