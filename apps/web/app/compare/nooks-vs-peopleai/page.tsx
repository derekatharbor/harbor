...
// Comparing: Nooks vs People.ai

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Nooks vs People.ai (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Nooks and People.ai. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Nooks vs People.ai',
    description: 'Detailed comparison of Nooks and People.ai.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/nooks-vs-peopleai#article",
  "headline": "Nooks vs People.ai: Comparison",
  "description": "Detailed comparison of Nooks and People.ai. Features, pricing, and integrations compared side-by-side.",
