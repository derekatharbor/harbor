...
// Comparing: Allshore Talent vs Donnelly & Moore Corporation

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Allshore Talent vs Donnelly & Moore Corporation (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Allshore Talent and Donnelly & Moore Corporation. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Allshore Talent vs Donnelly & Moore Corporation',
    description: 'Detailed comparison of Allshore Talent and Donnelly & Moore Corporation.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allshore-talent-vs-donnelly-moore-corporation#article",
  "headline": "Allshore Talent vs Donnelly & Moore Corporation: Comparison",
  "description": "Detailed comparison of Allshore Talent and Donnelly & Moore Corporation. Features, pricing, and integrations compared side-by-side.",
