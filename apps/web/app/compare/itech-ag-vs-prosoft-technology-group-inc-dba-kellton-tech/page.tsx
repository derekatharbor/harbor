...
// Comparing: iTech AG vs ProSoft Technology Group Inc.dba Kellton Tech

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'iTech AG vs ProSoft Technology Group Inc.dba Kellton Tech (November 30, 2025) | Harbor',
  description: 'Detailed comparison of iTech AG and ProSoft Technology Group Inc.dba Kellton Tech. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'iTech AG vs ProSoft Technology Group Inc.dba Kellton Tech',
    description: 'Detailed comparison of iTech AG and ProSoft Technology Group Inc.dba Kellton Tech.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/itech-ag-vs-prosoft-technology-group-inc-dba-kellton-tech#article",
  "headline": "iTech AG vs ProSoft Technology Group Inc.dba Kellton Tech: Comparison",
  "description": "Detailed comparison of iTech AG and ProSoft Technology Group Inc.dba Kellton Tech. Features, pricing, and integrations compared side-by-side.",
