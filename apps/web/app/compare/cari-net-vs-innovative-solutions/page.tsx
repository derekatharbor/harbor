...
// Generated: 2025-11-30T19:44:53.936Z
// Comparing: CARI.net vs Innovative Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CARI.net vs Innovative Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CARI.net and Innovative Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CARI.net vs Innovative Solutions',
    description: 'Detailed comparison of CARI.net and Innovative Solutions.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.936Z',
    modifiedTime: '2025-11-30T19:44:53.936Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cari-net-vs-innovative-solutions#article",
  "headline": "CARI.net vs Innovative Solutions: Comparison",
  "description": "Detailed comparison of CARI.net and Innovative Solutions. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.936Z",
  "dateModified": "2025-11-30T19:44:53.936Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.936Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.936Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
