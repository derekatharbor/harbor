...
// Comparing: CorSource vs ESG

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CorSource vs ESG (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CorSource and ESG. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CorSource vs ESG',
    description: 'Detailed comparison of CorSource and ESG.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/corsource-vs-esg#article",
  "headline": "CorSource vs ESG: Comparison",
  "description": "Detailed comparison of CorSource and ESG. Features, pricing, and integrations compared side-by-side.",
