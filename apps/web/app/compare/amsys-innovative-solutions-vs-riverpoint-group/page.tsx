...
// Comparing: AMSYS Innovative Solutions vs RiverPoint Group

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AMSYS Innovative Solutions vs RiverPoint Group (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AMSYS Innovative Solutions and RiverPoint Group. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AMSYS Innovative Solutions vs RiverPoint Group',
    description: 'Detailed comparison of AMSYS Innovative Solutions and RiverPoint Group.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amsys-innovative-solutions-vs-riverpoint-group#article",
  "headline": "AMSYS Innovative Solutions vs RiverPoint Group: Comparison",
  "description": "Detailed comparison of AMSYS Innovative Solutions and RiverPoint Group. Features, pricing, and integrations compared side-by-side.",
