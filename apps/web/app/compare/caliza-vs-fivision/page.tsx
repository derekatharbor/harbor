...
// Comparing: Caliza vs fiVISION

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Caliza vs fiVISION (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Caliza and fiVISION. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Caliza vs fiVISION',
    description: 'Detailed comparison of Caliza and fiVISION.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/caliza-vs-fivision#article",
  "headline": "Caliza vs fiVISION: Comparison",
  "description": "Detailed comparison of Caliza and fiVISION. Features, pricing, and integrations compared side-by-side.",
