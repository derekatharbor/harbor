...
// Comparing: OurChurch.Com vs Power Shift

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'OurChurch.Com vs Power Shift (November 30, 2025) | Harbor',
  description: 'Detailed comparison of OurChurch.Com and Power Shift. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'OurChurch.Com vs Power Shift',
    description: 'Detailed comparison of OurChurch.Com and Power Shift.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ourchurch-com-vs-power-shift#article",
  "headline": "OurChurch.Com vs Power Shift: Comparison",
  "description": "Detailed comparison of OurChurch.Com and Power Shift. Features, pricing, and integrations compared side-by-side.",
