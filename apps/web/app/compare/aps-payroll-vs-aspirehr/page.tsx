...
// Comparing: APS Payroll vs AspireHR

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'APS Payroll vs AspireHR (November 30, 2025) | Harbor',
  description: 'Detailed comparison of APS Payroll and AspireHR. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'APS Payroll vs AspireHR',
    description: 'Detailed comparison of APS Payroll and AspireHR.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aps-payroll-vs-aspirehr#article",
  "headline": "APS Payroll vs AspireHR: Comparison",
  "description": "Detailed comparison of APS Payroll and AspireHR. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "APS Payroll",
      "url": "https://useharbor.io/brands/aps-payroll"
    },
    {
      "@type": "SoftwareApplication",
      "name": "AspireHR",
      "url": "https://useharbor.io/brands/aspirehr"
    }
  ]
}
...
const brand1 = {
  "slug": "aps-payroll",
  "brand_name": "APS Payroll",
  "domain": "apspayroll.com",
  "category": "Human Capital Management",
  "summary": "A comprehensive human capital management technology provider.",
  "pricing": {
    "price_model": "per_user",
    "price_notes": "Includes a $50/month base fee",
    "has_free_tier": false,
    "starting_price": "$6/month per employee"
  },
  "features": [
    "Payroll Console",
    "Guaranteed Tax Compliance – Federal and One State",
    "Accrual Time Tracking",
    "Employee Directory",
...
const brand2 = {
  ...
  "domain": "aspirehr.com",
  "category": "Human Capital Management",
  "summary": "AspireHR is a leading provider of Human Capital Management (HCM) solutions.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "HCM Advisory and Implementation",
