...
// Comparing: HUBX vs Neo

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'HUBX vs Neo (November 30, 2025) | Harbor',
  description: 'Detailed comparison of HUBX and Neo. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'HUBX vs Neo',
    description: 'Detailed comparison of HUBX and Neo.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hubx-vs-neo#article",
  "headline": "HUBX vs Neo: Comparison",
  "description": "Detailed comparison of HUBX and Neo. Features, pricing, and integrations compared side-by-side.",
