...
// Comparing: BigID vs Seclore

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BigID vs Seclore (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BigID and Seclore. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BigID vs Seclore',
    description: 'Detailed comparison of BigID and Seclore.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bigid-vs-seclore#article",
  "headline": "BigID vs Seclore: Comparison",
  "description": "Detailed comparison of BigID and Seclore. Features, pricing, and integrations compared side-by-side.",
