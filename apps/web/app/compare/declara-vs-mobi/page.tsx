...
// Comparing: Declara vs mobi

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Declara vs mobi (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Declara and mobi. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Declara vs mobi',
    description: 'Detailed comparison of Declara and mobi.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/declara-vs-mobi#article",
  "headline": "Declara vs mobi: Comparison",
  "description": "Detailed comparison of Declara and mobi. Features, pricing, and integrations compared side-by-side.",
