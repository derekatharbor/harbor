...
// Generated: 2025-11-30T19:36:57.419Z
// Comparing: FirstLight Fiber vs Infrastructure Networks

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'FirstLight Fiber vs Infrastructure Networks (November 30, 2025) | Harbor',
  description: 'Detailed comparison of FirstLight Fiber and Infrastructure Networks. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'FirstLight Fiber vs Infrastructure Networks',
    description: 'Detailed comparison of FirstLight Fiber and Infrastructure Networks.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.419Z',
    modifiedTime: '2025-11-30T19:36:57.419Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/firstlight-fiber-vs-infrastructure-networks#article",
  "headline": "FirstLight Fiber vs Infrastructure Networks: Comparison",
  "description": "Detailed comparison of FirstLight Fiber and Infrastructure Networks. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.419Z",
  "dateModified": "2025-11-30T19:36:57.419Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand1 = {
  ...
  "features": [
    ...
    "Managed firewall and network devices",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.419Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.419Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
