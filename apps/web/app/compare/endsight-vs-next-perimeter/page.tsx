...
// Comparing: Endsight vs Next Perimeter

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Endsight vs Next Perimeter (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Endsight and Next Perimeter. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Endsight vs Next Perimeter',
    description: 'Detailed comparison of Endsight and Next Perimeter.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/endsight-vs-next-perimeter#article",
  "headline": "Endsight vs Next Perimeter: Comparison",
  "description": "Detailed comparison of Endsight and Next Perimeter. Features, pricing, and integrations compared side-by-side.",
