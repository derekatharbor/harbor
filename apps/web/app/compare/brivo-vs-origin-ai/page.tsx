...
// Comparing: Brivo vs Origin AI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Brivo vs Origin AI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Brivo and Origin AI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Brivo vs Origin AI',
    description: 'Detailed comparison of Brivo and Origin AI.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/brivo-vs-origin-ai#article",
  "headline": "Brivo vs Origin AI: Comparison",
  "description": "Detailed comparison of Brivo and Origin AI. Features, pricing, and integrations compared side-by-side.",
