...
// Comparing: ENTOUCH vs WeaveGrid

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ENTOUCH vs WeaveGrid (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ENTOUCH and WeaveGrid. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ENTOUCH vs WeaveGrid',
    description: 'Detailed comparison of ENTOUCH and WeaveGrid.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/entouch-vs-weavegrid#article",
  "headline": "ENTOUCH vs WeaveGrid: Comparison",
  "description": "Detailed comparison of ENTOUCH and WeaveGrid. Features, pricing, and integrations compared side-by-side.",
...
const brand1 = {
  ...
  "features": [
    ...
    "Mobile installation and commissioning app",
