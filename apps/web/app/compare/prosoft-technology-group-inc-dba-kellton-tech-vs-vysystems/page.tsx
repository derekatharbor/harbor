...
// Generated: 2025-11-30T19:44:54.006Z
// Comparing: ProSoft Technology Group Inc.dba Kellton Tech vs VySystems

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ProSoft Technology Group Inc.dba Kellton Tech vs VySystems (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ProSoft Technology Group Inc.dba Kellton Tech and VySystems. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ProSoft Technology Group Inc.dba Kellton Tech vs VySystems',
    description: 'Detailed comparison of ProSoft Technology Group Inc.dba Kellton Tech and VySystems.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.006Z',
    modifiedTime: '2025-11-30T19:44:54.006Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/prosoft-technology-group-inc-dba-kellton-tech-vs-vysystems#article",
  "headline": "ProSoft Technology Group Inc.dba Kellton Tech vs VySystems: Comparison",
  "description": "Detailed comparison of ProSoft Technology Group Inc.dba Kellton Tech and VySystems. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.006Z",
  "dateModified": "2025-11-30T19:44:54.006Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.006Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.006Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
