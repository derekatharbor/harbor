...
// Comparing: Order.co vs ORO Labs

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Order.co vs ORO Labs (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Order.co and ORO Labs. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Order.co vs ORO Labs',
    description: 'Detailed comparison of Order.co and ORO Labs.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/orderco-vs-oro-labs#article",
  "headline": "Order.co vs ORO Labs: Comparison",
  "description": "Detailed comparison of Order.co and ORO Labs. Features, pricing, and integrations compared side-by-side.",
