...
// Comparing: CFBT vs Donnellon McCarthy Enterprises

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CFBT vs Donnellon McCarthy Enterprises (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CFBT and Donnellon McCarthy Enterprises. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CFBT vs Donnellon McCarthy Enterprises',
    description: 'Detailed comparison of CFBT and Donnellon McCarthy Enterprises.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cfbt-vs-donnellon-mccarthy-enterprises#article",
  "headline": "CFBT vs Donnellon McCarthy Enterprises: Comparison",
  "description": "Detailed comparison of CFBT and Donnellon McCarthy Enterprises. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "CFBT",
      "url": "https://useharbor.io/brands/cfbt"
    },
    {
      "@type": "SoftwareApplication",
...
const brand1 = {
  "slug": "cfbt",
  "brand_name": "CFBT",
  "domain": "cfbtsolutions.com",
  "category": "Office Technology",
  "summary": "CFBT is a premier office technology provider specializing in hardware, software, IT services, and document management.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
