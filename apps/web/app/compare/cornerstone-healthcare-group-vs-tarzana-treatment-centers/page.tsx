...
// Comparing: Cornerstone Healthcare Group vs Tarzana Treatment Centers

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cornerstone Healthcare Group vs Tarzana Treatment Centers (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cornerstone Healthcare Group and Tarzana Treatment Centers. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cornerstone Healthcare Group vs Tarzana Treatment Centers',
    description: 'Detailed comparison of Cornerstone Healthcare Group and Tarzana Treatment Centers.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cornerstone-healthcare-group-vs-tarzana-treatment-centers#article",
  "headline": "Cornerstone Healthcare Group vs Tarzana Treatment Centers: Comparison",
  "description": "Detailed comparison of Cornerstone Healthcare Group and Tarzana Treatment Centers. Features, pricing, and integrations compared side-by-side.",
