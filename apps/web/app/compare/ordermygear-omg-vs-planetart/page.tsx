...
// Comparing: OrderMyGear (OMG) vs PlanetArt

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'OrderMyGear (OMG) vs PlanetArt (November 30, 2025) | Harbor',
  description: 'Detailed comparison of OrderMyGear (OMG) and PlanetArt. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'OrderMyGear (OMG) vs PlanetArt',
    description: 'Detailed comparison of OrderMyGear (OMG) and PlanetArt.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ordermygear-omg-vs-planetart#article",
  "headline": "OrderMyGear (OMG) vs PlanetArt: Comparison",
  "description": "Detailed comparison of OrderMyGear (OMG) and PlanetArt. Features, pricing, and integrations compared side-by-side.",
