...
// Generated: 2025-11-30T19:36:57.614Z
// Comparing: Aptos Retail vs Treez Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Aptos Retail vs Treez Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Aptos Retail and Treez Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Aptos Retail vs Treez Inc.',
    description: 'Detailed comparison of Aptos Retail and Treez Inc..',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.614Z',
    modifiedTime: '2025-11-30T19:36:57.614Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aptos-retail-vs-treez-inc#article",
  "headline": "Aptos Retail vs Treez Inc.: Comparison",
  "description": "Detailed comparison of Aptos Retail and Treez Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.614Z",
  "dateModified": "2025-11-30T19:36:57.614Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.614Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.614Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
