...
// Generated: 2025-11-30T20:05:20.427Z
// Comparing: Manta Ray Labs vs Offchain Labs

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Manta Ray Labs vs Offchain Labs (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Manta Ray Labs and Offchain Labs. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Manta Ray Labs vs Offchain Labs',
    description: 'Detailed comparison of Manta Ray Labs and Offchain Labs.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.427Z',
    modifiedTime: '2025-11-30T20:05:20.427Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/manta-ray-labs-vs-offchain-labs#article",
  "headline": "Manta Ray Labs vs Offchain Labs: Comparison",
  "description": "Detailed comparison of Manta Ray Labs and Offchain Labs. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.427Z",
  "dateModified": "2025-11-30T20:05:20.427Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.427Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.427Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
