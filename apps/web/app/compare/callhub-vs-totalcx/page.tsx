...
// Comparing: CallHub vs TotalCX

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CallHub vs TotalCX (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CallHub and TotalCX. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CallHub vs TotalCX',
    description: 'Detailed comparison of CallHub and TotalCX.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/callhub-vs-totalcx#article",
  "headline": "CallHub vs TotalCX: Comparison",
  "description": "Detailed comparison of CallHub and TotalCX. Features, pricing, and integrations compared side-by-side.",
