...
// Comparing: TechR2 vs Virtru

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'TechR2 vs Virtru (November 30, 2025) | Harbor',
  description: 'Detailed comparison of TechR2 and Virtru. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'TechR2 vs Virtru',
    description: 'Detailed comparison of TechR2 and Virtru.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/techr2-vs-virtru#article",
  "headline": "TechR2 vs Virtru: Comparison",
  "description": "Detailed comparison of TechR2 and Virtru. Features, pricing, and integrations compared side-by-side.",
