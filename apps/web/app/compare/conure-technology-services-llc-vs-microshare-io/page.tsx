...
// Comparing: Conure Technology Services, LLC vs Microshare.io

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Conure Technology Services, LLC vs Microshare.io (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Conure Technology Services, LLC and Microshare.io. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Conure Technology Services, LLC vs Microshare.io',
    description: 'Detailed comparison of Conure Technology Services, LLC and Microshare.io.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/conure-technology-services-llc-vs-microshare-io#article",
  "headline": "Conure Technology Services, LLC vs Microshare.io: Comparison",
  "description": "Detailed comparison of Conure Technology Services, LLC and Microshare.io. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Conure Technology Services, LLC",
      "url": "https://useharbor.io/brands/conure-technology-services-llc"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Microshare.io",
      "url": "https://useharbor.io/brands/microshare-io"
    }
  ]
}

const brand1 = {
  "slug": "conure-technology-services-llc",
  "brand_name": "Conure Technology Services, LLC",
  "domain": "conurets.com",
  "category": "IoT Solutions",
  "summary": "Innovative provider of smart parking and IoT solutions for urban management.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Smart Permit Management Solution",
    "Smart Parking Enforcement Solution",
...
const brand2 = {
  "slug": "microshare-io",
  "brand_name": "Microshare.io",
  "domain": "microshare.io",
  "category": "IoT Solutions",
  "summary": "Microshare digitizes real-world industries with innovative solutions.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Security alerts",
    "Washroom cleanliness monitoring"
  ],
  "integrations": [
    "Blu Star CRM",
    "Tactacam"
