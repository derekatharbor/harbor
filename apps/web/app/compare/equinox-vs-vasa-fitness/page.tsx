...
// Generated: 2025-11-30T19:44:53.608Z
// Comparing: Equinox vs VASA FITNESS

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Equinox vs VASA FITNESS (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Equinox and VASA FITNESS. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Equinox vs VASA FITNESS',
    description: 'Detailed comparison of Equinox and VASA FITNESS.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.608Z',
    modifiedTime: '2025-11-30T19:44:53.608Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/equinox-vs-vasa-fitness#article",
  "headline": "Equinox vs VASA FITNESS: Comparison",
  "description": "Detailed comparison of Equinox and VASA FITNESS. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.608Z",
  "dateModified": "2025-11-30T19:44:53.608Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.608Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.608Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
