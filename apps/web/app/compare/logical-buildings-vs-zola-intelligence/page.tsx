...
// Comparing: Logical Buildings vs ZOLA iNTELLIGENCE

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Logical Buildings vs ZOLA iNTELLIGENCE (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Logical Buildings and ZOLA iNTELLIGENCE. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Logical Buildings vs ZOLA iNTELLIGENCE',
    description: 'Detailed comparison of Logical Buildings and ZOLA iNTELLIGENCE.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/logical-buildings-vs-zola-intelligence#article",
  "headline": "Logical Buildings vs ZOLA iNTELLIGENCE: Comparison",
  "description": "Detailed comparison of Logical Buildings and ZOLA iNTELLIGENCE. Features, pricing, and integrations compared side-by-side.",
