...
// Generated: 2025-11-30T20:05:20.152Z
// Comparing: Lares, a Damovo Company vs RunSafe Security Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Lares, a Damovo Company vs RunSafe Security Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Lares, a Damovo Company and RunSafe Security Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Lares, a Damovo Company vs RunSafe Security Inc.',
    description: 'Detailed comparison of Lares, a Damovo Company and RunSafe Security Inc..',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.152Z',
    modifiedTime: '2025-11-30T20:05:20.152Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/lares-a-damovo-company-vs-runsafe-security-inc#article",
  "headline": "Lares, a Damovo Company vs RunSafe Security Inc.: Comparison",
  "description": "Detailed comparison of Lares, a Damovo Company and RunSafe Security Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.152Z",
  "dateModified": "2025-11-30T20:05:20.152Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.152Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.152Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
