...
// Comparing: Computer Packages Inc. - CPI vs MaxVal Group, Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Computer Packages Inc. - CPI vs MaxVal Group, Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Computer Packages Inc. - CPI and MaxVal Group, Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Computer Packages Inc. - CPI vs MaxVal Group, Inc.',
    description: 'Detailed comparison of Computer Packages Inc. - CPI and MaxVal Group, Inc..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/computer-packages-inc-cpi-vs-maxval-group-inc#article",
  "headline": "Computer Packages Inc. - CPI vs MaxVal Group, Inc.: Comparison",
  "description": "Detailed comparison of Computer Packages Inc. - CPI and MaxVal Group, Inc.. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Computer Packages Inc. - CPI",
      "url": "https://useharbor.io/brands/computer-packages-inc-cpi"
    },
    {
      "@type": "SoftwareApplication",
      "name": "MaxVal Group, Inc.",
      "url": "https://useharbor.io/brands/maxval-group-inc"
    }
  ]
}

const brand1 = {
  "slug": "computer-packages-inc-cpi",
  "brand_name": "Computer Packages Inc. - CPI",
  "domain": "computerpackages.com",
  "category": "Intellectual Property Management",
  "summary": "A leading provider of IP management software and services.",
  "pricing": {
    "price_model": "custom",
  ...
  "features": [
    "Real-Time Patent Management",
    "Trademark Management",
    "General Matters Management",
...
const brand2 = {
  "slug": "maxval-group-inc",
  "brand_name": "MaxVal Group, Inc.",
  "domain": "maxval.com",
  "category": "Intellectual Property Management",
  "summary": "MaxVal Group provides innovative IP management solutions and services.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Renewals",
    "Streamlined Operations for Law Firms",
    "Search and Analytics Technology",
