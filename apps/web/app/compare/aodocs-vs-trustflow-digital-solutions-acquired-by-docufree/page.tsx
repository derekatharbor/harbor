...
// Comparing: AODocs vs TrustFlow Digital Solutions (Acquired by Docufree)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AODocs vs TrustFlow Digital Solutions (Acquired by Docufree) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AODocs and TrustFlow Digital Solutions (Acquired by Docufree). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AODocs vs TrustFlow Digital Solutions (Acquired by Docufree)',
    description: 'Detailed comparison of AODocs and TrustFlow Digital Solutions (Acquired by Docufree).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aodocs-vs-trustflow-digital-solutions-acquired-by-docufree#article",
  "headline": "AODocs vs TrustFlow Digital Solutions (Acquired by Docufree): Comparison",
  "description": "Detailed comparison of AODocs and TrustFlow Digital Solutions (Acquired by Docufree). Features, pricing, and integrations compared side-by-side.",
...
const brand1 = {
  ...
  "features": [
    ...
    "Secure document storage with SOC2 certification",
