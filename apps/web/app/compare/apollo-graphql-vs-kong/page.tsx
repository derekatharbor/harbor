...
// Comparing: Apollo GraphQL vs Kong

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Apollo GraphQL vs Kong (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Apollo GraphQL and Kong. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Apollo GraphQL vs Kong',
    description: 'Detailed comparison of Apollo GraphQL and Kong.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/apollo-graphql-vs-kong#article",
  "headline": "Apollo GraphQL vs Kong: Comparison",
  "description": "Detailed comparison of Apollo GraphQL and Kong. Features, pricing, and integrations compared side-by-side.",
