...
// Comparing: BigBear.ai vs Posh

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BigBear.ai vs Posh (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BigBear.ai and Posh. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BigBear.ai vs Posh',
    description: 'Detailed comparison of BigBear.ai and Posh.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bigbearai-vs-posh#article",
  "headline": "BigBear.ai vs Posh: Comparison",
  "description": "Detailed comparison of BigBear.ai and Posh. Features, pricing, and integrations compared side-by-side.",
