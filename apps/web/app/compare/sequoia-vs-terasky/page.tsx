...
// Comparing: Sequoia vs TeraSky

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Sequoia vs TeraSky (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Sequoia and TeraSky. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Sequoia vs TeraSky',
    description: 'Detailed comparison of Sequoia and TeraSky.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/sequoia-vs-terasky#article",
  "headline": "Sequoia vs TeraSky: Comparison",
  "description": "Detailed comparison of Sequoia and TeraSky. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "TeraSky",
      "url": "https://useharbor.io/brands/terasky"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "terasky.com",
  "category": "Cloud Solutions",
  "summary": "Global Solution Integrator specializing in cloud-native infrastructure and digital transformation.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
