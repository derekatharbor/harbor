...
// Generated: 2025-11-30T19:44:54.018Z
// Comparing: Aurea vs Enventive Engineering

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Aurea vs Enventive Engineering (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Aurea and Enventive Engineering. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Aurea vs Enventive Engineering',
    description: 'Detailed comparison of Aurea and Enventive Engineering.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.018Z',
    modifiedTime: '2025-11-30T19:44:54.018Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aurea-vs-enventive-engineering#article",
  "headline": "Aurea vs Enventive Engineering: Comparison",
  "description": "Detailed comparison of Aurea and Enventive Engineering. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.018Z",
  "dateModified": "2025-11-30T19:44:54.018Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand1 = {
  ...
  "features": [
    ...
    "Powerful analytics for customer engagement",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.018Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.018Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
