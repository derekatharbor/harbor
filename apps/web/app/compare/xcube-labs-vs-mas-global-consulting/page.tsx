...
// Comparing: [x]cube LABS vs MAS Global Consulting

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '[x]cube LABS vs MAS Global Consulting (November 30, 2025) | Harbor',
  description: 'Detailed comparison of [x]cube LABS and MAS Global Consulting. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '[x]cube LABS vs MAS Global Consulting',
    description: 'Detailed comparison of [x]cube LABS and MAS Global Consulting.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/xcube-labs-vs-mas-global-consulting#article",
  "headline": "[x]cube LABS vs MAS Global Consulting: Comparison",
  "description": "Detailed comparison of [x]cube LABS and MAS Global Consulting. Features, pricing, and integrations compared side-by-side.",
