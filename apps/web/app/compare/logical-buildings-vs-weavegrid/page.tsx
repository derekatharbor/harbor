...
// Comparing: Logical Buildings vs WeaveGrid

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Logical Buildings vs WeaveGrid (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Logical Buildings and WeaveGrid. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Logical Buildings vs WeaveGrid',
    description: 'Detailed comparison of Logical Buildings and WeaveGrid.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/logical-buildings-vs-weavegrid#article",
  "headline": "Logical Buildings vs WeaveGrid: Comparison",
  "description": "Detailed comparison of Logical Buildings and WeaveGrid. Features, pricing, and integrations compared side-by-side.",
