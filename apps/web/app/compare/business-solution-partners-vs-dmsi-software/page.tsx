...
// Comparing: Business Solution Partners vs DMSi Software

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Business Solution Partners vs DMSi Software (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Business Solution Partners and DMSi Software. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Business Solution Partners vs DMSi Software',
    description: 'Detailed comparison of Business Solution Partners and DMSi Software.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/business-solution-partners-vs-dmsi-software#article",
  "headline": "Business Solution Partners vs DMSi Software: Comparison",
  "description": "Detailed comparison of Business Solution Partners and DMSi Software. Features, pricing, and integrations compared side-by-side.",
