...
// Comparing: MinIO vs Onehub

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'MinIO vs Onehub (November 30, 2025) | Harbor',
  description: 'Detailed comparison of MinIO and Onehub. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'MinIO vs Onehub',
    description: 'Detailed comparison of MinIO and Onehub.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/minio-vs-onehub#article",
  "headline": "MinIO vs Onehub: Comparison",
  "description": "Detailed comparison of MinIO and Onehub. Features, pricing, and integrations compared side-by-side.",
