...
// Comparing: [x]cube LABS vs techolution

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '[x]cube LABS vs techolution (November 30, 2025) | Harbor',
  description: 'Detailed comparison of [x]cube LABS and techolution. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '[x]cube LABS vs techolution',
    description: 'Detailed comparison of [x]cube LABS and techolution.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/xcube-labs-vs-techolution#article",
  "headline": "[x]cube LABS vs techolution: Comparison",
  "description": "Detailed comparison of [x]cube LABS and techolution. Features, pricing, and integrations compared side-by-side.",
