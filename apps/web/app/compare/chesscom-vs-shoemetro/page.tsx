...
// Comparing: Chess.com vs ShoeMetro

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Chess.com vs ShoeMetro (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Chess.com and ShoeMetro. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Chess.com vs ShoeMetro',
    description: 'Detailed comparison of Chess.com and ShoeMetro.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/chesscom-vs-shoemetro#article",
  "headline": "Chess.com vs ShoeMetro: Comparison",
  "description": "Detailed comparison of Chess.com and ShoeMetro. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Chess.com",
      "url": "https://useharbor.io/brands/chesscom"
    },
    {
      "@type": "SoftwareApplication",
      "name": "ShoeMetro",
      "url": "https://useharbor.io/brands/shoemetro"
    }
  ]
}
...
const brand1 = {
  "slug": "chesscom",
  "brand_name": "Chess.com",
  "domain": "chess.com",
  "category": "Online Gaming",
  "summary": "The leading online platform for playing and learning chess.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": true,
  ...
  "features": [
    ...
    "Play online with over 225 million members",
    "Game Review with virtual coach",
    "Train with 500,000+ puzzles",
    "Interactive lessons from top masters and coaches",
    "Watch live events and top players",
    "Daily Games with friends and family",
    "Mobile app access for training and play"
  ],
  "integrations": []
}
...
const brand2 = {
  "slug": "shoemetro",
  "brand_name": "ShoeMetro",
  "domain": "shoemetro.com",
  "category": "Online Gaming",
  "summary": "Kakap69 is a leading online gaming platform in Indonesia offering a variety of gambling services.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Minimum deposit and withdrawal amounts",
    "has_free_tier": false,
    "starting_price": "IDR 10,000,-"
  },
  "features": [
    "Sportsbook",
    "Live Casino",
