...
// Comparing: ONE (Open Network Exchange) vs Powerfront

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ONE (Open Network Exchange) vs Powerfront (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ONE (Open Network Exchange) and Powerfront. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ONE (Open Network Exchange) vs Powerfront',
    description: 'Detailed comparison of ONE (Open Network Exchange) and Powerfront.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/one-open-network-exchange-vs-powerfront#article",
  "headline": "ONE (Open Network Exchange) vs Powerfront: Comparison",
  "description": "Detailed comparison of ONE (Open Network Exchange) and Powerfront. Features, pricing, and integrations compared side-by-side.",
