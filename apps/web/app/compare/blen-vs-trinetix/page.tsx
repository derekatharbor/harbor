...
// Comparing: BLEN vs Trinetix

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BLEN vs Trinetix (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BLEN and Trinetix. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BLEN vs Trinetix',
    description: 'Detailed comparison of BLEN and Trinetix.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/blen-vs-trinetix#article",
  "headline": "BLEN vs Trinetix: Comparison",
  "description": "Detailed comparison of BLEN and Trinetix. Features, pricing, and integrations compared side-by-side.",
