...
// Comparing: Argent Software vs ZehnTek

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Argent Software vs ZehnTek (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Argent Software and ZehnTek. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Argent Software vs ZehnTek',
    description: 'Detailed comparison of Argent Software and ZehnTek.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/argent-software-vs-zehntek#article",
  "headline": "Argent Software vs ZehnTek: Comparison",
  "description": "Detailed comparison of Argent Software and ZehnTek. Features, pricing, and integrations compared side-by-side.",
