...
// Generated: 2025-11-30T20:05:20.159Z
// Comparing: Dynamic Quest vs I.T.WORKS! Managed IT Services

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Dynamic Quest vs I.T.WORKS! Managed IT Services (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Dynamic Quest and I.T.WORKS! Managed IT Services. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Dynamic Quest vs I.T.WORKS! Managed IT Services',
    description: 'Detailed comparison of Dynamic Quest and I.T.WORKS! Managed IT Services.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.159Z',
    modifiedTime: '2025-11-30T20:05:20.159Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dynamic-quest-vs-i-t-works-managed-it-services#article",
  "headline": "Dynamic Quest vs I.T.WORKS! Managed IT Services: Comparison",
  "description": "Detailed comparison of Dynamic Quest and I.T.WORKS! Managed IT Services. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.159Z",
  "dateModified": "2025-11-30T20:05:20.159Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.159Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.159Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
