...
// Comparing: GSK Solutions Inc. vs Login Consulting

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'GSK Solutions Inc. vs Login Consulting (November 30, 2025) | Harbor',
  description: 'Detailed comparison of GSK Solutions Inc. and Login Consulting. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'GSK Solutions Inc. vs Login Consulting',
    description: 'Detailed comparison of GSK Solutions Inc. and Login Consulting.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gsk-solutions-inc-vs-login-consulting#article",
  "headline": "GSK Solutions Inc. vs Login Consulting: Comparison",
  "description": "Detailed comparison of GSK Solutions Inc. and Login Consulting. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "GSK Solutions Inc.",
      "url": "https://useharbor.io/brands/gsk-solutions-inc"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Login Consulting",
      "url": "https://useharbor.io/brands/login-consulting"
    }
  ]
}

const brand1 = {
  "slug": "gsk-solutions-inc",
  "brand_name": "GSK Solutions Inc.",
  "domain": "gsksolutions.com",
  "category": "Staffing and Consulting",
  "summary": "unknown",
  "pricing": {
    "price_model": "tiered",
    "price_notes": null,
...
const brand2 = {
  "slug": "login-consulting",
  "brand_name": "Login Consulting",
  "domain": "loginconsult.com",
  "category": "Staffing and Consulting",
  "summary": "A staffing firm specializing in IT, healthcare, and financial services.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
