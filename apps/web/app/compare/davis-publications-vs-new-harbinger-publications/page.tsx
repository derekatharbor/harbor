...
// Generated: 2025-11-30T20:05:20.333Z
// Comparing: Davis Publications vs New Harbinger Publications

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Davis Publications vs New Harbinger Publications (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Davis Publications and New Harbinger Publications. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Davis Publications vs New Harbinger Publications',
    description: 'Detailed comparison of Davis Publications and New Harbinger Publications.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.333Z',
    modifiedTime: '2025-11-30T20:05:20.333Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/davis-publications-vs-new-harbinger-publications#article",
  "headline": "Davis Publications vs New Harbinger Publications: Comparison",
  "description": "Detailed comparison of Davis Publications and New Harbinger Publications. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.333Z",
  "dateModified": "2025-11-30T20:05:20.333Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.333Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.333Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
