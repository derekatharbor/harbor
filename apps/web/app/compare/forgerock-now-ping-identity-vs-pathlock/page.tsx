...
// Comparing: ForgeRock (Now Ping Identity) vs Pathlock

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ForgeRock (Now Ping Identity) vs Pathlock (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ForgeRock (Now Ping Identity) and Pathlock. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ForgeRock (Now Ping Identity) vs Pathlock',
    description: 'Detailed comparison of ForgeRock (Now Ping Identity) and Pathlock.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/forgerock-now-ping-identity-vs-pathlock#article",
  "headline": "ForgeRock (Now Ping Identity) vs Pathlock: Comparison",
  "description": "Detailed comparison of ForgeRock (Now Ping Identity) and Pathlock. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "url": "https://useharbor.io/brands/forgerock-now-ping-identity"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Pathlock",
      "url": "https://useharbor.io/brands/pathlock"
    }
  ]
}

const brand1 = {
  "slug": "forgerock-now-ping-identity",
  "brand_name": "ForgeRock (Now Ping Identity)",
  "domain": "pingidentity.com",
  "category": "Identity Security",
  "summary": "Ping Identity provides advanced identity security solutions for digital enterprises.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "pathlock.com",
  "category": "Identity Security",
  "summary": "Pathlock provides identity security and governance solutions for business-critical applications.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
