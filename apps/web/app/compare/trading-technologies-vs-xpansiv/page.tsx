...
// Comparing: Trading Technologies vs Xpansiv

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Trading Technologies vs Xpansiv (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Trading Technologies and Xpansiv. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Trading Technologies vs Xpansiv',
    description: 'Detailed comparison of Trading Technologies and Xpansiv.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/trading-technologies-vs-xpansiv#article",
  "headline": "Trading Technologies vs Xpansiv: Comparison",
  "description": "Detailed comparison of Trading Technologies and Xpansiv. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "url": "https://useharbor.io/brands/trading-technologies"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Xpansiv",
      "url": "https://useharbor.io/brands/xpansiv"
    }
  ]
}

const brand1 = {
  "slug": "trading-technologies",
  "brand_name": "Trading Technologies",
  "domain": "tradingtechnologies.com",
  "category": "Trading Platforms",
  "summary": "A leading provider of multi-asset trading and surveillance platforms.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "xpansiv.com",
  "category": "Trading Platforms",
  "summary": "Xpansiv connects buyers and sellers in the energy and environmental markets.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "Efficient trading of environmental commodities",
    "Real-time marketplace data",
    "Post-trade settlement",
    "Meta-registry access",
