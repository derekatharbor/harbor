...
// Comparing: AutoRABIT vs GitLab CI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AutoRABIT vs GitLab CI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AutoRABIT and GitLab CI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AutoRABIT vs GitLab CI',
    description: 'Detailed comparison of AutoRABIT and GitLab CI.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/autorabit-vs-gitlab-ci#article",
  "headline": "AutoRABIT vs GitLab CI: Comparison",
  "description": "Detailed comparison of AutoRABIT and GitLab CI. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "AutoRABIT",
      "url": "https://useharbor.io/brands/autorabit"
    },
    {
      "@type": "SoftwareApplication",
      "name": "GitLab CI",
      "url": "https://useharbor.io/brands/gitlab-ci"
    }
  ]
}
...
const brand1 = {
  "slug": "autorabit",
  "brand_name": "AutoRABIT",
  "domain": "autorabit.com",
  "category": "DevSecOps",
  "summary": "AutoRABIT is an enterprise Salesforce DevSecOps solution focused on security and innovation.",
  "pricing": {
    "price_model": "custom",
...
const brand2 = {
  "slug": "gitlab-ci",
  "brand_name": "GitLab CI",
  "domain": "gitlab.com/gitlab-ci",
  "category": "DevSecOps",
  "summary": "An AI-powered DevSecOps platform for software development.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
