...
// Comparing: ABUP vs Sibros

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ABUP vs Sibros (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ABUP and Sibros. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ABUP vs Sibros',
    description: 'Detailed comparison of ABUP and Sibros.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/abup-vs-sibros#article",
  "headline": "ABUP vs Sibros: Comparison",
  "description": "Detailed comparison of ABUP and Sibros. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "ABUP",
      "url": "https://useharbor.io/brands/abup"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Sibros",
...
const brand1 = {
  ...
  "summary": "Ailabi Intelligent Technology specializes in OTA solutions for automotive and IoT applications.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "Automotive FOTA",
    "Automotive VSP software management",
    "Automotive DOTA diagnostics",
    "EasyControl MDM",
    "Remote control"
  ],
  "integrations": []
