...
// Comparing: ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Intrinsic Technologies

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Intrinsic Technologies (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and Intrinsic Technologies. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Intrinsic Technologies',
    description: 'Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and Intrinsic Technologies.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ice-consulting-managed-it-cybersecurity-for-life-sciences-vs-intrinsic-technologies#article",
  "headline": "ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs Intrinsic Technologies: Comparison",
  "description": "Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and Intrinsic Technologies. Features, pricing, and integrations compared side-by-side.",
