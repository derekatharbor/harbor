...
// Comparing: CIO Solutions vs I.T.WORKS! Managed IT Services

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CIO Solutions vs I.T.WORKS! Managed IT Services (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CIO Solutions and I.T.WORKS! Managed IT Services. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CIO Solutions vs I.T.WORKS! Managed IT Services',
    description: 'Detailed comparison of CIO Solutions and I.T.WORKS! Managed IT Services.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cio-solutions-vs-i-t-works-managed-it-services#article",
  "headline": "CIO Solutions vs I.T.WORKS! Managed IT Services: Comparison",
  "description": "Detailed comparison of CIO Solutions and I.T.WORKS! Managed IT Services. Features, pricing, and integrations compared side-by-side.",
