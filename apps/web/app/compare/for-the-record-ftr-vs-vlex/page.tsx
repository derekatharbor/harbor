...
// Generated: 2025-11-30T19:44:53.822Z
// Comparing: For The Record (FTR) vs vLex

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'For The Record (FTR) vs vLex (November 30, 2025) | Harbor',
  description: 'Detailed comparison of For The Record (FTR) and vLex. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'For The Record (FTR) vs vLex',
    description: 'Detailed comparison of For The Record (FTR) and vLex.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.822Z',
    modifiedTime: '2025-11-30T19:44:53.822Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/for-the-record-ftr-vs-vlex#article",
  "headline": "For The Record (FTR) vs vLex: Comparison",
  "description": "Detailed comparison of For The Record (FTR) and vLex. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.822Z",
  "dateModified": "2025-11-30T19:44:53.822Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.822Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.822Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
