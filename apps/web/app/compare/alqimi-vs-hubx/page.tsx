...
// Comparing: ALQIMI vs HUBX

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALQIMI vs HUBX (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALQIMI and HUBX. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALQIMI vs HUBX',
    description: 'Detailed comparison of ALQIMI and HUBX.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/alqimi-vs-hubx#article",
  "headline": "ALQIMI vs HUBX: Comparison",
  "description": "Detailed comparison of ALQIMI and HUBX. Features, pricing, and integrations compared side-by-side.",
