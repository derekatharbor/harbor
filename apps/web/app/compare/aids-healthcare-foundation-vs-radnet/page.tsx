...
// Generated: 2025-11-30T20:05:20.172Z
// Comparing: AIDS Healthcare Foundation vs RadNet

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AIDS Healthcare Foundation vs RadNet (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AIDS Healthcare Foundation and RadNet. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AIDS Healthcare Foundation vs RadNet',
    description: 'Detailed comparison of AIDS Healthcare Foundation and RadNet.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.172Z',
    modifiedTime: '2025-11-30T20:05:20.172Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aids-healthcare-foundation-vs-radnet#article",
  "headline": "AIDS Healthcare Foundation vs RadNet: Comparison",
  "description": "Detailed comparison of AIDS Healthcare Foundation and RadNet. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.172Z",
  "dateModified": "2025-11-30T20:05:20.172Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand2 = {
  ...
  "features": [
    ...
    "Stringent quality programs",
    "RadNet Television (RTV) for patient engagement"
  ],
  "integrations": [
    "eRAD"
  ]
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.172Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.172Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
