...
// Comparing: Datawiz Corporation (a GTSC Company) vs EvonSys

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Datawiz Corporation (a GTSC Company) vs EvonSys (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Datawiz Corporation (a GTSC Company) and EvonSys. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Datawiz Corporation (a GTSC Company) vs EvonSys',
    description: 'Detailed comparison of Datawiz Corporation (a GTSC Company) and EvonSys.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/datawiz-corporation-a-gtsc-company-vs-evonsys#article",
  "headline": "Datawiz Corporation (a GTSC Company) vs EvonSys: Comparison",
  "description": "Detailed comparison of Datawiz Corporation (a GTSC Company) and EvonSys. Features, pricing, and integrations compared side-by-side.",
