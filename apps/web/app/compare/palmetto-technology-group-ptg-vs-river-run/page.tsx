...
// Comparing: Palmetto Technology Group (PTG) vs River Run

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Palmetto Technology Group (PTG) vs River Run (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Palmetto Technology Group (PTG) and River Run. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Palmetto Technology Group (PTG) vs River Run',
    description: 'Detailed comparison of Palmetto Technology Group (PTG) and River Run.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/palmetto-technology-group-ptg-vs-river-run#article",
  "headline": "Palmetto Technology Group (PTG) vs River Run: Comparison",
  "description": "Detailed comparison of Palmetto Technology Group (PTG) and River Run. Features, pricing, and integrations compared side-by-side.",
