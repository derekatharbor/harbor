...
// Comparing: [x]cube LABS vs InfoObjects Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '[x]cube LABS vs InfoObjects Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of [x]cube LABS and InfoObjects Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '[x]cube LABS vs InfoObjects Inc.',
    description: 'Detailed comparison of [x]cube LABS and InfoObjects Inc..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/xcube-labs-vs-infoobjects-inc#article",
  "headline": "[x]cube LABS vs InfoObjects Inc.: Comparison",
  "description": "Detailed comparison of [x]cube LABS and InfoObjects Inc.. Features, pricing, and integrations compared side-by-side.",
