...
// Generated: 2025-11-30T20:05:20.283Z
// Comparing: St. Supéry Estate Vineyards & Winery vs Williams Selyem Winery

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'St. Supéry Estate Vineyards & Winery vs Williams Selyem Winery (November 30, 2025) | Harbor',
  description: 'Detailed comparison of St. Supéry Estate Vineyards & Winery and Williams Selyem Winery. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'St. Supéry Estate Vineyards & Winery vs Williams Selyem Winery',
    description: 'Detailed comparison of St. Supéry Estate Vineyards & Winery and Williams Selyem Winery.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.283Z',
    modifiedTime: '2025-11-30T20:05:20.283Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/st-supry-estate-vineyards-and-winery-vs-williams-selyem-winery#article",
  "headline": "St. Supéry Estate Vineyards & Winery vs Williams Selyem Winery: Comparison",
  "description": "Detailed comparison of St. Supéry Estate Vineyards & Winery and Williams Selyem Winery. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.283Z",
  "dateModified": "2025-11-30T20:05:20.283Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "url": "https://useharbor.io/brands/st-supry-estate-vineyards-and-winery"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Williams Selyem Winery",
      "url": "https://useharbor.io/brands/williams-selyem-winery"
    }
  ]
}

const brand1 = {
  "slug": "st-supry-estate-vineyards-and-winery",
  "brand_name": "St. Supéry Estate Vineyards & Winery",
  "domain": "stsupery.com",
  "category": "Winery",
  "summary": "A sustainable winery in Napa Valley producing estate-grown wines.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "brand_name": "Williams Selyem Winery",
  "domain": "williamsselyem.com",
  "category": "Winery",
  "summary": "A winery dedicated to producing exceptional wines from high-quality grapes.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.283Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.283Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
