...
// Comparing: AgilePoint vs MetaSource

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AgilePoint vs MetaSource (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AgilePoint and MetaSource. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AgilePoint vs MetaSource',
    description: 'Detailed comparison of AgilePoint and MetaSource.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/agilepoint-vs-metasource#article",
  "headline": "AgilePoint vs MetaSource: Comparison",
  "description": "Detailed comparison of AgilePoint and MetaSource. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "AgilePoint",
      "url": "https://useharbor.io/brands/agilepoint"
    },
    {
      "@type": "SoftwareApplication",
      "name": "MetaSource",
      "url": "https://useharbor.io/brands/metasource"
    }
  ]
}
...
const brand1 = {
  "slug": "agilepoint",
  "brand_name": "AgilePoint",
  "domain": "agilepoint.com",
  "category": "Business Process Automation",
  "summary": "AgilePoint provides a low-code platform for business process automation and AI governance.",
  "pricing": {
    "price_model": "per_user",
    "price_notes": "Free tier available for Community Edition with limited features.",
    "has_free_tier": true,
    "starting_price": "$39/seat* per month"
  },
  "features": [
    "Dynamic concurrent user licensing",
    "Single Sign-On",
    "Mobile App Builder",
    "Analytic Center",
    "Advanced Connectors",
...
const brand2 = {
  "slug": "metasource",
  "brand_name": "MetaSource",
  "domain": "metasource.com",
  "category": "Business Process Automation",
  "summary": "MetaSource is a digital transformation solutions provider specializing in business process automation and intelligent document processing.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
