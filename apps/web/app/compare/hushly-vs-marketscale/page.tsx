...
// Comparing: Hushly vs MarketScale

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Hushly vs MarketScale (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Hushly and MarketScale. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Hushly vs MarketScale',
    description: 'Detailed comparison of Hushly and MarketScale.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hushly-vs-marketscale#article",
  "headline": "Hushly vs MarketScale: Comparison",
  "description": "Detailed comparison of Hushly and MarketScale. Features, pricing, and integrations compared side-by-side.",
