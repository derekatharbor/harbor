...
// Comparing: Cloudfy vs UniformMarket by SellersCommerce

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cloudfy vs UniformMarket by SellersCommerce (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cloudfy and UniformMarket by SellersCommerce. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cloudfy vs UniformMarket by SellersCommerce',
    description: 'Detailed comparison of Cloudfy and UniformMarket by SellersCommerce.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cloudfy-vs-uniformmarket-by-sellerscommerce#article",
  "headline": "Cloudfy vs UniformMarket by SellersCommerce: Comparison",
  "description": "Detailed comparison of Cloudfy and UniformMarket by SellersCommerce. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Cloudfy",
      "url": "https://useharbor.io/brands/cloudfy"
    },
    {
      "@type": "SoftwareApplication",
...
const brand1 = {
  ...
  "summary": "Cloudfy is a leading B2B eCommerce platform designed for manufacturers and distributors.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Three editions available, all priced at $39.99/month",
    "has_free_tier": false,
    "starting_price": "$39.99/mo"
  },
  "features": [
    "B2B Ordering Portal",
