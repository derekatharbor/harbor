...
// Comparing: Madison Logic vs Mutiny

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Madison Logic vs Mutiny (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Madison Logic and Mutiny. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Madison Logic vs Mutiny',
    description: 'Detailed comparison of Madison Logic and Mutiny.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/madison-logic-vs-mutiny#article",
  "headline": "Madison Logic vs Mutiny: Comparison",
  "description": "Detailed comparison of Madison Logic and Mutiny. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Madison Logic",
      "url": "https://useharbor.io/brands/madison-logic"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Mutiny",
      "url": "https://useharbor.io/brands/mutiny"
    }
  ]
}
...
const brand1 = {
  "slug": "madison-logic",
  "brand_name": "Madison Logic",
  "domain": "madisonlogic.com",
  "category": "Account-Based Marketing",
  "summary": "A leading B2B marketing technology company specializing in account-based marketing solutions.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Pricing details are not explicitly stated; interested users are encouraged to book a demo.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
...
const brand2 = {
  ...
  "domain": "mutinyhq.com",
  "category": "Account-Based Marketing",
  "summary": "AI account-based personalization platform for B2B companies.",
  "pricing": {
    "price_model": "custom",
