...
// Comparing: Cloudinary vs CyanGate

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cloudinary vs CyanGate (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cloudinary and CyanGate. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cloudinary vs CyanGate',
    description: 'Detailed comparison of Cloudinary and CyanGate.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cloudinary-vs-cyangate#article",
  "headline": "Cloudinary vs CyanGate: Comparison",
  "description": "Detailed comparison of Cloudinary and CyanGate. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Quickly find your assets",
    "Repurpose your rich media",
    "Secure your assets",
