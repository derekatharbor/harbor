...
// Comparing: Aptos Retail vs Quilt Software

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Aptos Retail vs Quilt Software (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Aptos Retail and Quilt Software. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Aptos Retail vs Quilt Software',
    description: 'Detailed comparison of Aptos Retail and Quilt Software.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aptos-retail-vs-quilt-software#article",
  "headline": "Aptos Retail vs Quilt Software: Comparison",
  "description": "Detailed comparison of Aptos Retail and Quilt Software. Features, pricing, and integrations compared side-by-side.",
