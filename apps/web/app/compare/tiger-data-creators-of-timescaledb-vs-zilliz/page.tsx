...
// Generated: 2025-11-30T20:05:20.327Z
// Comparing: Tiger Data (creators of TimescaleDB) vs Zilliz

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Tiger Data (creators of TimescaleDB) vs Zilliz (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Tiger Data (creators of TimescaleDB) and Zilliz. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Tiger Data (creators of TimescaleDB) vs Zilliz',
    description: 'Detailed comparison of Tiger Data (creators of TimescaleDB) and Zilliz.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.327Z',
    modifiedTime: '2025-11-30T20:05:20.327Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/tiger-data-creators-of-timescaledb-vs-zilliz#article",
  "headline": "Tiger Data (creators of TimescaleDB) vs Zilliz: Comparison",
  "description": "Detailed comparison of Tiger Data (creators of TimescaleDB) and Zilliz. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.327Z",
  "dateModified": "2025-11-30T20:05:20.327Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.327Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.327Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
