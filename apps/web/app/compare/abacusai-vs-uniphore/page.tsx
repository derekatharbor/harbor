...
// Comparing: Abacus.AI vs Uniphore

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Abacus.AI vs Uniphore (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Abacus.AI and Uniphore. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Abacus.AI vs Uniphore',
    description: 'Detailed comparison of Abacus.AI and Uniphore.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/abacusai-vs-uniphore#article",
  "headline": "Abacus.AI vs Uniphore: Comparison",
  "description": "Detailed comparison of Abacus.AI and Uniphore. Features, pricing, and integrations compared side-by-side.",
