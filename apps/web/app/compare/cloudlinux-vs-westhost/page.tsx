...
// Comparing: CloudLinux vs WestHost

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CloudLinux vs WestHost (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CloudLinux and WestHost. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CloudLinux vs WestHost',
    description: 'Detailed comparison of CloudLinux and WestHost.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cloudlinux-vs-westhost#article",
  "headline": "CloudLinux vs WestHost: Comparison",
  "description": "Detailed comparison of CloudLinux and WestHost. Features, pricing, and integrations compared side-by-side.",
