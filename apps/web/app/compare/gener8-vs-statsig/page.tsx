...
// Comparing: gener8 vs Statsig

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'gener8 vs Statsig (November 30, 2025) | Harbor',
  description: 'Detailed comparison of gener8 and Statsig. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'gener8 vs Statsig',
    description: 'Detailed comparison of gener8 and Statsig.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gener8-vs-statsig#article",
  "headline": "gener8 vs Statsig: Comparison",
  "description": "Detailed comparison of gener8 and Statsig. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "gener8",
      "url": "https://useharbor.io/brands/gener8"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Statsig",
      "url": "https://useharbor.io/brands/statsig"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "Gener8 is a product development and manufacturing company specializing in engineering solutions.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Offers a free consultation but specific pricing details are not provided.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
...
const brand2 = {
  ...
  "domain": "statsig.com",
  "category": "Product Development",
  "summary": "A modern product development platform that empowers teams to build better products through data-driven decisions.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "Free tier allows for 2M events per month and unlimited flag & config checks.",
    "has_free_tier": true,
