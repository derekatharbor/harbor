...
// Comparing: Cornerstone Healthcare Group vs RadNet

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cornerstone Healthcare Group vs RadNet (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cornerstone Healthcare Group and RadNet. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cornerstone Healthcare Group vs RadNet',
    description: 'Detailed comparison of Cornerstone Healthcare Group and RadNet.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cornerstone-healthcare-group-vs-radnet#article",
  "headline": "Cornerstone Healthcare Group vs RadNet: Comparison",
  "description": "Detailed comparison of Cornerstone Healthcare Group and RadNet. Features, pricing, and integrations compared side-by-side.",
