...
// Generated: 2025-11-30T20:05:20.285Z
// Comparing: CuroGens - A Hoalani Group Company vs Herdt Consulting, Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CuroGens - A Hoalani Group Company vs Herdt Consulting, Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CuroGens - A Hoalani Group Company and Herdt Consulting, Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CuroGens - A Hoalani Group Company vs Herdt Consulting, Inc.',
    description: 'Detailed comparison of CuroGens - A Hoalani Group Company and Herdt Consulting, Inc..',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.285Z',
    modifiedTime: '2025-11-30T20:05:20.285Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/curogens-a-hoalani-group-company-vs-herdt-consulting-inc#article",
  "headline": "CuroGens - A Hoalani Group Company vs Herdt Consulting, Inc.: Comparison",
  "description": "Detailed comparison of CuroGens - A Hoalani Group Company and Herdt Consulting, Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.285Z",
  "dateModified": "2025-11-30T20:05:20.285Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.285Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.285Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
