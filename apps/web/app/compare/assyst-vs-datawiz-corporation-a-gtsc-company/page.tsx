...
// Comparing: ASSYST vs Datawiz Corporation (a GTSC Company)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ASSYST vs Datawiz Corporation (a GTSC Company) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ASSYST and Datawiz Corporation (a GTSC Company). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ASSYST vs Datawiz Corporation (a GTSC Company)',
    description: 'Detailed comparison of ASSYST and Datawiz Corporation (a GTSC Company).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/assyst-vs-datawiz-corporation-a-gtsc-company#article",
  "headline": "ASSYST vs Datawiz Corporation (a GTSC Company): Comparison",
  "description": "Detailed comparison of ASSYST and Datawiz Corporation (a GTSC Company). Features, pricing, and integrations compared side-by-side.",
