...
// Comparing: Blurb vs Scribe Media

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Blurb vs Scribe Media (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Blurb and Scribe Media. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Blurb vs Scribe Media',
    description: 'Detailed comparison of Blurb and Scribe Media.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/blurb-vs-scribe-media#article",
  "headline": "Blurb vs Scribe Media: Comparison",
  "description": "Detailed comparison of Blurb and Scribe Media. Features, pricing, and integrations compared side-by-side.",
