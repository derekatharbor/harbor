...
// Comparing: Gluu vs OneLogin

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Gluu vs OneLogin (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Gluu and OneLogin. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Gluu vs OneLogin',
    description: 'Detailed comparison of Gluu and OneLogin.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gluu-vs-onelogin#article",
  "headline": "Gluu vs OneLogin: Comparison",
  "description": "Detailed comparison of Gluu and OneLogin. Features, pricing, and integrations compared side-by-side.",
