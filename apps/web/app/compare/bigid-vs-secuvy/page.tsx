...
// Comparing: BigID vs Secuvy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BigID vs Secuvy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BigID and Secuvy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BigID vs Secuvy',
    description: 'Detailed comparison of BigID and Secuvy.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bigid-vs-secuvy#article",
  "headline": "BigID vs Secuvy: Comparison",
  "description": "Detailed comparison of BigID and Secuvy. Features, pricing, and integrations compared side-by-side.",
