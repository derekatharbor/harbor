...
// Generated: 2025-11-30T19:36:57.558Z
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.558Z',
    modifiedTime: '2025-11-30T19:36:57.558Z',
  },
}
...
const schemaOrg = {
  ...
  "description": "Detailed comparison of BadgePass, Inc and OneLogin. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.558Z",
  "dateModified": "2025-11-30T19:36:57.558Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.558Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.558Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
