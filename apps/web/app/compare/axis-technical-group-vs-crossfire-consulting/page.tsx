...
// Comparing: Axis Technical Group vs Crossfire Consulting

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Axis Technical Group vs Crossfire Consulting (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Axis Technical Group and Crossfire Consulting. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Axis Technical Group vs Crossfire Consulting',
    description: 'Detailed comparison of Axis Technical Group and Crossfire Consulting.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/axis-technical-group-vs-crossfire-consulting#article",
  "headline": "Axis Technical Group vs Crossfire Consulting: Comparison",
  "description": "Detailed comparison of Axis Technical Group and Crossfire Consulting. Features, pricing, and integrations compared side-by-side.",
