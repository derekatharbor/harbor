...
// Comparing: CARI.net vs ScaleMatrix

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CARI.net vs ScaleMatrix (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CARI.net and ScaleMatrix. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CARI.net vs ScaleMatrix',
    description: 'Detailed comparison of CARI.net and ScaleMatrix.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cari-net-vs-scalematrix#article",
  "headline": "CARI.net vs ScaleMatrix: Comparison",
  "description": "Detailed comparison of CARI.net and ScaleMatrix. Features, pricing, and integrations compared side-by-side.",
