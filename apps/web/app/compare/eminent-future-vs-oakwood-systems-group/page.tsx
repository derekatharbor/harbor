...
// Comparing: Eminent Future vs Oakwood Systems Group

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Eminent Future vs Oakwood Systems Group (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Eminent Future and Oakwood Systems Group. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Eminent Future vs Oakwood Systems Group',
    description: 'Detailed comparison of Eminent Future and Oakwood Systems Group.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/eminent-future-vs-oakwood-systems-group#article",
  "headline": "Eminent Future vs Oakwood Systems Group: Comparison",
  "description": "Detailed comparison of Eminent Future and Oakwood Systems Group. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Eminent Future",
      "url": "https://useharbor.io/brands/eminent-future"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Oakwood Systems Group",
      "url": "https://useharbor.io/brands/oakwood-systems-group"
    }
  ]
}
...
const brand1 = {
  "slug": "eminent-future",
  "brand_name": "Eminent Future",
  "domain": "eminentfuture.com",
  "category": "Cloud Consulting",
  "summary": "Cloud Advisors for DOS and DOD Directors.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "oakwood-systems-group",
  "brand_name": "Oakwood Systems Group",
  "domain": "oakwoodsys.com",
  "category": "Cloud Consulting",
  "summary": "A premier Microsoft Solutions Partner specializing in cloud consulting and IT services.",
  "pricing": {
    "price_model": "flat",
    "price_notes": null,
    "has_free_tier": false,
    "starting_price": "$219/mo"
  },
  "features": [
    "Data management",
    "Governance",
