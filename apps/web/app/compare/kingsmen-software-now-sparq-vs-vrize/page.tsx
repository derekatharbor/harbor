...
// Comparing: Kingsmen Software (now Sparq) vs VRIZE

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Kingsmen Software (now Sparq) vs VRIZE (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Kingsmen Software (now Sparq) and VRIZE. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Kingsmen Software (now Sparq) vs VRIZE',
    description: 'Detailed comparison of Kingsmen Software (now Sparq) and VRIZE.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/kingsmen-software-now-sparq-vs-vrize#article",
  "headline": "Kingsmen Software (now Sparq) vs VRIZE: Comparison",
  "description": "Detailed comparison of Kingsmen Software (now Sparq) and VRIZE. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Kingsmen Software (now Sparq)",
      "url": "https://useharbor.io/brands/kingsmen-software-now-sparq"
    },
    {
      "@type": "SoftwareApplication",
      "name": "VRIZE",
      "url": "https://useharbor.io/brands/vrize"
    }
  ]
}

const brand1 = {
  "slug": "kingsmen-software-now-sparq",
  "brand_name": "Kingsmen Software (now Sparq)",
  "domain": "kingsmensoftware.com",
  "category": "Digital Engineering",
  "summary": "A digital and product engineering company focused on AI-driven solutions.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "vrize.com",
  "category": "Digital Engineering",
  "summary": "A leading provider of frictionless digital engineering solutions.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
