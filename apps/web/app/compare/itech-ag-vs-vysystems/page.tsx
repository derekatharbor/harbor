...
// Comparing: iTech AG vs VySystems

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'iTech AG vs VySystems (November 30, 2025) | Harbor',
  description: 'Detailed comparison of iTech AG and VySystems. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'iTech AG vs VySystems',
    description: 'Detailed comparison of iTech AG and VySystems.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/itech-ag-vs-vysystems#article",
  "headline": "iTech AG vs VySystems: Comparison",
  "description": "Detailed comparison of iTech AG and VySystems. Features, pricing, and integrations compared side-by-side.",
