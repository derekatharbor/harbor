...
// Generated: 2025-11-30T20:05:20.307Z
// Comparing: Ekata, a Mastercard company vs ThreatMark

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Ekata, a Mastercard company vs ThreatMark (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Ekata, a Mastercard company and ThreatMark. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Ekata, a Mastercard company vs ThreatMark',
    description: 'Detailed comparison of Ekata, a Mastercard company and ThreatMark.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.307Z',
    modifiedTime: '2025-11-30T20:05:20.307Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ekata-a-mastercard-company-vs-threatmark#article",
  "headline": "Ekata, a Mastercard company vs ThreatMark: Comparison",
  "description": "Detailed comparison of Ekata, a Mastercard company and ThreatMark. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.307Z",
  "dateModified": "2025-11-30T20:05:20.307Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.307Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.307Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
