...
// Comparing: NetNation vs Power Shift

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NetNation vs Power Shift (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NetNation and Power Shift. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NetNation vs Power Shift',
    description: 'Detailed comparison of NetNation and Power Shift.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/netnation-vs-power-shift#article",
  "headline": "NetNation vs Power Shift: Comparison",
  "description": "Detailed comparison of NetNation and Power Shift. Features, pricing, and integrations compared side-by-side.",
