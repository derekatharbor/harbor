...
// Comparing: Poppulo vs Rocket.Chat

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Poppulo vs Rocket.Chat (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Poppulo and Rocket.Chat. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Poppulo vs Rocket.Chat',
    description: 'Detailed comparison of Poppulo and Rocket.Chat.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/poppulo-vs-rocketchat#article",
  "headline": "Poppulo vs Rocket.Chat: Comparison",
  "description": "Detailed comparison of Poppulo and Rocket.Chat. Features, pricing, and integrations compared side-by-side.",
