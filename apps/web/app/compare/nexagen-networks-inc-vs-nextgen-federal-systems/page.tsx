...
// Generated: 2025-11-30T20:05:20.209Z
// Comparing: Nexagen Networks, Inc. vs NextGen Federal Systems

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Nexagen Networks, Inc. vs NextGen Federal Systems (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Nexagen Networks, Inc. and NextGen Federal Systems. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Nexagen Networks, Inc. vs NextGen Federal Systems',
    description: 'Detailed comparison of Nexagen Networks, Inc. and NextGen Federal Systems.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.209Z',
    modifiedTime: '2025-11-30T20:05:20.209Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/nexagen-networks-inc-vs-nextgen-federal-systems#article",
  "headline": "Nexagen Networks, Inc. vs NextGen Federal Systems: Comparison",
  "description": "Detailed comparison of Nexagen Networks, Inc. and NextGen Federal Systems. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.209Z",
  "dateModified": "2025-11-30T20:05:20.209Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.209Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.209Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
