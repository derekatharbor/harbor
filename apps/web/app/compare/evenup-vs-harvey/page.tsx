...
// Comparing: EvenUp vs Harvey

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'EvenUp vs Harvey (November 30, 2025) | Harbor',
  description: 'Detailed comparison of EvenUp and Harvey. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'EvenUp vs Harvey',
    description: 'Detailed comparison of EvenUp and Harvey.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/evenup-vs-harvey#article",
  "headline": "EvenUp vs Harvey: Comparison",
  "description": "Detailed comparison of EvenUp and Harvey. Features, pricing, and integrations compared side-by-side.",
