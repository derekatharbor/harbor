...
// Generated: 2025-11-30T20:05:20.386Z
// Comparing: A2Go - Agentic AI for Supply Chain Operations vs Z2Data

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'A2Go - Agentic AI for Supply Chain Operations vs Z2Data (November 30, 2025) | Harbor',
  description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Z2Data. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'A2Go - Agentic AI for Supply Chain Operations vs Z2Data',
    description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Z2Data.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.386Z',
    modifiedTime: '2025-11-30T20:05:20.386Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/a2go-agentic-ai-for-supply-chain-operations-vs-z2data#article",
  "headline": "A2Go - Agentic AI for Supply Chain Operations vs Z2Data: Comparison",
  "description": "Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Z2Data. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.386Z",
  "dateModified": "2025-11-30T20:05:20.386Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.386Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.386Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
