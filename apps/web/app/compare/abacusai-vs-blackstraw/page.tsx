...
// Comparing: Abacus.AI vs Blackstraw

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Abacus.AI vs Blackstraw (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Abacus.AI and Blackstraw. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Abacus.AI vs Blackstraw',
    description: 'Detailed comparison of Abacus.AI and Blackstraw.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/abacusai-vs-blackstraw#article",
  "headline": "Abacus.AI vs Blackstraw: Comparison",
  "description": "Detailed comparison of Abacus.AI and Blackstraw. Features, pricing, and integrations compared side-by-side.",
