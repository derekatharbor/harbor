...
// Comparing: InMoment vs Sierra

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'InMoment vs Sierra (November 30, 2025) | Harbor',
  description: 'Detailed comparison of InMoment and Sierra. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'InMoment vs Sierra',
    description: 'Detailed comparison of InMoment and Sierra.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/inmoment-vs-sierra#article",
  "headline": "InMoment vs Sierra: Comparison",
  "description": "Detailed comparison of InMoment and Sierra. Features, pricing, and integrations compared side-by-side.",
