...
// Generated: 2025-11-30T19:36:57.507Z
// Comparing: ALLOut Security vs TimeKeeping Systems, Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALLOut Security vs TimeKeeping Systems, Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALLOut Security and TimeKeeping Systems, Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALLOut Security vs TimeKeeping Systems, Inc.',
    description: 'Detailed comparison of ALLOut Security and TimeKeeping Systems, Inc..',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.507Z',
    modifiedTime: '2025-11-30T19:36:57.507Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allout-security-vs-timekeeping-systems-inc#article",
  "headline": "ALLOut Security vs TimeKeeping Systems, Inc.: Comparison",
  "description": "Detailed comparison of ALLOut Security and TimeKeeping Systems, Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.507Z",
  "dateModified": "2025-11-30T19:36:57.507Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.507Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.507Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
