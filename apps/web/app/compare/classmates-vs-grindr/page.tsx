...
// Generated: 2025-11-30T19:44:54.030Z
// Comparing: Classmates® vs Grindr

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Classmates® vs Grindr (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Classmates® and Grindr. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Classmates® vs Grindr',
    description: 'Detailed comparison of Classmates® and Grindr.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.030Z',
    modifiedTime: '2025-11-30T19:44:54.030Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/classmates-vs-grindr#article",
  "headline": "Classmates® vs Grindr: Comparison",
  "description": "Detailed comparison of Classmates® and Grindr. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.030Z",
  "dateModified": "2025-11-30T19:44:54.030Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "Classmates®",
      "url": "https://useharbor.io/brands/classmates"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Grindr",
      "url": "https://useharbor.io/brands/grindr"
    }
  ]
}
...
const brand1 = {
  "slug": "classmates",
  "brand_name": "Classmates®",
  "domain": "classmates.com",
  "category": "social networking",
  "summary": "A social networking platform dedicated to reconnecting high school friends.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "grindr.com",
  "category": "social networking",
  "summary": "The world’s largest social networking app for LGBTQ people.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.030Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.030Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
