...
// Comparing: eBrevia vs For The Record (FTR)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'eBrevia vs For The Record (FTR) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of eBrevia and For The Record (FTR). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'eBrevia vs For The Record (FTR)',
    description: 'Detailed comparison of eBrevia and For The Record (FTR).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ebrevia-vs-for-the-record-ftr#article",
  "headline": "eBrevia vs For The Record (FTR): Comparison",
  "description": "Detailed comparison of eBrevia and For The Record (FTR). Features, pricing, and integrations compared side-by-side.",
