...
// Comparing: LearnQuest vs United Training

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'LearnQuest vs United Training (November 30, 2025) | Harbor',
  description: 'Detailed comparison of LearnQuest and United Training. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'LearnQuest vs United Training',
    description: 'Detailed comparison of LearnQuest and United Training.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/learnquest-vs-united-training#article",
  "headline": "LearnQuest vs United Training: Comparison",
  "description": "Detailed comparison of LearnQuest and United Training. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "LearnQuest",
      "url": "https://useharbor.io/brands/learnquest"
    },
    {
      "@type": "SoftwareApplication",
...
const brand1 = {
  "slug": "learnquest",
  "brand_name": "LearnQuest",
  "domain": "learnquest.com",
  "category": "IT Training",
  "summary": "Global provider of IT, Business, and AI training solutions.",
  "pricing": {
    "price_model": "custom",
