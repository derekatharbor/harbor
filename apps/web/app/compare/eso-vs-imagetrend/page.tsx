...
// Comparing: ESO vs ImageTrend

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ESO vs ImageTrend (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ESO and ImageTrend. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ESO vs ImageTrend',
    description: 'Detailed comparison of ESO and ImageTrend.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/eso-vs-imagetrend#article",
  "headline": "ESO vs ImageTrend: Comparison",
  "description": "Detailed comparison of ESO and ImageTrend. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "ESO",
      "url": "https://useharbor.io/brands/eso"
    },
    {
      "@type": "SoftwareApplication",
      "name": "ImageTrend",
      "url": "https://useharbor.io/brands/imagetrend"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "ESO provides innovative software solutions for emergency medical services, fire departments, and hospitals.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "Pricing is based upon EMS transport volume.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
    "Bidirectional data sharing",
    "Real-time EMS data sharing",
    "Auto-Generated Narrative tool",
    "Simplified EMS reporting",
    "Compliance tracking",
    "Patient demographics and billing data access",
...
const brand2 = {
  "slug": "imagetrend",
  "brand_name": "ImageTrend",
  "domain": "imagetrend.com",
  "category": "Emergency Management Software",
  "summary": "Emergency management software for fire, EMS, and hospitals.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "ePCR documentation",
    "Fire RMS capabilities",
    "Patient tracking",
    "Billing solutions",
    "Data exchange between EMS and hospitals",
