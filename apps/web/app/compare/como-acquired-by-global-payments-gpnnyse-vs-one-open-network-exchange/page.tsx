...
// Generated: 2025-11-30T20:05:20.354Z
// Comparing: Como® (acquired by Global Payments GPN:NYSE) vs ONE (Open Network Exchange)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Como® (acquired by Global Payments GPN:NYSE) vs ONE (Open Network Exchange) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Como® (acquired by Global Payments GPN:NYSE) and ONE (Open Network Exchange). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Como® (acquired by Global Payments GPN:NYSE) vs ONE (Open Network Exchange)',
    description: 'Detailed comparison of Como® (acquired by Global Payments GPN:NYSE) and ONE (Open Network Exchange).',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.354Z',
    modifiedTime: '2025-11-30T20:05:20.354Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/como-acquired-by-global-payments-gpnnyse-vs-one-open-network-exchange#article",
  "headline": "Como® (acquired by Global Payments GPN:NYSE) vs ONE (Open Network Exchange): Comparison",
  "description": "Detailed comparison of Como® (acquired by Global Payments GPN:NYSE) and ONE (Open Network Exchange). Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.354Z",
  "dateModified": "2025-11-30T20:05:20.354Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.354Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.354Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
