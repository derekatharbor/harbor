...
// Generated: 2025-11-30T19:44:53.439Z
// Comparing: Helpshift, a Keywords Technology vs Re:amaze

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Helpshift, a Keywords Technology vs Re:amaze (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Helpshift, a Keywords Technology and Re:amaze. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Helpshift, a Keywords Technology vs Re:amaze',
    description: 'Detailed comparison of Helpshift, a Keywords Technology and Re:amaze.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.439Z',
    modifiedTime: '2025-11-30T19:44:53.439Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/helpshift-a-keywords-technology-vs-reamaze#article",
  "headline": "Helpshift, a Keywords Technology vs Re:amaze: Comparison",
  "description": "Detailed comparison of Helpshift, a Keywords Technology and Re:amaze. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.439Z",
  "dateModified": "2025-11-30T19:44:53.439Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.439Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.439Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
