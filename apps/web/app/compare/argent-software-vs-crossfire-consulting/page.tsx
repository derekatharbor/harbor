...
// Comparing: Argent Software vs Crossfire Consulting

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Argent Software vs Crossfire Consulting (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Argent Software and Crossfire Consulting. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Argent Software vs Crossfire Consulting',
    description: 'Detailed comparison of Argent Software and Crossfire Consulting.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/argent-software-vs-crossfire-consulting#article",
  "headline": "Argent Software vs Crossfire Consulting: Comparison",
  "description": "Detailed comparison of Argent Software and Crossfire Consulting. Features, pricing, and integrations compared side-by-side.",
