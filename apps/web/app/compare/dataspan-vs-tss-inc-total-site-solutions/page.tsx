...
// Comparing: DataSpan vs TSS, Inc (Total Site Solutions)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DataSpan vs TSS, Inc (Total Site Solutions) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DataSpan and TSS, Inc (Total Site Solutions). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DataSpan vs TSS, Inc (Total Site Solutions)',
    description: 'Detailed comparison of DataSpan and TSS, Inc (Total Site Solutions).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dataspan-vs-tss-inc-total-site-solutions#article",
  "headline": "DataSpan vs TSS, Inc (Total Site Solutions): Comparison",
  "description": "Detailed comparison of DataSpan and TSS, Inc (Total Site Solutions). Features, pricing, and integrations compared side-by-side.",
