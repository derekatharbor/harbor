...
// Comparing: ALLOut Security vs Reco

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALLOut Security vs Reco (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALLOut Security and Reco. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALLOut Security vs Reco',
    description: 'Detailed comparison of ALLOut Security and Reco.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allout-security-vs-reco#article",
  "headline": "ALLOut Security vs Reco: Comparison",
  "description": "Detailed comparison of ALLOut Security and Reco. Features, pricing, and integrations compared side-by-side.",
