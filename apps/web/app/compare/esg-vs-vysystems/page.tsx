...
// Comparing: ESG vs VySystems

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ESG vs VySystems (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ESG and VySystems. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ESG vs VySystems',
    description: 'Detailed comparison of ESG and VySystems.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/esg-vs-vysystems#article",
  "headline": "ESG vs VySystems: Comparison",
  "description": "Detailed comparison of ESG and VySystems. Features, pricing, and integrations compared side-by-side.",
