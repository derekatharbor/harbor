...
// Generated: 2025-11-30T19:36:57.506Z
// Comparing: ALLOut Security vs eConnect Global

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALLOut Security vs eConnect Global (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALLOut Security and eConnect Global. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALLOut Security vs eConnect Global',
    description: 'Detailed comparison of ALLOut Security and eConnect Global.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.506Z',
    modifiedTime: '2025-11-30T19:36:57.506Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allout-security-vs-econnect-global#article",
  "headline": "ALLOut Security vs eConnect Global: Comparison",
  "description": "Detailed comparison of ALLOut Security and eConnect Global. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.506Z",
  "dateModified": "2025-11-30T19:36:57.506Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.506Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.506Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
