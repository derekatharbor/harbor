...
// Comparing: Fairmarkit vs Order.co

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Fairmarkit vs Order.co (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Fairmarkit and Order.co. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Fairmarkit vs Order.co',
    description: 'Detailed comparison of Fairmarkit and Order.co.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/fairmarkit-vs-orderco#article",
  "headline": "Fairmarkit vs Order.co: Comparison",
  "description": "Detailed comparison of Fairmarkit and Order.co. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Payments AI for reconciliation",
    "Tracking AI for vendor updates",
    "Fulfillment AI for order placement",
    "Approvals AI for purchase guidance",
    "Sourcing AI for supplier identification"
  ],
  "integrations": []
}
