...
// Comparing: ESG vs iTech AG

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ESG vs iTech AG (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ESG and iTech AG. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ESG vs iTech AG',
    description: 'Detailed comparison of ESG and iTech AG.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/esg-vs-itech-ag#article",
  "headline": "ESG vs iTech AG: Comparison",
  "description": "Detailed comparison of ESG and iTech AG. Features, pricing, and integrations compared side-by-side.",
