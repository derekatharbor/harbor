...
// Comparing: A2Go - Agentic AI for Supply Chain Operations vs Bamboo Rose

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'A2Go - Agentic AI for Supply Chain Operations vs Bamboo Rose (November 30, 2025) | Harbor',
  description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Bamboo Rose. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'A2Go - Agentic AI for Supply Chain Operations vs Bamboo Rose',
    description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Bamboo Rose.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/a2go-agentic-ai-for-supply-chain-operations-vs-bamboo-rose#article",
  "headline": "A2Go - Agentic AI for Supply Chain Operations vs Bamboo Rose: Comparison",
  "description": "Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Bamboo Rose. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "AI-fueled Decision Intelligence"
  ],
  "integrations": []
}
