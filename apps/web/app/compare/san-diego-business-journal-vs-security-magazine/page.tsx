...
// Comparing: San Diego Business Journal vs Security Magazine

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'San Diego Business Journal vs Security Magazine (November 30, 2025) | Harbor',
  description: 'Detailed comparison of San Diego Business Journal and Security Magazine. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'San Diego Business Journal vs Security Magazine',
    description: 'Detailed comparison of San Diego Business Journal and Security Magazine.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/san-diego-business-journal-vs-security-magazine#article",
  "headline": "San Diego Business Journal vs Security Magazine: Comparison",
  "description": "Detailed comparison of San Diego Business Journal and Security Magazine. Features, pricing, and integrations compared side-by-side.",
