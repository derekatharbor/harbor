...
// Comparing: Infrastructure Networks vs PS LIGHTWAVE

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Infrastructure Networks vs PS LIGHTWAVE (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Infrastructure Networks and PS LIGHTWAVE. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Infrastructure Networks vs PS LIGHTWAVE',
    description: 'Detailed comparison of Infrastructure Networks and PS LIGHTWAVE.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infrastructure-networks-vs-ps-lightwave#article",
  "headline": "Infrastructure Networks vs PS LIGHTWAVE: Comparison",
  "description": "Detailed comparison of Infrastructure Networks and PS LIGHTWAVE. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Custom point-to-point and point-to-multipoint network solutions"
  ],
  "integrations": []
}
