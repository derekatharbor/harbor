...
// Comparing: Custom Information Services vs Next Perimeter

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Custom Information Services vs Next Perimeter (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Custom Information Services and Next Perimeter. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Custom Information Services vs Next Perimeter',
    description: 'Detailed comparison of Custom Information Services and Next Perimeter.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/custom-information-services-vs-next-perimeter#article",
  "headline": "Custom Information Services vs Next Perimeter: Comparison",
  "description": "Detailed comparison of Custom Information Services and Next Perimeter. Features, pricing, and integrations compared side-by-side.",
