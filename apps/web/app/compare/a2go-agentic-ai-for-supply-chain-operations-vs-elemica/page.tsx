...
// Comparing: A2Go - Agentic AI for Supply Chain Operations vs Elemica

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'A2Go - Agentic AI for Supply Chain Operations vs Elemica (November 30, 2025) | Harbor',
  description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Elemica. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'A2Go - Agentic AI for Supply Chain Operations vs Elemica',
    description: 'Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Elemica.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/a2go-agentic-ai-for-supply-chain-operations-vs-elemica#article",
  "headline": "A2Go - Agentic AI for Supply Chain Operations vs Elemica: Comparison",
  "description": "Detailed comparison of A2Go - Agentic AI for Supply Chain Operations and Elemica. Features, pricing, and integrations compared side-by-side.",
