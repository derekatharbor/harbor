...
// Generated: 2025-11-30T19:36:57.583Z
// Comparing: Canopy Partners vs Prescryptive Health, Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Canopy Partners vs Prescryptive Health, Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Canopy Partners and Prescryptive Health, Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Canopy Partners vs Prescryptive Health, Inc.',
    description: 'Detailed comparison of Canopy Partners and Prescryptive Health, Inc..',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.583Z',
    modifiedTime: '2025-11-30T19:36:57.583Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/canopy-partners-vs-prescryptive-health-inc#article",
  "headline": "Canopy Partners vs Prescryptive Health, Inc.: Comparison",
  "description": "Detailed comparison of Canopy Partners and Prescryptive Health, Inc.. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.583Z",
  "dateModified": "2025-11-30T19:36:57.583Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.583Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.583Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
