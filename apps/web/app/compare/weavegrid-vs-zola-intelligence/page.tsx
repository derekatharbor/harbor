...
// Comparing: WeaveGrid vs ZOLA iNTELLIGENCE

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'WeaveGrid vs ZOLA iNTELLIGENCE (November 30, 2025) | Harbor',
  description: 'Detailed comparison of WeaveGrid and ZOLA iNTELLIGENCE. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'WeaveGrid vs ZOLA iNTELLIGENCE',
    description: 'Detailed comparison of WeaveGrid and ZOLA iNTELLIGENCE.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/weavegrid-vs-zola-intelligence#article",
  "headline": "WeaveGrid vs ZOLA iNTELLIGENCE: Comparison",
  "description": "Detailed comparison of WeaveGrid and ZOLA iNTELLIGENCE. Features, pricing, and integrations compared side-by-side.",
