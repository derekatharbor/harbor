...
// Comparing: iMocha vs ResNav Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'iMocha vs ResNav Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of iMocha and ResNav Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'iMocha vs ResNav Solutions',
    description: 'Detailed comparison of iMocha and ResNav Solutions.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/imocha-vs-resnav-solutions#article",
  "headline": "iMocha vs ResNav Solutions: Comparison",
  "description": "Detailed comparison of iMocha and ResNav Solutions. Features, pricing, and integrations compared side-by-side.",
...
const brand1 = {
  ...
  "features": [
    ...
    "Skills-Based Hiring",
    "Talent Deployment",
    "10,000+ Enriched Taxonomies",
    "3,000+ Skills Ontologies",
    "10,000+ Skills Assessments"
  ],
  "integrations": [
    "HCM",
    "LMS",
