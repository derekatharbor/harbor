...
// Comparing: Borneo (Acquired by Atlassian) vs Protecto

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Borneo (Acquired by Atlassian) vs Protecto (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Borneo (Acquired by Atlassian) and Protecto. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Borneo (Acquired by Atlassian) vs Protecto',
    description: 'Detailed comparison of Borneo (Acquired by Atlassian) and Protecto.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/borneo-acquired-by-atlassian-vs-protecto#article",
  "headline": "Borneo (Acquired by Atlassian) vs Protecto: Comparison",
  "description": "Detailed comparison of Borneo (Acquired by Atlassian) and Protecto. Features, pricing, and integrations compared side-by-side.",
