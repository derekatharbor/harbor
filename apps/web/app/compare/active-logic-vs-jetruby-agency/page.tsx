...
// Generated: 2025-11-30T19:44:53.490Z
// Comparing: Active Logic vs JetRuby Agency

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Active Logic vs JetRuby Agency (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Active Logic and JetRuby Agency. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Active Logic vs JetRuby Agency',
    description: 'Detailed comparison of Active Logic and JetRuby Agency.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.490Z',
    modifiedTime: '2025-11-30T19:44:53.490Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/active-logic-vs-jetruby-agency#article",
  "headline": "Active Logic vs JetRuby Agency: Comparison",
  "description": "Detailed comparison of Active Logic and JetRuby Agency. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.490Z",
  "dateModified": "2025-11-30T19:44:53.490Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.490Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.490Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
