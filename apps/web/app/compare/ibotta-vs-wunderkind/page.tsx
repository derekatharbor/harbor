...
// Comparing: Ibotta vs Wunderkind

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Ibotta vs Wunderkind (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Ibotta and Wunderkind. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Ibotta vs Wunderkind',
    description: 'Detailed comparison of Ibotta and Wunderkind.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ibotta-vs-wunderkind#article",
  "headline": "Ibotta vs Wunderkind: Comparison",
  "description": "Detailed comparison of Ibotta and Wunderkind. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Ibotta",
      "url": "https://useharbor.io/brands/ibotta"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Wunderkind",
      "url": "https://useharbor.io/brands/wunderkind"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "Ibotta is a performance marketing platform that rewards consumers with cash back on everyday purchases.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": "The app is free to use for consumers.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
    "Earn cash back on purchases",
    "Access to digital promotions",
    "Targeted brand growth solutions",
    "Rewards as a Service platform",
    "Real-time campaign efficiency"
  ],
  "integrations": [
    "Circana"
  ]
...
const brand2 = {
  "slug": "wunderkind",
  "brand_name": "Wunderkind",
  "domain": "wunderkind.co",
  "category": "Performance Marketing",
  "summary": "AI-Powered Performance Marketing Solution",
  "pricing": {
    "price_model": "custom",
  ...
  "features": [
    ...
    "Combines real-time behavioral signals",
    "Triggers high-performing messages across channels",
    "Increases revenue through reach",
    "Seamless integration into existing tech stack",
    "Scales one-to-one marketing messages",
    "Drives significant digital revenue"
  ],
  "integrations": [
    "Movable Ink",
    "Contentsquare",
