...
// Comparing: Brave vs DuckDuckGo

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Brave vs DuckDuckGo (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Brave and DuckDuckGo. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Brave vs DuckDuckGo',
    description: 'Detailed comparison of Brave and DuckDuckGo.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/brave-vs-duckduckgo#article",
  "headline": "Brave vs DuckDuckGo: Comparison",
  "description": "Detailed comparison of Brave and DuckDuckGo. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Brave",
      "url": "https://useharbor.io/brands/brave"
    },
    {
      "@type": "SoftwareApplication",
      "name": "DuckDuckGo",
...
const brand1 = {
  ...
  "summary": "A privacy-focused browser and search engine that prioritizes user experience.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": true,
