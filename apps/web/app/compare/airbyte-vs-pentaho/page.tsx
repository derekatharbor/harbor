...
// Generated: 2025-11-30T19:44:54.053Z
// Comparing: Airbyte vs Pentaho

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Airbyte vs Pentaho (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Airbyte and Pentaho. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Airbyte vs Pentaho',
    description: 'Detailed comparison of Airbyte and Pentaho.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.053Z',
    modifiedTime: '2025-11-30T19:44:54.053Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/airbyte-vs-pentaho#article",
  "headline": "Airbyte vs Pentaho: Comparison",
  "description": "Detailed comparison of Airbyte and Pentaho. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.053Z",
  "dateModified": "2025-11-30T19:44:54.053Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "Airbyte",
      "url": "https://useharbor.io/brands/airbyte"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Pentaho",
      "url": "https://useharbor.io/brands/pentaho"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "Open-source data integration platform for seamless data movement.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Pricing is separated between databases and API sources, and is designed to be easy to understand and predict.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
    "Replicate data in minutes with pre-built and custom connectors",
    "Supports the largest number of connectors in the industry",
    "Real-time monitoring and notifications",
    "Custom transformations using dbt integration",
    "Build custom connectors in hours using low-code Connector Builder"
  ],
  "integrations": [
    "Azure Blob Storage",
    "BigQuery",
...
const brand2 = {
  ...
  "domain": "pentaho.com",
  "category": "Data Integration",
  "summary": "Pentaho is a scalable data integration and intelligence platform designed to help organizations manage and activate their data effectively.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.053Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.053Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
