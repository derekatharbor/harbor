...
// Comparing: Astute Technology Management vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Astute Technology Management vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Astute Technology Management and ICE Consulting - Managed IT & Cybersecurity for Life Sciences. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Astute Technology Management vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences',
    description: 'Detailed comparison of Astute Technology Management and ICE Consulting - Managed IT & Cybersecurity for Life Sciences.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/astute-technology-management-vs-ice-consulting-managed-it-cybersecurity-for-life-sciences#article",
  "headline": "Astute Technology Management vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences: Comparison",
  "description": "Detailed comparison of Astute Technology Management and ICE Consulting - Managed IT & Cybersecurity for Life Sciences. Features, pricing, and integrations compared side-by-side.",
