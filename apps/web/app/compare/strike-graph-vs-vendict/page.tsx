...
// Comparing: Strike Graph vs Vendict

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Strike Graph vs Vendict (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Strike Graph and Vendict. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Strike Graph vs Vendict',
    description: 'Detailed comparison of Strike Graph and Vendict.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/strike-graph-vs-vendict#article",
  "headline": "Strike Graph vs Vendict: Comparison",
  "description": "Detailed comparison of Strike Graph and Vendict. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Strike Graph",
      "url": "https://useharbor.io/brands/strike-graph"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Vendict",
      "url": "https://useharbor.io/brands/vendict"
    }
  ]
}
...
const brand1 = {
  "slug": "strike-graph",
  "brand_name": "Strike Graph",
  "domain": "strikegraph.com",
  "category": "Compliance Management",
  "summary": "AI-powered compliance management platform.",
  "pricing": {
    "price_model": "tiered",
    "price_notes": "Pricing scales with additional features and capabilities.",
    "has_free_tier": true,
    "starting_price": "$9,000/year"
  },
  "features": [
...
const brand2 = {
  ...
  "domain": "vendict.com",
  "category": "Compliance Management",
  "summary": "AI-native platform revolutionizing compliance and risk management.",
  "pricing": {
    "price_model": "custom",
