...
// Comparing: BRYTER vs Harvey

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BRYTER vs Harvey (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BRYTER and Harvey. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BRYTER vs Harvey',
    description: 'Detailed comparison of BRYTER and Harvey.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bryter-vs-harvey#article",
  "headline": "BRYTER vs Harvey: Comparison",
  "description": "Detailed comparison of BRYTER and Harvey. Features, pricing, and integrations compared side-by-side.",
