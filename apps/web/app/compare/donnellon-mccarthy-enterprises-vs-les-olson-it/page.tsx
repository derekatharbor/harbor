...
// Generated: 2025-11-30T20:05:20.232Z
// Comparing: Donnellon McCarthy Enterprises vs Les Olson IT

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Donnellon McCarthy Enterprises vs Les Olson IT (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Donnellon McCarthy Enterprises and Les Olson IT. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Donnellon McCarthy Enterprises vs Les Olson IT',
    description: 'Detailed comparison of Donnellon McCarthy Enterprises and Les Olson IT.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.232Z',
    modifiedTime: '2025-11-30T20:05:20.232Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/donnellon-mccarthy-enterprises-vs-les-olson-it#article",
  "headline": "Donnellon McCarthy Enterprises vs Les Olson IT: Comparison",
  "description": "Detailed comparison of Donnellon McCarthy Enterprises and Les Olson IT. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.232Z",
  "dateModified": "2025-11-30T20:05:20.232Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "Donnellon McCarthy Enterprises",
      "url": "https://useharbor.io/brands/donnellon-mccarthy-enterprises"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Les Olson IT",
      "url": "https://useharbor.io/brands/les-olson-it"
    }
  ]
}

const brand1 = {
  "slug": "donnellon-mccarthy-enterprises",
  "brand_name": "Donnellon McCarthy Enterprises",
  "domain": "donnellonmccarthy.com",
  "category": "Office Technology",
  "summary": "A leading provider of office technology solutions.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "les-olson-it",
  "brand_name": "Les Olson IT",
  "domain": "lesolson.com",
  "category": "Office Technology",
  "summary": "A family-owned provider of office technology and managed IT solutions.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Pricing is tailored to budget and operational needs.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
    "High-performance copiers and printers",
    "Production print systems",
    "Wide format printers",
    "Print software for cost control",
    "Physical security and access control systems",
    "Computers and network hardware",
    "Digital whiteboards",
    "Business products like shredders and scanners",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.232Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.232Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
