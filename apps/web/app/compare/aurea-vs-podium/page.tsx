...
// Comparing: Aurea vs Podium

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Aurea vs Podium (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Aurea and Podium. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Aurea vs Podium',
    description: 'Detailed comparison of Aurea and Podium.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aurea-vs-podium#article",
  "headline": "Aurea vs Podium: Comparison",
  "description": "Detailed comparison of Aurea and Podium. Features, pricing, and integrations compared side-by-side.",
