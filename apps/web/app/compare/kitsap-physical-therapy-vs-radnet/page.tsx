...
// Generated: 2025-11-30T19:36:57.405Z
// Comparing: Kitsap Physical Therapy vs RadNet

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Kitsap Physical Therapy vs RadNet (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Kitsap Physical Therapy and RadNet. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Kitsap Physical Therapy vs RadNet',
    description: 'Detailed comparison of Kitsap Physical Therapy and RadNet.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.405Z',
    modifiedTime: '2025-11-30T19:36:57.405Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/kitsap-physical-therapy-vs-radnet#article",
  "headline": "Kitsap Physical Therapy vs RadNet: Comparison",
  "description": "Detailed comparison of Kitsap Physical Therapy and RadNet. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.405Z",
  "dateModified": "2025-11-30T19:36:57.405Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.405Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.405Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
