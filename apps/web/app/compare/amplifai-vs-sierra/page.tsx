...
// Comparing: AmplifAI vs Sierra

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AmplifAI vs Sierra (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AmplifAI and Sierra. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AmplifAI vs Sierra',
    description: 'Detailed comparison of AmplifAI and Sierra.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amplifai-vs-sierra#article",
  "headline": "AmplifAI vs Sierra: Comparison",
  "description": "Detailed comparison of AmplifAI and Sierra. Features, pricing, and integrations compared side-by-side.",
