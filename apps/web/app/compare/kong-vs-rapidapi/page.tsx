...
// Comparing: Kong vs RapidAPI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Kong vs RapidAPI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Kong and RapidAPI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Kong vs RapidAPI',
    description: 'Detailed comparison of Kong and RapidAPI.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/kong-vs-rapidapi#article",
  "headline": "Kong vs RapidAPI: Comparison",
  "description": "Detailed comparison of Kong and RapidAPI. Features, pricing, and integrations compared side-by-side.",
