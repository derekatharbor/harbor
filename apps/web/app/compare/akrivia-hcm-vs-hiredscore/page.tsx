...
// Generated: 2025-11-30T20:05:20.405Z
// Comparing: Akrivia HCM vs HiredScore

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Akrivia HCM vs HiredScore (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Akrivia HCM and HiredScore. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Akrivia HCM vs HiredScore',
    description: 'Detailed comparison of Akrivia HCM and HiredScore.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.405Z',
    modifiedTime: '2025-11-30T20:05:20.405Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/akrivia-hcm-vs-hiredscore#article",
  "headline": "Akrivia HCM vs HiredScore: Comparison",
  "description": "Detailed comparison of Akrivia HCM and HiredScore. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.405Z",
  "dateModified": "2025-11-30T20:05:20.405Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.405Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.405Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
