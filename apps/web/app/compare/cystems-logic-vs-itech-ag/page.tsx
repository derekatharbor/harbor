...
// Comparing: Cystems Logic vs iTech AG

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cystems Logic vs iTech AG (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cystems Logic and iTech AG. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cystems Logic vs iTech AG',
    description: 'Detailed comparison of Cystems Logic and iTech AG.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cystems-logic-vs-itech-ag#article",
  "headline": "Cystems Logic vs iTech AG: Comparison",
  "description": "Detailed comparison of Cystems Logic and iTech AG. Features, pricing, and integrations compared side-by-side.",
