...
// Comparing: CorSource vs VySystems

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CorSource vs VySystems (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CorSource and VySystems. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CorSource vs VySystems',
    description: 'Detailed comparison of CorSource and VySystems.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/corsource-vs-vysystems#article",
  "headline": "CorSource vs VySystems: Comparison",
  "description": "Detailed comparison of CorSource and VySystems. Features, pricing, and integrations compared side-by-side.",
