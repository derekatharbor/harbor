...
// Comparing: QuadraNet Enterprises, LLC. vs SumTotal Systems, LLC

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'QuadraNet Enterprises, LLC. vs SumTotal Systems, LLC (November 30, 2025) | Harbor',
  description: 'Detailed comparison of QuadraNet Enterprises, LLC. and SumTotal Systems, LLC. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'QuadraNet Enterprises, LLC. vs SumTotal Systems, LLC',
    description: 'Detailed comparison of QuadraNet Enterprises, LLC. and SumTotal Systems, LLC.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/quadranet-enterprises-llc-vs-sumtotal-systems-llc#article",
  "headline": "QuadraNet Enterprises, LLC. vs SumTotal Systems, LLC: Comparison",
  "description": "Detailed comparison of QuadraNet Enterprises, LLC. and SumTotal Systems, LLC. Features, pricing, and integrations compared side-by-side.",
