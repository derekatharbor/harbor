...
// Comparing: Manta, an IBM Company vs Reltio

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Manta, an IBM Company vs Reltio (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Manta, an IBM Company and Reltio. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Manta, an IBM Company vs Reltio',
    description: 'Detailed comparison of Manta, an IBM Company and Reltio.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/manta-an-ibm-company-vs-reltio#article",
  "headline": "Manta, an IBM Company vs Reltio: Comparison",
  "description": "Detailed comparison of Manta, an IBM Company and Reltio. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Fast-start implementation methodology"
  ],
  "integrations": []
}
