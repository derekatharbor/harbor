...
// Generated: 2025-11-30T19:44:53.413Z
// Comparing: Infrastructure Networks vs LOGIX FIBER NETWORKS

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Infrastructure Networks vs LOGIX FIBER NETWORKS (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Infrastructure Networks and LOGIX FIBER NETWORKS. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Infrastructure Networks vs LOGIX FIBER NETWORKS',
    description: 'Detailed comparison of Infrastructure Networks and LOGIX FIBER NETWORKS.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.413Z',
    modifiedTime: '2025-11-30T19:44:53.413Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infrastructure-networks-vs-logix-fiber-networks#article",
  "headline": "Infrastructure Networks vs LOGIX FIBER NETWORKS: Comparison",
  "description": "Detailed comparison of Infrastructure Networks and LOGIX FIBER NETWORKS. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.413Z",
  "dateModified": "2025-11-30T19:44:53.413Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.413Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.413Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
