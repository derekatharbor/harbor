...
// Comparing: Cobalt Iron vs InCountry

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cobalt Iron vs InCountry (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cobalt Iron and InCountry. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cobalt Iron vs InCountry',
    description: 'Detailed comparison of Cobalt Iron and InCountry.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cobalt-iron-vs-incountry#article",
  "headline": "Cobalt Iron vs InCountry: Comparison",
  "description": "Detailed comparison of Cobalt Iron and InCountry. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Cobalt Iron",
      "url": "https://useharbor.io/brands/cobalt-iron"
    },
    {
      "@type": "SoftwareApplication",
      "name": "InCountry",
...
const brand1 = {
  "slug": "cobalt-iron",
  "brand_name": "Cobalt Iron",
  "domain": "cobaltiron.com",
  "category": "Data Protection",
  "summary": "Cobalt Iron is a leader in SaaS-based enterprise data protection technology.",
  "pricing": {
    "price_model": "custom",
  ...
  "features": [
    ...
    "Cyber Shield® security features",
    "Zero Access® policy",
    "Automated security infrastructure",
    "Ongoing monitoring and analysis of operational backup metadata"
  ],
  "integrations": [
    "Amazon Web Services",
