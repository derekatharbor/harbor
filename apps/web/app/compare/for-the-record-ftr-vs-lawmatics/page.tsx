...
// Comparing: For The Record (FTR) vs Lawmatics

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'For The Record (FTR) vs Lawmatics (November 30, 2025) | Harbor',
  description: 'Detailed comparison of For The Record (FTR) and Lawmatics. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'For The Record (FTR) vs Lawmatics',
    description: 'Detailed comparison of For The Record (FTR) and Lawmatics.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/for-the-record-ftr-vs-lawmatics#article",
  "headline": "For The Record (FTR) vs Lawmatics: Comparison",
  "description": "Detailed comparison of For The Record (FTR) and Lawmatics. Features, pricing, and integrations compared side-by-side.",
