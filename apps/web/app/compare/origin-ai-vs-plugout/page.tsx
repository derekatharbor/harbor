...
// Comparing: Origin AI vs PLUGOUT

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Origin AI vs PLUGOUT (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Origin AI and PLUGOUT. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Origin AI vs PLUGOUT',
    description: 'Detailed comparison of Origin AI and PLUGOUT.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/origin-ai-vs-plugout#article",
  "headline": "Origin AI vs PLUGOUT: Comparison",
  "description": "Detailed comparison of Origin AI and PLUGOUT. Features, pricing, and integrations compared side-by-side.",
