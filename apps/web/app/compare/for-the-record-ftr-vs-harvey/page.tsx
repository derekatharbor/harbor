...
// Comparing: For The Record (FTR) vs Harvey

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'For The Record (FTR) vs Harvey (November 30, 2025) | Harbor',
  description: 'Detailed comparison of For The Record (FTR) and Harvey. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'For The Record (FTR) vs Harvey',
    description: 'Detailed comparison of For The Record (FTR) and Harvey.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/for-the-record-ftr-vs-harvey#article",
  "headline": "For The Record (FTR) vs Harvey: Comparison",
  "description": "Detailed comparison of For The Record (FTR) and Harvey. Features, pricing, and integrations compared side-by-side.",
