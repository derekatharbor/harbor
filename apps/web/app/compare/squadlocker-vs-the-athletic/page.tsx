...
// Comparing: SquadLocker vs The Athletic

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'SquadLocker vs The Athletic (November 30, 2025) | Harbor',
  description: 'Detailed comparison of SquadLocker and The Athletic. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'SquadLocker vs The Athletic',
    description: 'Detailed comparison of SquadLocker and The Athletic.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/squadlocker-vs-the-athletic#article",
  "headline": "SquadLocker vs The Athletic: Comparison",
  "description": "Detailed comparison of SquadLocker and The Athletic. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "SquadLocker",
      "url": "https://useharbor.io/brands/squadlocker"
    },
    {
      "@type": "SoftwareApplication",
      "name": "The Athletic",
      "url": "https://useharbor.io/brands/the-athletic"
    }
  ]
}
...
const brand1 = {
  "slug": "squadlocker",
  "brand_name": "SquadLocker",
  "domain": "squadlocker.com",
  "category": "Apparel",
  "summary": "Custom team uniforms and apparel solutions for schools, sports organizations, and businesses.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "the-athletic",
  "brand_name": "The Athletic",
  "domain": "theathleticcommunity.com",
  "category": "Apparel",
  "summary": "A brand focused on athletic apparel and gear for outdoor enthusiasts.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Price for individual socks",
    "has_free_tier": false,
