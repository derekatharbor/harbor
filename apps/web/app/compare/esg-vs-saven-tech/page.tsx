...
// Comparing: ESG vs Saven Tech

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ESG vs Saven Tech (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ESG and Saven Tech. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ESG vs Saven Tech',
    description: 'Detailed comparison of ESG and Saven Tech.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/esg-vs-saven-tech#article",
  "headline": "ESG vs Saven Tech: Comparison",
  "description": "Detailed comparison of ESG and Saven Tech. Features, pricing, and integrations compared side-by-side.",
