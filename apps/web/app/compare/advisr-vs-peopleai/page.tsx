...
// Comparing: Advisr vs People.ai

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Advisr vs People.ai (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Advisr and People.ai. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Advisr vs People.ai',
    description: 'Detailed comparison of Advisr and People.ai.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/advisr-vs-peopleai#article",
  "headline": "Advisr vs People.ai: Comparison",
  "description": "Detailed comparison of Advisr and People.ai. Features, pricing, and integrations compared side-by-side.",
