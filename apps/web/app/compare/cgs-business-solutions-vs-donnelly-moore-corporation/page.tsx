...
// Comparing: CGS Business Solutions vs Donnelly & Moore Corporation

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CGS Business Solutions vs Donnelly & Moore Corporation (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CGS Business Solutions and Donnelly & Moore Corporation. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CGS Business Solutions vs Donnelly & Moore Corporation',
    description: 'Detailed comparison of CGS Business Solutions and Donnelly & Moore Corporation.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cgs-business-solutions-vs-donnelly-moore-corporation#article",
  "headline": "CGS Business Solutions vs Donnelly & Moore Corporation: Comparison",
  "description": "Detailed comparison of CGS Business Solutions and Donnelly & Moore Corporation. Features, pricing, and integrations compared side-by-side.",
