...
// Comparing: Origin AI vs Reco

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Origin AI vs Reco (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Origin AI and Reco. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Origin AI vs Reco',
    description: 'Detailed comparison of Origin AI and Reco.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/origin-ai-vs-reco#article",
  "headline": "Origin AI vs Reco: Comparison",
  "description": "Detailed comparison of Origin AI and Reco. Features, pricing, and integrations compared side-by-side.",
