...
// Generated: 2025-11-30T19:36:57.440Z
// Comparing: ArhamSoft (Pvt) Ltd vs Oxagile

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ArhamSoft (Pvt) Ltd vs Oxagile (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ArhamSoft (Pvt) Ltd and Oxagile. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ArhamSoft (Pvt) Ltd vs Oxagile',
    description: 'Detailed comparison of ArhamSoft (Pvt) Ltd and Oxagile.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.440Z',
    modifiedTime: '2025-11-30T19:36:57.440Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/arhamsoft-pvt-ltd-vs-oxagile#article",
  "headline": "ArhamSoft (Pvt) Ltd vs Oxagile: Comparison",
  "description": "Detailed comparison of ArhamSoft (Pvt) Ltd and Oxagile. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.440Z",
  "dateModified": "2025-11-30T19:36:57.440Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.440Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.440Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
