...
// Comparing: LaunchNotes vs UserVoice

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'LaunchNotes vs UserVoice (November 30, 2025) | Harbor',
  description: 'Detailed comparison of LaunchNotes and UserVoice. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'LaunchNotes vs UserVoice',
    description: 'Detailed comparison of LaunchNotes and UserVoice.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/launchnotes-vs-uservoice#article",
  "headline": "LaunchNotes vs UserVoice: Comparison",
  "description": "Detailed comparison of LaunchNotes and UserVoice. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "LaunchNotes",
      "url": "https://useharbor.io/brands/launchnotes"
    },
    {
      "@type": "SoftwareApplication",
      "name": "UserVoice",
      "url": "https://useharbor.io/brands/uservoice"
    }
  ]
}
...
const brand1 = {
  "slug": "launchnotes",
  "brand_name": "LaunchNotes",
  "domain": "launchnotes.com",
  "category": "Product Management",
  "summary": "A product communication platform designed for enterprise teams.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Free 14-day trial available",
    "has_free_tier": true,
    "starting_price": "$249/mo"
  },
  "features": [
    "Announcements",
    "Roadmap",
...
const brand2 = {
  "slug": "uservoice",
  "brand_name": "UserVoice",
  "domain": "uservoice.com",
  "category": "Product Management",
  "summary": "UserVoice is a product feedback management platform designed to enhance product strategy through customer engagement.",
  "pricing": {
    "price_model": "tiered",
    "price_notes": "Annual plans available with a 10% discount.",
    "has_free_tier": true,
    "starting_price": "$899/mo"
  },
  "features": [
    "Feedback activity dashboard",
    "Web portal",
    "In-App widget",
