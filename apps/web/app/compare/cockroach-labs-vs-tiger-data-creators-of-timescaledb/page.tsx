...
// Comparing: Cockroach Labs vs Tiger Data (creators of TimescaleDB)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cockroach Labs vs Tiger Data (creators of TimescaleDB) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cockroach Labs and Tiger Data (creators of TimescaleDB). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cockroach Labs vs Tiger Data (creators of TimescaleDB)',
    description: 'Detailed comparison of Cockroach Labs and Tiger Data (creators of TimescaleDB).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cockroach-labs-vs-tiger-data-creators-of-timescaledb#article",
  "headline": "Cockroach Labs vs Tiger Data (creators of TimescaleDB): Comparison",
  "description": "Detailed comparison of Cockroach Labs and Tiger Data (creators of TimescaleDB). Features, pricing, and integrations compared side-by-side.",
