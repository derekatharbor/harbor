...
// Generated: 2025-11-30T19:44:53.435Z
// Comparing: Frontier Business Products vs Next Perimeter

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Frontier Business Products vs Next Perimeter (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Frontier Business Products and Next Perimeter. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Frontier Business Products vs Next Perimeter',
    description: 'Detailed comparison of Frontier Business Products and Next Perimeter.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.435Z',
    modifiedTime: '2025-11-30T19:44:53.435Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/frontier-business-products-vs-next-perimeter#article",
  "headline": "Frontier Business Products vs Next Perimeter: Comparison",
  "description": "Detailed comparison of Frontier Business Products and Next Perimeter. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.435Z",
  "dateModified": "2025-11-30T19:44:53.435Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.435Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.435Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
