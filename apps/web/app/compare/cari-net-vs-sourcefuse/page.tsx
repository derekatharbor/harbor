...
// Comparing: CARI.net vs SourceFuse

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CARI.net vs SourceFuse (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CARI.net and SourceFuse. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CARI.net vs SourceFuse',
    description: 'Detailed comparison of CARI.net and SourceFuse.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cari-net-vs-sourcefuse#article",
  "headline": "CARI.net vs SourceFuse: Comparison",
  "description": "Detailed comparison of CARI.net and SourceFuse. Features, pricing, and integrations compared side-by-side.",
