...
// Comparing: artnet vs Yummy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'artnet vs Yummy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of artnet and Yummy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'artnet vs Yummy',
    description: 'Detailed comparison of artnet and Yummy.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/artnet-vs-yummy#article",
  "headline": "artnet vs Yummy: Comparison",
  "description": "Detailed comparison of artnet and Yummy. Features, pricing, and integrations compared side-by-side.",
