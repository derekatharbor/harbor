...
// Generated: 2025-11-30T20:05:20.313Z
// Comparing: Emagine IT, Inc. vs Software Design Partners

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Emagine IT, Inc. vs Software Design Partners (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Emagine IT, Inc. and Software Design Partners. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Emagine IT, Inc. vs Software Design Partners',
    description: 'Detailed comparison of Emagine IT, Inc. and Software Design Partners.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.313Z',
    modifiedTime: '2025-11-30T20:05:20.313Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/emagine-it-inc-vs-software-design-partners#article",
  "headline": "Emagine IT, Inc. vs Software Design Partners: Comparison",
  "description": "Detailed comparison of Emagine IT, Inc. and Software Design Partners. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.313Z",
  "dateModified": "2025-11-30T20:05:20.313Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.313Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.313Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
