...
// Comparing: AIDS Healthcare Foundation vs Tarzana Treatment Centers

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AIDS Healthcare Foundation vs Tarzana Treatment Centers (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AIDS Healthcare Foundation and Tarzana Treatment Centers. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AIDS Healthcare Foundation vs Tarzana Treatment Centers',
    description: 'Detailed comparison of AIDS Healthcare Foundation and Tarzana Treatment Centers.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aids-healthcare-foundation-vs-tarzana-treatment-centers#article",
  "headline": "AIDS Healthcare Foundation vs Tarzana Treatment Centers: Comparison",
  "description": "Detailed comparison of AIDS Healthcare Foundation and Tarzana Treatment Centers. Features, pricing, and integrations compared side-by-side.",
