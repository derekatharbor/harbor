...
// Comparing: CONFLUX SYSTEMS vs Project Insight

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CONFLUX SYSTEMS vs Project Insight (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CONFLUX SYSTEMS and Project Insight. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CONFLUX SYSTEMS vs Project Insight',
    description: 'Detailed comparison of CONFLUX SYSTEMS and Project Insight.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/conflux-systems-vs-project-insight#article",
  "headline": "CONFLUX SYSTEMS vs Project Insight: Comparison",
  "description": "Detailed comparison of CONFLUX SYSTEMS and Project Insight. Features, pricing, and integrations compared side-by-side.",
