...
// Comparing: Gala vs Neo

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Gala vs Neo (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Gala and Neo. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Gala vs Neo',
    description: 'Detailed comparison of Gala and Neo.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gala-vs-neo#article",
  "headline": "Gala vs Neo: Comparison",
  "description": "Detailed comparison of Gala and Neo. Features, pricing, and integrations compared side-by-side.",
