...
// Comparing: Amnet vs Palmetto Technology Group (PTG)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Amnet vs Palmetto Technology Group (PTG) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Amnet and Palmetto Technology Group (PTG). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Amnet vs Palmetto Technology Group (PTG)',
    description: 'Detailed comparison of Amnet and Palmetto Technology Group (PTG).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amnet-vs-palmetto-technology-group-ptg#article",
  "headline": "Amnet vs Palmetto Technology Group (PTG): Comparison",
  "description": "Detailed comparison of Amnet and Palmetto Technology Group (PTG). Features, pricing, and integrations compared side-by-side.",
