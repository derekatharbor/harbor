...
// Comparing: ClearObject vs EvonSys

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ClearObject vs EvonSys (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ClearObject and EvonSys. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ClearObject vs EvonSys',
    description: 'Detailed comparison of ClearObject and EvonSys.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/clearobject-vs-evonsys#article",
  "headline": "ClearObject vs EvonSys: Comparison",
  "description": "Detailed comparison of ClearObject and EvonSys. Features, pricing, and integrations compared side-by-side.",
