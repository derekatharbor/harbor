...
// Comparing: 360 Advanced vs Trava Security

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '360 Advanced vs Trava Security (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 360 Advanced and Trava Security. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '360 Advanced vs Trava Security',
    description: 'Detailed comparison of 360 Advanced and Trava Security.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/360-advanced-vs-trava-security#article",
  "headline": "360 Advanced vs Trava Security: Comparison",
  "description": "Detailed comparison of 360 Advanced and Trava Security. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "360 Advanced",
      "url": "https://useharbor.io/brands/360-advanced"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Trava Security",
      "url": "https://useharbor.io/brands/trava-security"
    }
  ]
}
...
const brand1 = {
  "slug": "360-advanced",
  "brand_name": "360 Advanced",
  "domain": "360advanced.com",
  "category": "Cybersecurity and Compliance",
  "summary": "A cybersecurity and compliance firm specializing in tailored security support and compliance programs.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "trava-security",
  "brand_name": "Trava Security",
  "domain": "travasecurity.com",
  "category": "Cybersecurity and Compliance",
  "summary": "Trava Security provides compliance and cybersecurity advisory services tailored for growth-stage companies.",
  "pricing": {
    "price_model": "custom",
