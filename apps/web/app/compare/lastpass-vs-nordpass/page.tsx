...
// Comparing: LastPass vs NordPass

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'LastPass vs NordPass (November 30, 2025) | Harbor',
  description: 'Detailed comparison of LastPass and NordPass. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'LastPass vs NordPass',
    description: 'Detailed comparison of LastPass and NordPass.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/lastpass-vs-nordpass#article",
  "headline": "LastPass vs NordPass: Comparison",
  "description": "Detailed comparison of LastPass and NordPass. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "NordPass",
      "url": "https://useharbor.io/brands/nordpass"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "nordpass.com",
  "category": "Password Management",
  "summary": "A password manager designed for individuals and businesses to enhance online security.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": "Free plan available with essential features; Premium and Family plans available but specific prices not listed.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
