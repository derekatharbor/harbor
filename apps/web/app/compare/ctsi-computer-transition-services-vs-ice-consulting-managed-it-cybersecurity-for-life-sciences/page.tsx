...
// Generated: 2025-11-30T19:44:53.410Z
// Comparing: CTSI | Computer Transition Services vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CTSI | Computer Transition Services vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CTSI | Computer Transition Services and ICE Consulting - Managed IT & Cybersecurity for Life Sciences. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CTSI | Computer Transition Services vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences',
    description: 'Detailed comparison of CTSI | Computer Transition Services and ICE Consulting - Managed IT & Cybersecurity for Life Sciences.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.410Z',
    modifiedTime: '2025-11-30T19:44:53.410Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ctsi-computer-transition-services-vs-ice-consulting-managed-it-cybersecurity-for-life-sciences#article",
  "headline": "CTSI | Computer Transition Services vs ICE Consulting - Managed IT & Cybersecurity for Life Sciences: Comparison",
  "description": "Detailed comparison of CTSI | Computer Transition Services and ICE Consulting - Managed IT & Cybersecurity for Life Sciences. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.410Z",
  "dateModified": "2025-11-30T19:44:53.410Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.410Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.410Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
