...
// Comparing: ArhamSoft (Pvt) Ltd vs IQ Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ArhamSoft (Pvt) Ltd vs IQ Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ArhamSoft (Pvt) Ltd and IQ Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ArhamSoft (Pvt) Ltd vs IQ Inc.',
    description: 'Detailed comparison of ArhamSoft (Pvt) Ltd and IQ Inc..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/arhamsoft-pvt-ltd-vs-iq-inc#article",
  "headline": "ArhamSoft (Pvt) Ltd vs IQ Inc.: Comparison",
  "description": "Detailed comparison of ArhamSoft (Pvt) Ltd and IQ Inc.. Features, pricing, and integrations compared side-by-side.",
