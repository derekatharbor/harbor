...
// Comparing: DynamiCare Health vs Wellthy Therapeutics (acquired by TruDoc)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DynamiCare Health vs Wellthy Therapeutics (acquired by TruDoc) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DynamiCare Health and Wellthy Therapeutics (acquired by TruDoc). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DynamiCare Health vs Wellthy Therapeutics (acquired by TruDoc)',
    description: 'Detailed comparison of DynamiCare Health and Wellthy Therapeutics (acquired by TruDoc).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dynamicare-health-vs-wellthy-therapeutics-acquired-by-trudoc#article",
  "headline": "DynamiCare Health vs Wellthy Therapeutics (acquired by TruDoc): Comparison",
  "description": "Detailed comparison of DynamiCare Health and Wellthy Therapeutics (acquired by TruDoc). Features, pricing, and integrations compared side-by-side.",
