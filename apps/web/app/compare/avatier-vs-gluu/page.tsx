...
// Comparing: Avatier vs Gluu

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Avatier vs Gluu (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Avatier and Gluu. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Avatier vs Gluu',
    description: 'Detailed comparison of Avatier and Gluu.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/avatier-vs-gluu#article",
  "headline": "Avatier vs Gluu: Comparison",
  "description": "Detailed comparison of Avatier and Gluu. Features, pricing, and integrations compared side-by-side.",
