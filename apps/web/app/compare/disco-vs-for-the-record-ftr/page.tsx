...
// Generated: 2025-11-30T20:05:20.346Z
// Comparing: DISCO vs For The Record (FTR)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DISCO vs For The Record (FTR) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DISCO and For The Record (FTR). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DISCO vs For The Record (FTR)',
    description: 'Detailed comparison of DISCO and For The Record (FTR).',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.346Z',
    modifiedTime: '2025-11-30T20:05:20.346Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/disco-vs-for-the-record-ftr#article",
  "headline": "DISCO vs For The Record (FTR): Comparison",
  "description": "Detailed comparison of DISCO and For The Record (FTR). Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.346Z",
  "dateModified": "2025-11-30T20:05:20.346Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand1 = {
  ...
  "features": [
    ...
    "Comprehensive audit logs and robust reporting",
    "Single sign-on",
    "Unlimited users",
    "Unlimited requests",
    "Onboarding"
...
const brand2 = {
  ...
  "features": [
    ...
    "Custom courtroom technology design and installation",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.346Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.346Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
