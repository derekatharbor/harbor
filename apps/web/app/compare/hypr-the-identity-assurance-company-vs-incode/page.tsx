...
// Comparing: HYPR | The Identity Assurance Company vs Incode

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'HYPR | The Identity Assurance Company vs Incode (November 30, 2025) | Harbor',
  description: 'Detailed comparison of HYPR | The Identity Assurance Company and Incode. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'HYPR | The Identity Assurance Company vs Incode',
    description: 'Detailed comparison of HYPR | The Identity Assurance Company and Incode.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hypr-the-identity-assurance-company-vs-incode#article",
  "headline": "HYPR | The Identity Assurance Company vs Incode: Comparison",
  "description": "Detailed comparison of HYPR | The Identity Assurance Company and Incode. Features, pricing, and integrations compared side-by-side.",
