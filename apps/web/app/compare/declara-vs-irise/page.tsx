...
// Comparing: Declara vs iRise

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Declara vs iRise (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Declara and iRise. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Declara vs iRise',
    description: 'Detailed comparison of Declara and iRise.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/declara-vs-irise#article",
  "headline": "Declara vs iRise: Comparison",
  "description": "Detailed comparison of Declara and iRise. Features, pricing, and integrations compared side-by-side.",
