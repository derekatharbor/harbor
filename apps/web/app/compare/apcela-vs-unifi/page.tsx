...
// Comparing: Apcela vs UniFi

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Apcela vs UniFi (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Apcela and UniFi. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Apcela vs UniFi',
    description: 'Detailed comparison of Apcela and UniFi.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/apcela-vs-unifi#article",
  "headline": "Apcela vs UniFi: Comparison",
  "description": "Detailed comparison of Apcela and UniFi. Features, pricing, and integrations compared side-by-side.",
