...
// Generated: 2025-11-30T19:44:54.039Z
// Comparing: Cambridge Technology Enterprises Limited vs Deccan AI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cambridge Technology Enterprises Limited vs Deccan AI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cambridge Technology Enterprises Limited and Deccan AI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cambridge Technology Enterprises Limited vs Deccan AI',
    description: 'Detailed comparison of Cambridge Technology Enterprises Limited and Deccan AI.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:54.039Z',
    modifiedTime: '2025-11-30T19:44:54.039Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cambridge-technology-enterprises-limited-vs-deccan-ai#article",
  "headline": "Cambridge Technology Enterprises Limited vs Deccan AI: Comparison",
  "description": "Detailed comparison of Cambridge Technology Enterprises Limited and Deccan AI. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:54.039Z",
  "dateModified": "2025-11-30T19:44:54.039Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "Deccan AI",
      "url": "https://useharbor.io/brands/deccan-ai"
    }
  ]
}
...
const brand2 = {
  "slug": "deccan-ai",
  "brand_name": "Deccan AI",
  "domain": "deccan.ai",
  "category": "AI and Data Solutions",
  "summary": "Deccan AI provides high-quality, human-curated datasets and AI solutions for superior model training and operations.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Contact for pricing details",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
    ...
    "Interoperable LLM workflows",
    "Supervised fine-tuning across modalities",
    "Text-To-SQL conversion",
    "Model performance evaluation",
    "Optimize AI models with human feedback"
  ],
  "integrations": []
}
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:54.039Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:54.039Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
