...
// Comparing: Mirabilis Design Inc. vs Real Intent

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Mirabilis Design Inc. vs Real Intent (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Mirabilis Design Inc. and Real Intent. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Mirabilis Design Inc. vs Real Intent',
    description: 'Detailed comparison of Mirabilis Design Inc. and Real Intent.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/mirabilis-design-inc-vs-real-intent#article",
  "headline": "Mirabilis Design Inc. vs Real Intent: Comparison",
  "description": "Detailed comparison of Mirabilis Design Inc. and Real Intent. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "url": "https://useharbor.io/brands/mirabilis-design-inc"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Real Intent",
      "url": "https://useharbor.io/brands/real-intent"
    }
  ]
}

const brand1 = {
  "slug": "mirabilis-design-inc",
  "brand_name": "Mirabilis Design Inc.",
  "domain": "mirabilisdesign.com",
  "category": "EDA Software",
  "summary": "Mirabilis Design is a Silicon Valley-based EDA software company specializing in electronic system architecture.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "VisualSim can be purchased as an annual or perpetual license.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
...
const brand2 = {
  "slug": "real-intent",
  "brand_name": "Real Intent",
  "domain": "realintent.com",
  "category": "EDA Software",
  "summary": "Leading provider of EDA software for digital design verification.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Advanced RTL Linting & Analysis",
    "Connectivity & Glitch Sign-Off",
    "Multimode DFT Sign-Off"
  ],
  "integrations": []
}
