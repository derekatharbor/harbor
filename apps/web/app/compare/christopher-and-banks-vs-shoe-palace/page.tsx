...
// Comparing: Christopher and Banks vs Shoe Palace

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Christopher and Banks vs Shoe Palace (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Christopher and Banks and Shoe Palace. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Christopher and Banks vs Shoe Palace',
    description: 'Detailed comparison of Christopher and Banks and Shoe Palace.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/christopher-and-banks-vs-shoe-palace#article",
  "headline": "Christopher and Banks vs Shoe Palace: Comparison",
  "description": "Detailed comparison of Christopher and Banks and Shoe Palace. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Christopher and Banks",
      "url": "https://useharbor.io/brands/christopher-and-banks"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Shoe Palace",
      "url": "https://useharbor.io/brands/shoe-palace"
    }
  ]
}

const brand1 = {
  "slug": "christopher-and-banks",
  "brand_name": "Christopher and Banks",
  "domain": "christopherandbanks.com",
  "category": "Retail",
  "summary": "A women's clothing retailer specializing in stylish and comfortable apparel.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Prices for items start from $18.82",
    "has_free_tier": false,
    "starting_price": "$18.82"
  },
  "features": [
    "Wide range of women's clothing",
    "Exclusive patterns",
    "Free shipping on all orders",
    "Discounts on new arrivals",
    "Seasonal styles"
  ],
  "integrations": []
}
...
const brand2 = {
  ...
  "category": "Retail",
  "summary": "A retail brand specializing in sneakers and apparel from elite brands.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
