...
// Comparing: enkompas Technology Solutions vs Frontier Business Products

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'enkompas Technology Solutions vs Frontier Business Products (November 30, 2025) | Harbor',
  description: 'Detailed comparison of enkompas Technology Solutions and Frontier Business Products. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'enkompas Technology Solutions vs Frontier Business Products',
    description: 'Detailed comparison of enkompas Technology Solutions and Frontier Business Products.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/enkompas-technology-solutions-vs-frontier-business-products#article",
  "headline": "enkompas Technology Solutions vs Frontier Business Products: Comparison",
  "description": "Detailed comparison of enkompas Technology Solutions and Frontier Business Products. Features, pricing, and integrations compared side-by-side.",
