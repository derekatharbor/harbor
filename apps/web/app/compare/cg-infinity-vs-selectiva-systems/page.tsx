...
// Comparing: CG Infinity vs Selectiva Systems

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CG Infinity vs Selectiva Systems (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CG Infinity and Selectiva Systems. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CG Infinity vs Selectiva Systems',
    description: 'Detailed comparison of CG Infinity and Selectiva Systems.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cg-infinity-vs-selectiva-systems#article",
  "headline": "CG Infinity vs Selectiva Systems: Comparison",
  "description": "Detailed comparison of CG Infinity and Selectiva Systems. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "CG Infinity",
      "url": "https://useharbor.io/brands/cg-infinity"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Selectiva Systems",
      "url": "https://useharbor.io/brands/selectiva-systems"
    }
  ]
}
...
const brand1 = {
  "slug": "cg-infinity",
  "brand_name": "CG Infinity",
  "domain": "cginfinity.com",
  "category": "Integration Services",
  "summary": "CG Infinity is a technology consulting firm specializing in Salesforce solutions and data analytics.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "selectiva-systems",
  "brand_name": "Selectiva Systems",
  "domain": "selectiva.com",
  "category": "Integration Services",
  "summary": "Selectiva provides innovative digital AI and IT solutions to empower businesses.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Strategic Business Process Integration"
  ],
  "integrations": [
    "Oracle",
    "Boomi",
