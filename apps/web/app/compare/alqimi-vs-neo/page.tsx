...
// Comparing: ALQIMI vs Neo

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALQIMI vs Neo (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALQIMI and Neo. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALQIMI vs Neo',
    description: 'Detailed comparison of ALQIMI and Neo.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/alqimi-vs-neo#article",
  "headline": "ALQIMI vs Neo: Comparison",
  "description": "Detailed comparison of ALQIMI and Neo. Features, pricing, and integrations compared side-by-side.",
