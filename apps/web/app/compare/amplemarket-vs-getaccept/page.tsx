...
// Comparing: Amplemarket vs GetAccept

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Amplemarket vs GetAccept (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Amplemarket and GetAccept. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Amplemarket vs GetAccept',
    description: 'Detailed comparison of Amplemarket and GetAccept.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amplemarket-vs-getaccept#article",
  "headline": "Amplemarket vs GetAccept: Comparison",
  "description": "Detailed comparison of Amplemarket and GetAccept. Features, pricing, and integrations compared side-by-side.",
