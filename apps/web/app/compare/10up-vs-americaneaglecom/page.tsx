...
// Generated: 2025-11-30T19:44:53.494Z
// Comparing: 10up vs Americaneagle.com

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '10up vs Americaneagle.com (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 10up and Americaneagle.com. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '10up vs Americaneagle.com',
    description: 'Detailed comparison of 10up and Americaneagle.com.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.494Z',
    modifiedTime: '2025-11-30T19:44:53.494Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/10up-vs-americaneaglecom#article",
  "headline": "10up vs Americaneagle.com: Comparison",
  "description": "Detailed comparison of 10up and Americaneagle.com. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.494Z",
  "dateModified": "2025-11-30T19:44:53.494Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
  ...
  "about": [
    {
      ...
      "name": "10up",
      "url": "https://useharbor.io/brands/10up"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Americaneagle.com",
      "url": "https://useharbor.io/brands/americaneaglecom"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "10up is a leading WordPress practice that crafts websites and tools for content creators.",
  "pricing": {
    "price_model": "custom",
  ...
  "features": [
    ...
    "Open source framework for headless websites",
    "AI model integration for WordPress"
  ],
  "integrations": [
    "Microsoft Azure",
    "New Relic",
...
const brand2 = {
  "slug": "americaneaglecom",
  "brand_name": "Americaneagle.com",
  "domain": "americaneagle.com",
  "category": "Web Development",
  "summary": "A premier web design, development, and digital marketing agency.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.494Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.494Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
