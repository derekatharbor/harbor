...
// Comparing: Astute Technology Management vs CTSI | Computer Transition Services

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Astute Technology Management vs CTSI | Computer Transition Services (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Astute Technology Management and CTSI | Computer Transition Services. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Astute Technology Management vs CTSI | Computer Transition Services',
    description: 'Detailed comparison of Astute Technology Management and CTSI | Computer Transition Services.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/astute-technology-management-vs-ctsi-computer-transition-services#article",
  "headline": "Astute Technology Management vs CTSI | Computer Transition Services: Comparison",
  "description": "Detailed comparison of Astute Technology Management and CTSI | Computer Transition Services. Features, pricing, and integrations compared side-by-side.",
