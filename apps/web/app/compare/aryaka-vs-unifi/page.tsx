...
// Comparing: Aryaka vs UniFi

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Aryaka vs UniFi (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Aryaka and UniFi. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Aryaka vs UniFi',
    description: 'Detailed comparison of Aryaka and UniFi.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aryaka-vs-unifi#article",
  "headline": "Aryaka vs UniFi: Comparison",
  "description": "Detailed comparison of Aryaka and UniFi. Features, pricing, and integrations compared side-by-side.",
