...
// Comparing: Allwyn Corporation vs VoxCroft Analytics

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Allwyn Corporation vs VoxCroft Analytics (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Allwyn Corporation and VoxCroft Analytics. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Allwyn Corporation vs VoxCroft Analytics',
    description: 'Detailed comparison of Allwyn Corporation and VoxCroft Analytics.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allwyn-corporation-vs-voxcroft-analytics#article",
  "headline": "Allwyn Corporation vs VoxCroft Analytics: Comparison",
  "description": "Detailed comparison of Allwyn Corporation and VoxCroft Analytics. Features, pricing, and integrations compared side-by-side.",
