...
// Comparing: Cprime, Inc vs SenseHawk

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cprime, Inc vs SenseHawk (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cprime, Inc and SenseHawk. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cprime, Inc vs SenseHawk',
    description: 'Detailed comparison of Cprime, Inc and SenseHawk.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cprime-inc-vs-sensehawk#article",
  "headline": "Cprime, Inc vs SenseHawk: Comparison",
  "description": "Detailed comparison of Cprime, Inc and SenseHawk. Features, pricing, and integrations compared side-by-side.",
