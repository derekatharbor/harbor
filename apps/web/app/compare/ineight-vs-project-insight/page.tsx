...
// Comparing: InEight vs Project Insight

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'InEight vs Project Insight (November 30, 2025) | Harbor',
  description: 'Detailed comparison of InEight and Project Insight. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'InEight vs Project Insight',
    description: 'Detailed comparison of InEight and Project Insight.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ineight-vs-project-insight#article",
  "headline": "InEight vs Project Insight: Comparison",
  "description": "Detailed comparison of InEight and Project Insight. Features, pricing, and integrations compared side-by-side.",
