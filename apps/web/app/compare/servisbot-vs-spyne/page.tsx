...
// Comparing: ServisBOT vs Spyne

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ServisBOT vs Spyne (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ServisBOT and Spyne. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ServisBOT vs Spyne',
    description: 'Detailed comparison of ServisBOT and Spyne.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/servisbot-vs-spyne#article",
  "headline": "ServisBOT vs Spyne: Comparison",
  "description": "Detailed comparison of ServisBOT and Spyne. Features, pricing, and integrations compared side-by-side.",
