...
// Generated: 2025-11-30T20:05:20.306Z
// Comparing: Ekata, a Mastercard company vs Fingerprint

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Ekata, a Mastercard company vs Fingerprint (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Ekata, a Mastercard company and Fingerprint. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Ekata, a Mastercard company vs Fingerprint',
    description: 'Detailed comparison of Ekata, a Mastercard company and Fingerprint.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.306Z',
    modifiedTime: '2025-11-30T20:05:20.306Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ekata-a-mastercard-company-vs-fingerprint#article",
  "headline": "Ekata, a Mastercard company vs Fingerprint: Comparison",
  "description": "Detailed comparison of Ekata, a Mastercard company and Fingerprint. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.306Z",
  "dateModified": "2025-11-30T20:05:20.306Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.306Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.306Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
