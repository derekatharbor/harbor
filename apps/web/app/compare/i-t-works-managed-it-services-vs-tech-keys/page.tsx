...
// Comparing: I.T.WORKS! Managed IT Services vs Tech-Keys

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'I.T.WORKS! Managed IT Services vs Tech-Keys (November 30, 2025) | Harbor',
  description: 'Detailed comparison of I.T.WORKS! Managed IT Services and Tech-Keys. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'I.T.WORKS! Managed IT Services vs Tech-Keys',
    description: 'Detailed comparison of I.T.WORKS! Managed IT Services and Tech-Keys.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/i-t-works-managed-it-services-vs-tech-keys#article",
  "headline": "I.T.WORKS! Managed IT Services vs Tech-Keys: Comparison",
  "description": "Detailed comparison of I.T.WORKS! Managed IT Services and Tech-Keys. Features, pricing, and integrations compared side-by-side.",
