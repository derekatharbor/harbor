...
// Comparing: ASSYST vs ClearObject

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ASSYST vs ClearObject (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ASSYST and ClearObject. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ASSYST vs ClearObject',
    description: 'Detailed comparison of ASSYST and ClearObject.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/assyst-vs-clearobject#article",
  "headline": "ASSYST vs ClearObject: Comparison",
  "description": "Detailed comparison of ASSYST and ClearObject. Features, pricing, and integrations compared side-by-side.",
