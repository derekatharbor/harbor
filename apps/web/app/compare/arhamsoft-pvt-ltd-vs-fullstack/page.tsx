...
// Comparing: ArhamSoft (Pvt) Ltd vs FullStack

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ArhamSoft (Pvt) Ltd vs FullStack (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ArhamSoft (Pvt) Ltd and FullStack. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ArhamSoft (Pvt) Ltd vs FullStack',
    description: 'Detailed comparison of ArhamSoft (Pvt) Ltd and FullStack.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/arhamsoft-pvt-ltd-vs-fullstack#article",
  "headline": "ArhamSoft (Pvt) Ltd vs FullStack: Comparison",
  "description": "Detailed comparison of ArhamSoft (Pvt) Ltd and FullStack. Features, pricing, and integrations compared side-by-side.",
