...
// Comparing: Modal vs Outdefine

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Modal vs Outdefine (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Modal and Outdefine. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Modal vs Outdefine',
    description: 'Detailed comparison of Modal and Outdefine.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/modal-vs-outdefine#article",
  "headline": "Modal vs Outdefine: Comparison",
  "description": "Detailed comparison of Modal and Outdefine. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Modal",
      "url": "https://useharbor.io/brands/modal"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Outdefine",
...
const brand1 = {
  ...
  "summary": "High-performance AI infrastructure for developers.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "Pay for compute time by the CPU cycle; $30/month free credits for the Starter plan.",
    "has_free_tier": true,
    "starting_price": "$0/mo"
  },
  "features": [
