...
// Comparing: NextgenID vs ZITADEL

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NextgenID vs ZITADEL (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NextgenID and ZITADEL. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NextgenID vs ZITADEL',
    description: 'Detailed comparison of NextgenID and ZITADEL.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/nextgenid-vs-zitadel#article",
  "headline": "NextgenID vs ZITADEL: Comparison",
  "description": "Detailed comparison of NextgenID and ZITADEL. Features, pricing, and integrations compared side-by-side.",
