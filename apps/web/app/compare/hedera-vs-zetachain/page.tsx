...
// Comparing: Hedera vs ZetaChain

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Hedera vs ZetaChain (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Hedera and ZetaChain. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Hedera vs ZetaChain',
    description: 'Detailed comparison of Hedera and ZetaChain.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/hedera-vs-zetachain#article",
  "headline": "Hedera vs ZetaChain: Comparison",
  "description": "Detailed comparison of Hedera and ZetaChain. Features, pricing, and integrations compared side-by-side.",
