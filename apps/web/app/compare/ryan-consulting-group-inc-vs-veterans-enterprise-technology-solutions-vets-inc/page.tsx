...
// Comparing: Ryan Consulting Group, Inc. vs Veterans Enterprise Technology Solutions (VETS) Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Ryan Consulting Group, Inc. vs Veterans Enterprise Technology Solutions (VETS) Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Ryan Consulting Group, Inc. and Veterans Enterprise Technology Solutions (VETS) Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Ryan Consulting Group, Inc. vs Veterans Enterprise Technology Solutions (VETS) Inc.',
    description: 'Detailed comparison of Ryan Consulting Group, Inc. and Veterans Enterprise Technology Solutions (VETS) Inc..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ryan-consulting-group-inc-vs-veterans-enterprise-technology-solutions-vets-inc#article",
  "headline": "Ryan Consulting Group, Inc. vs Veterans Enterprise Technology Solutions (VETS) Inc.: Comparison",
  "description": "Detailed comparison of Ryan Consulting Group, Inc. and Veterans Enterprise Technology Solutions (VETS) Inc.. Features, pricing, and integrations compared side-by-side.",
