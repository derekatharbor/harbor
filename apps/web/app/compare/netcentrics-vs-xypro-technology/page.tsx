...
// Generated: 2025-11-30T20:05:20.147Z
// Comparing: NetCentrics vs XYPRO Technology

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NetCentrics vs XYPRO Technology (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NetCentrics and XYPRO Technology. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NetCentrics vs XYPRO Technology',
    description: 'Detailed comparison of NetCentrics and XYPRO Technology.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.147Z',
    modifiedTime: '2025-11-30T20:05:20.147Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/netcentrics-vs-xypro-technology#article",
  "headline": "NetCentrics vs XYPRO Technology: Comparison",
  "description": "Detailed comparison of NetCentrics and XYPRO Technology. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.147Z",
  "dateModified": "2025-11-30T20:05:20.147Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.147Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.147Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
