...
// Comparing: Conexus SG vs Softengine

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Conexus SG vs Softengine (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Conexus SG and Softengine. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Conexus SG vs Softengine',
    description: 'Detailed comparison of Conexus SG and Softengine.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/conexus-sg-vs-softengine#article",
  "headline": "Conexus SG vs Softengine: Comparison",
  "description": "Detailed comparison of Conexus SG and Softengine. Features, pricing, and integrations compared side-by-side.",
