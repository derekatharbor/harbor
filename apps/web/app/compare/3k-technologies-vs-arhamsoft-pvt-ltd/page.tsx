...
// Generated: 2025-11-30T20:05:20.186Z
// Comparing: 3K Technologies vs ArhamSoft (Pvt) Ltd

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '3K Technologies vs ArhamSoft (Pvt) Ltd (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 3K Technologies and ArhamSoft (Pvt) Ltd. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '3K Technologies vs ArhamSoft (Pvt) Ltd',
    description: 'Detailed comparison of 3K Technologies and ArhamSoft (Pvt) Ltd.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.186Z',
    modifiedTime: '2025-11-30T20:05:20.186Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/3k-technologies-vs-arhamsoft-pvt-ltd#article",
  "headline": "3K Technologies vs ArhamSoft (Pvt) Ltd: Comparison",
  "description": "Detailed comparison of 3K Technologies and ArhamSoft (Pvt) Ltd. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.186Z",
  "dateModified": "2025-11-30T20:05:20.186Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.186Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.186Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
