...
// Comparing: Loxo vs XOR

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Loxo vs XOR (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Loxo and XOR. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Loxo vs XOR',
    description: 'Detailed comparison of Loxo and XOR.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/loxo-vs-xor#article",
  "headline": "Loxo vs XOR: Comparison",
  "description": "Detailed comparison of Loxo and XOR. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "XOR",
      "url": "https://useharbor.io/brands/xor"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "xor.ai",
  "category": "Recruitment",
  "summary": "XOR is an AI-driven recruiting platform that simplifies the hiring process.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Cost for hiring blue-collar workers",
    "has_free_tier": false,
    "starting_price": "$500 per hire"
  },
  "features": [
