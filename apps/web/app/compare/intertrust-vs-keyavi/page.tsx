...
// Generated: 2025-11-30T19:36:57.542Z
// Comparing: Intertrust vs Keyavi

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Intertrust vs Keyavi (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Intertrust and Keyavi. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Intertrust vs Keyavi',
    description: 'Detailed comparison of Intertrust and Keyavi.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.542Z',
    modifiedTime: '2025-11-30T19:36:57.542Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/intertrust-vs-keyavi#article",
  "headline": "Intertrust vs Keyavi: Comparison",
  "description": "Detailed comparison of Intertrust and Keyavi. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.542Z",
  "dateModified": "2025-11-30T19:36:57.542Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand2 = {
  ...
  "features": [
    ...
    "Real-time policy updates and access revocation",
    "Geofence data access",
    "Time-limited access for files",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.542Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.542Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
