...
// Generated: 2025-11-30T20:05:20.205Z
// Comparing: TechFlow, Inc. vs Trinetix

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'TechFlow, Inc. vs Trinetix (November 30, 2025) | Harbor',
  description: 'Detailed comparison of TechFlow, Inc. and Trinetix. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'TechFlow, Inc. vs Trinetix',
    description: 'Detailed comparison of TechFlow, Inc. and Trinetix.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.205Z',
    modifiedTime: '2025-11-30T20:05:20.205Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/techflow-inc-vs-trinetix#article",
  "headline": "TechFlow, Inc. vs Trinetix: Comparison",
  "description": "Detailed comparison of TechFlow, Inc. and Trinetix. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.205Z",
  "dateModified": "2025-11-30T20:05:20.205Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.205Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.205Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
