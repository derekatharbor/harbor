...
// Comparing: Datawiz Corporation (a GTSC Company) vs Info Services

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Datawiz Corporation (a GTSC Company) vs Info Services (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Datawiz Corporation (a GTSC Company) and Info Services. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Datawiz Corporation (a GTSC Company) vs Info Services',
    description: 'Detailed comparison of Datawiz Corporation (a GTSC Company) and Info Services.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/datawiz-corporation-a-gtsc-company-vs-info-services#article",
  "headline": "Datawiz Corporation (a GTSC Company) vs Info Services: Comparison",
  "description": "Detailed comparison of Datawiz Corporation (a GTSC Company) and Info Services. Features, pricing, and integrations compared side-by-side.",
