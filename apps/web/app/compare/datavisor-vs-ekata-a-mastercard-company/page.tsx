...
// Comparing: DataVisor vs Ekata, a Mastercard company

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DataVisor vs Ekata, a Mastercard company (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DataVisor and Ekata, a Mastercard company. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DataVisor vs Ekata, a Mastercard company',
    description: 'Detailed comparison of DataVisor and Ekata, a Mastercard company.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/datavisor-vs-ekata-a-mastercard-company#article",
  "headline": "DataVisor vs Ekata, a Mastercard company: Comparison",
  "description": "Detailed comparison of DataVisor and Ekata, a Mastercard company. Features, pricing, and integrations compared side-by-side.",
...
const brand1 = {
  ...
  "features": [
    ...
    "FinCrime and AML Compliance",
    "Promotions and Policy Abuse Management",
    "Real-Time Fraud Detection",
    "Adaptive AI for Fraud Prevention"
  ],
  "integrations": [
    "Salesforce",
    "Twilio",
