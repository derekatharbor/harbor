...
// Comparing: Cerberus by Redwood vs Globalscape

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cerberus by Redwood vs Globalscape (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cerberus by Redwood and Globalscape. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cerberus by Redwood vs Globalscape',
    description: 'Detailed comparison of Cerberus by Redwood and Globalscape.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cerberus-by-redwood-vs-globalscape#article",
  "headline": "Cerberus by Redwood vs Globalscape: Comparison",
  "description": "Detailed comparison of Cerberus by Redwood and Globalscape. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Cerberus by Redwood",
      "url": "https://useharbor.io/brands/cerberus-by-redwood"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Globalscape",
      "url": "https://useharbor.io/brands/globalscape"
    }
  ]
}

const brand1 = {
  "slug": "cerberus-by-redwood",
  "brand_name": "Cerberus by Redwood",
  "domain": "cerberusftp.com",
  "category": "File Transfer",
  "summary": "A secure and compliant FTP server solution for enterprise file transfers.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Discount available for 3-year subscription",
    "has_free_tier": true,
    "starting_price": "$1,599/year"
  },
  "features": [
    "FTP, SFTP, & FTP/S support",
...
const brand2 = {
  "slug": "globalscape",
  "brand_name": "Globalscape",
  "domain": "globalscape.com",
  "category": "File Transfer",
  "summary": "Globalscape provides secure managed file transfer solutions for organizations.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
