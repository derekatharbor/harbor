...
// Comparing: Conveyor vs EliseAI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Conveyor vs EliseAI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Conveyor and EliseAI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Conveyor vs EliseAI',
    description: 'Detailed comparison of Conveyor and EliseAI.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/conveyor-vs-eliseai#article",
  "headline": "Conveyor vs EliseAI: Comparison",
  "description": "Detailed comparison of Conveyor and EliseAI. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Conveyor",
      "url": "https://useharbor.io/brands/conveyor"
    },
    {
      "@type": "SoftwareApplication",
      "name": "EliseAI",
      "url": "https://useharbor.io/brands/eliseai"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "AI-powered automation for customer trust workflows.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    "AI Agents for Customer Security Reviews",
    "Automated Trust Center Management",
...
const brand2 = {
  ...
  "domain": "eliseai.com",
  "category": "AI Automation",
  "summary": "EliseAI provides industry-leading AI solutions for housing and healthcare to automate and scale operations.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "VoiceAI for inbound and outbound calls",
    "Instant SMS communication",
    "Email management for timely follow-ups",
    "Real-time customer engagement through chat"
  ],
  "integrations": [
    "Bluemoon",
    "Brivo",
