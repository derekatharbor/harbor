...
// Comparing: Cockroach Labs vs TiDB, powered by PingCAP

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cockroach Labs vs TiDB, powered by PingCAP (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cockroach Labs and TiDB, powered by PingCAP. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cockroach Labs vs TiDB, powered by PingCAP',
    description: 'Detailed comparison of Cockroach Labs and TiDB, powered by PingCAP.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cockroach-labs-vs-tidb-powered-by-pingcap#article",
  "headline": "Cockroach Labs vs TiDB, powered by PingCAP: Comparison",
  "description": "Detailed comparison of Cockroach Labs and TiDB, powered by PingCAP. Features, pricing, and integrations compared side-by-side.",
