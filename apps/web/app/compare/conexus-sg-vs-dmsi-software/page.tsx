...
// Comparing: Conexus SG vs DMSi Software

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Conexus SG vs DMSi Software (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Conexus SG and DMSi Software. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Conexus SG vs DMSi Software',
    description: 'Detailed comparison of Conexus SG and DMSi Software.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/conexus-sg-vs-dmsi-software#article",
  "headline": "Conexus SG vs DMSi Software: Comparison",
  "description": "Detailed comparison of Conexus SG and DMSi Software. Features, pricing, and integrations compared side-by-side.",
