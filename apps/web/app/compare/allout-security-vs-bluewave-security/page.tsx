...
// Generated: 2025-11-30T19:36:57.505Z
// Comparing: ALLOut Security vs BlueWave Security

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ALLOut Security vs BlueWave Security (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ALLOut Security and BlueWave Security. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ALLOut Security vs BlueWave Security',
    description: 'Detailed comparison of ALLOut Security and BlueWave Security.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.505Z',
    modifiedTime: '2025-11-30T19:36:57.505Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/allout-security-vs-bluewave-security#article",
  "headline": "ALLOut Security vs BlueWave Security: Comparison",
  "description": "Detailed comparison of ALLOut Security and BlueWave Security. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.505Z",
  "dateModified": "2025-11-30T19:36:57.505Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.505Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.505Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
