...
// Generated: 2025-11-30T19:36:57.547Z
// Comparing: Borneo (Acquired by Atlassian) vs Virtru

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Borneo (Acquired by Atlassian) vs Virtru (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Borneo (Acquired by Atlassian) and Virtru. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Borneo (Acquired by Atlassian) vs Virtru',
    description: 'Detailed comparison of Borneo (Acquired by Atlassian) and Virtru.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.547Z',
    modifiedTime: '2025-11-30T19:36:57.547Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/borneo-acquired-by-atlassian-vs-virtru#article",
  "headline": "Borneo (Acquired by Atlassian) vs Virtru: Comparison",
  "description": "Detailed comparison of Borneo (Acquired by Atlassian) and Virtru. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.547Z",
  "dateModified": "2025-11-30T19:36:57.547Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.547Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.547Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
