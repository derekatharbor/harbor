...
// Comparing: Check Point vs NXT GEN Technologies

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Check Point vs NXT GEN Technologies (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Check Point and NXT GEN Technologies. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Check Point vs NXT GEN Technologies',
    description: 'Detailed comparison of Check Point and NXT GEN Technologies.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/checkpoint-vs-nxt-gen-technologies#article",
  "headline": "Check Point vs NXT GEN Technologies: Comparison",
  "description": "Detailed comparison of Check Point and NXT GEN Technologies. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Check Point",
      "url": "https://useharbor.io/brands/checkpoint"
    },
    {
      "@type": "SoftwareApplication",
      "name": "NXT GEN Technologies",
      "url": "https://useharbor.io/brands/nxt-gen-technologies"
    }
  ]
}
...
const brand1 = {
  "slug": "checkpoint",
  "brand_name": "Check Point",
  "domain": "checkpoint.com",
  "category": "Cyber Security",
  "summary": "Leader in Cyber Security Solutions.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  "slug": "nxt-gen-technologies",
  "brand_name": "NXT GEN Technologies",
  "domain": "nxtgentech.com",
  "category": "Cyber Security",
  "summary": "Your Trusted Business Technology Solutions Partner.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
