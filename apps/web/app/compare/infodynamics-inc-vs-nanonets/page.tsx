...
// Comparing: INFODYNAMICS Inc. vs Nanonets

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'INFODYNAMICS Inc. vs Nanonets (November 30, 2025) | Harbor',
  description: 'Detailed comparison of INFODYNAMICS Inc. and Nanonets. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'INFODYNAMICS Inc. vs Nanonets',
    description: 'Detailed comparison of INFODYNAMICS Inc. and Nanonets.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/infodynamics-inc-vs-nanonets#article",
  "headline": "INFODYNAMICS Inc. vs Nanonets: Comparison",
  "description": "Detailed comparison of INFODYNAMICS Inc. and Nanonets. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "INFODYNAMICS Inc.",
      "url": "https://useharbor.io/brands/infodynamics-inc"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Nanonets",
      "url": "https://useharbor.io/brands/nanonets"
    }
  ]
}

const brand1 = {
  "slug": "infodynamics-inc",
  "brand_name": "INFODYNAMICS Inc.",
  "domain": "infodynamics.com",
  "category": "Document Automation",
  "summary": "A pioneer in document automation solutions for businesses.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "nanonets.com",
  "category": "Document Automation",
  "summary": "AI-driven platform for automating document processing and data extraction.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "Pay-as-you-go pricing based on block runs with $200 in credits when signing up.",
    "has_free_tier": true,
    "starting_price": null
  },
  "features": [
    ...
    "Custom workflows using blocks",
    "Data enrichment",
    "Real-time 2-way sync with ERP and CRM solutions",
    "Role-based access",
