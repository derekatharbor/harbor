...
// Comparing: Redeam: Technology Connecting Experiences vs Spotnana

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Redeam: Technology Connecting Experiences vs Spotnana (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Redeam: Technology Connecting Experiences and Spotnana. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Redeam: Technology Connecting Experiences vs Spotnana',
    description: 'Detailed comparison of Redeam: Technology Connecting Experiences and Spotnana.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/redeam-technology-connecting-experiences-vs-spotnana#article",
  "headline": "Redeam: Technology Connecting Experiences vs Spotnana: Comparison",
  "description": "Detailed comparison of Redeam: Technology Connecting Experiences and Spotnana. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    ...
    },
    {
      "@type": "SoftwareApplication",
      "name": "Spotnana",
      "url": "https://useharbor.io/brands/spotnana"
    }
  ]
}
...
const brand2 = {
  ...
  "domain": "spotnana.com",
  "category": "Travel Technology",
  "summary": "Spotnana is a Travel-as-a-Service platform that modernizes the travel industry.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Configurable travel management tools",
