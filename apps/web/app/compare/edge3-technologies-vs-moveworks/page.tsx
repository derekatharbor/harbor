...
// Generated: 2025-11-30T20:05:20.246Z
// Comparing: EDGE3 Technologies vs Moveworks

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'EDGE3 Technologies vs Moveworks (November 30, 2025) | Harbor',
  description: 'Detailed comparison of EDGE3 Technologies and Moveworks. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'EDGE3 Technologies vs Moveworks',
    description: 'Detailed comparison of EDGE3 Technologies and Moveworks.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.246Z',
    modifiedTime: '2025-11-30T20:05:20.246Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/edge3-technologies-vs-moveworks#article",
  "headline": "EDGE3 Technologies vs Moveworks: Comparison",
  "description": "Detailed comparison of EDGE3 Technologies and Moveworks. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.246Z",
  "dateModified": "2025-11-30T20:05:20.246Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.246Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.246Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
