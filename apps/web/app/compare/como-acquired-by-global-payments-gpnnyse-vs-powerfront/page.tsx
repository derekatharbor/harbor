...
// Comparing: Como® (acquired by Global Payments GPN:NYSE) vs Powerfront

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Como® (acquired by Global Payments GPN:NYSE) vs Powerfront (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Como® (acquired by Global Payments GPN:NYSE) and Powerfront. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Como® (acquired by Global Payments GPN:NYSE) vs Powerfront',
    description: 'Detailed comparison of Como® (acquired by Global Payments GPN:NYSE) and Powerfront.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/como-acquired-by-global-payments-gpnnyse-vs-powerfront#article",
  "headline": "Como® (acquired by Global Payments GPN:NYSE) vs Powerfront: Comparison",
  "description": "Detailed comparison of Como® (acquired by Global Payments GPN:NYSE) and Powerfront. Features, pricing, and integrations compared side-by-side.",
