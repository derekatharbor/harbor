...
// Comparing: CHESS Health vs DynamiCare Health

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CHESS Health vs DynamiCare Health (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CHESS Health and DynamiCare Health. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CHESS Health vs DynamiCare Health',
    description: 'Detailed comparison of CHESS Health and DynamiCare Health.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/chess-health-vs-dynamicare-health#article",
  "headline": "CHESS Health vs DynamiCare Health: Comparison",
  "description": "Detailed comparison of CHESS Health and DynamiCare Health. Features, pricing, and integrations compared side-by-side.",
