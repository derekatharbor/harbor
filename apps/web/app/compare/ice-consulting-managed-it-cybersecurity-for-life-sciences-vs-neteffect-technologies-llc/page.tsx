...
// Comparing: ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs neteffect technologies LLC

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs neteffect technologies LLC (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and neteffect technologies LLC. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs neteffect technologies LLC',
    description: 'Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and neteffect technologies LLC.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/ice-consulting-managed-it-cybersecurity-for-life-sciences-vs-neteffect-technologies-llc#article",
  "headline": "ICE Consulting - Managed IT & Cybersecurity for Life Sciences vs neteffect technologies LLC: Comparison",
  "description": "Detailed comparison of ICE Consulting - Managed IT & Cybersecurity for Life Sciences and neteffect technologies LLC. Features, pricing, and integrations compared side-by-side.",
