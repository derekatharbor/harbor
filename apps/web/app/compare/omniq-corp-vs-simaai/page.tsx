...
// Comparing: OMNIQ Corp. vs SiMa.ai

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'OMNIQ Corp. vs SiMa.ai (November 30, 2025) | Harbor',
  description: 'Detailed comparison of OMNIQ Corp. and SiMa.ai. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'OMNIQ Corp. vs SiMa.ai',
    description: 'Detailed comparison of OMNIQ Corp. and SiMa.ai.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/omniq-corp-vs-simaai#article",
  "headline": "OMNIQ Corp. vs SiMa.ai: Comparison",
  "description": "Detailed comparison of OMNIQ Corp. and SiMa.ai. Features, pricing, and integrations compared side-by-side.",
