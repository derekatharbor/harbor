...
// Comparing: Datawiz Corporation (a GTSC Company) vs Verinext

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Datawiz Corporation (a GTSC Company) vs Verinext (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Datawiz Corporation (a GTSC Company) and Verinext. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Datawiz Corporation (a GTSC Company) vs Verinext',
    description: 'Detailed comparison of Datawiz Corporation (a GTSC Company) and Verinext.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/datawiz-corporation-a-gtsc-company-vs-verinext#article",
  "headline": "Datawiz Corporation (a GTSC Company) vs Verinext: Comparison",
  "description": "Detailed comparison of Datawiz Corporation (a GTSC Company) and Verinext. Features, pricing, and integrations compared side-by-side.",
