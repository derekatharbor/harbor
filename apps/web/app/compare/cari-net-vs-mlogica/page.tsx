...
// Comparing: CARI.net vs mLogica

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'CARI.net vs mLogica (November 30, 2025) | Harbor',
  description: 'Detailed comparison of CARI.net and mLogica. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'CARI.net vs mLogica',
    description: 'Detailed comparison of CARI.net and mLogica.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cari-net-vs-mlogica#article",
  "headline": "CARI.net vs mLogica: Comparison",
  "description": "Detailed comparison of CARI.net and mLogica. Features, pricing, and integrations compared side-by-side.",
