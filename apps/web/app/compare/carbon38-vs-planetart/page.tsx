...
// Comparing: Carbon38 vs PlanetArt

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Carbon38 vs PlanetArt (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Carbon38 and PlanetArt. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Carbon38 vs PlanetArt',
    description: 'Detailed comparison of Carbon38 and PlanetArt.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/carbon38-vs-planetart#article",
  "headline": "Carbon38 vs PlanetArt: Comparison",
  "description": "Detailed comparison of Carbon38 and PlanetArt. Features, pricing, and integrations compared side-by-side.",
