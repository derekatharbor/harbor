...
// Generated: 2025-11-30T19:44:53.960Z
// Comparing: Borneo (Acquired by Atlassian) vs Secuvy

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Borneo (Acquired by Atlassian) vs Secuvy (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Borneo (Acquired by Atlassian) and Secuvy. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Borneo (Acquired by Atlassian) vs Secuvy',
    description: 'Detailed comparison of Borneo (Acquired by Atlassian) and Secuvy.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.960Z',
    modifiedTime: '2025-11-30T19:44:53.960Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/borneo-acquired-by-atlassian-vs-secuvy#article",
  "headline": "Borneo (Acquired by Atlassian) vs Secuvy: Comparison",
  "description": "Detailed comparison of Borneo (Acquired by Atlassian) and Secuvy. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.960Z",
  "dateModified": "2025-11-30T19:44:53.960Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.960Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.960Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
