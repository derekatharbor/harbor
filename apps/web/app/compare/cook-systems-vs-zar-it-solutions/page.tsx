...
// Comparing: Cook Systems vs ZAR IT Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cook Systems vs ZAR IT Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cook Systems and ZAR IT Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cook Systems vs ZAR IT Solutions',
    description: 'Detailed comparison of Cook Systems and ZAR IT Solutions.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cook-systems-vs-zar-it-solutions#article",
  "headline": "Cook Systems vs ZAR IT Solutions: Comparison",
  "description": "Detailed comparison of Cook Systems and ZAR IT Solutions. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Cook Systems",
      "url": "https://useharbor.io/brands/cook-systems"
    },
    {
      "@type": "SoftwareApplication",
      "name": "ZAR IT Solutions",
      "url": "https://useharbor.io/brands/zar-it-solutions"
    }
  ]
}
...
const brand1 = {
  "slug": "cook-systems",
  "brand_name": "Cook Systems",
  "domain": "cooksys.com",
  "category": "IT Staffing and Consulting",
  "summary": "Veteran-owned IT solutions and staffing company with over 30 years of experience.",
  "pricing": {
    "price_model": "custom",
...
const brand2 = {
  "slug": "zar-it-solutions",
  "brand_name": "ZAR IT Solutions",
  "domain": "zarit.com",
  "category": "IT Staffing and Consulting",
  "summary": "A 100% women-owned staffing and talent solutions company.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Consulting services",
    "Expertise in IT strategy",
    "Development and transformation solutions",
    "Connecting professionals with companies"
  ],
  "integrations": []
}
