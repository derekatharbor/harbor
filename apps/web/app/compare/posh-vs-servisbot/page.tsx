...
// Comparing: Posh vs ServisBOT

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Posh vs ServisBOT (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Posh and ServisBOT. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Posh vs ServisBOT',
    description: 'Detailed comparison of Posh and ServisBOT.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/posh-vs-servisbot#article",
  "headline": "Posh vs ServisBOT: Comparison",
  "description": "Detailed comparison of Posh and ServisBOT. Features, pricing, and integrations compared side-by-side.",
