...
// Comparing: I.T.WORKS! Managed IT Services vs TAG Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'I.T.WORKS! Managed IT Services vs TAG Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of I.T.WORKS! Managed IT Services and TAG Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'I.T.WORKS! Managed IT Services vs TAG Solutions',
    description: 'Detailed comparison of I.T.WORKS! Managed IT Services and TAG Solutions.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/i-t-works-managed-it-services-vs-tag-solutions#article",
  "headline": "I.T.WORKS! Managed IT Services vs TAG Solutions: Comparison",
  "description": "Detailed comparison of I.T.WORKS! Managed IT Services and TAG Solutions. Features, pricing, and integrations compared side-by-side.",
