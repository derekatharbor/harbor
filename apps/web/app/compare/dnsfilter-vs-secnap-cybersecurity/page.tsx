...
// Generated: 2025-11-30T19:36:57.403Z
// Comparing: DNSFilter vs Secnap Cybersecurity

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'DNSFilter vs Secnap Cybersecurity (November 30, 2025) | Harbor',
  description: 'Detailed comparison of DNSFilter and Secnap Cybersecurity. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'DNSFilter vs Secnap Cybersecurity',
    description: 'Detailed comparison of DNSFilter and Secnap Cybersecurity.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.403Z',
    modifiedTime: '2025-11-30T19:36:57.403Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/dnsfilter-vs-secnap-cybersecurity#article",
  "headline": "DNSFilter vs Secnap Cybersecurity: Comparison",
  "description": "Detailed comparison of DNSFilter and Secnap Cybersecurity. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.403Z",
  "dateModified": "2025-11-30T19:36:57.403Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.403Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.403Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
