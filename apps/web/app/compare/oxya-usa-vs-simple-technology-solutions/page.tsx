...
// Generated: 2025-11-30T19:44:53.944Z
// Comparing: oXya - USA vs Simple Technology Solutions

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'oXya - USA vs Simple Technology Solutions (November 30, 2025) | Harbor',
  description: 'Detailed comparison of oXya - USA and Simple Technology Solutions. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'oXya - USA vs Simple Technology Solutions',
    description: 'Detailed comparison of oXya - USA and Simple Technology Solutions.',
    type: 'article',
    publishedTime: '2025-11-30T19:44:53.944Z',
    modifiedTime: '2025-11-30T19:44:53.944Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/oxya-usa-vs-simple-technology-solutions#article",
  "headline": "oXya - USA vs Simple Technology Solutions: Comparison",
  "description": "Detailed comparison of oXya - USA and Simple Technology Solutions. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:44:53.944Z",
  "dateModified": "2025-11-30T19:44:53.944Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:44:53.944Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:44:53.944Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
