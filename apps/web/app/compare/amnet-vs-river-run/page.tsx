...
// Comparing: Amnet vs River Run

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Amnet vs River Run (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Amnet and River Run. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Amnet vs River Run',
    description: 'Detailed comparison of Amnet and River Run.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/amnet-vs-river-run#article",
  "headline": "Amnet vs River Run: Comparison",
  "description": "Detailed comparison of Amnet and River Run. Features, pricing, and integrations compared side-by-side.",
