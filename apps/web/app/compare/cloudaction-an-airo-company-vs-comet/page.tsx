...
// Comparing: Cloudaction (An AiRo Company) vs Comet

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cloudaction (An AiRo Company) vs Comet (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cloudaction (An AiRo Company) and Comet. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cloudaction (An AiRo Company) vs Comet',
    description: 'Detailed comparison of Cloudaction (An AiRo Company) and Comet.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cloudaction-an-airo-company-vs-comet#article",
  "headline": "Cloudaction (An AiRo Company) vs Comet: Comparison",
  "description": "Detailed comparison of Cloudaction (An AiRo Company) and Comet. Features, pricing, and integrations compared side-by-side.",
