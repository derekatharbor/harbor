...
// Comparing: ClearObject vs Datawiz Corporation (a GTSC Company)

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'ClearObject vs Datawiz Corporation (a GTSC Company) (November 30, 2025) | Harbor',
  description: 'Detailed comparison of ClearObject and Datawiz Corporation (a GTSC Company). Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'ClearObject vs Datawiz Corporation (a GTSC Company)',
    description: 'Detailed comparison of ClearObject and Datawiz Corporation (a GTSC Company).',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/clearobject-vs-datawiz-corporation-a-gtsc-company#article",
  "headline": "ClearObject vs Datawiz Corporation (a GTSC Company): Comparison",
  "description": "Detailed comparison of ClearObject and Datawiz Corporation (a GTSC Company). Features, pricing, and integrations compared side-by-side.",
