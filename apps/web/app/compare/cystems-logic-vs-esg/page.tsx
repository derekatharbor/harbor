...
// Comparing: Cystems Logic vs ESG

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Cystems Logic vs ESG (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Cystems Logic and ESG. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Cystems Logic vs ESG',
    description: 'Detailed comparison of Cystems Logic and ESG.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/cystems-logic-vs-esg#article",
  "headline": "Cystems Logic vs ESG: Comparison",
  "description": "Detailed comparison of Cystems Logic and ESG. Features, pricing, and integrations compared side-by-side.",
