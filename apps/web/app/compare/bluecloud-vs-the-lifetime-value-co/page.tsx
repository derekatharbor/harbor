...
// Comparing: BlueCloud vs The Lifetime Value Co.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'BlueCloud vs The Lifetime Value Co. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of BlueCloud and The Lifetime Value Co.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'BlueCloud vs The Lifetime Value Co.',
    description: 'Detailed comparison of BlueCloud and The Lifetime Value Co..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bluecloud-vs-the-lifetime-value-co#article",
  "headline": "BlueCloud vs The Lifetime Value Co.: Comparison",
  "description": "Detailed comparison of BlueCloud and The Lifetime Value Co.. Features, pricing, and integrations compared side-by-side.",
...
const brand2 = {
  ...
  "features": [
    ...
    "Professional home value data",
    "Tools for managing wealth and unclaimed money",
