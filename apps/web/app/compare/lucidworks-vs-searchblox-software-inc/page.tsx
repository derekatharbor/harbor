...
// Comparing: Lucidworks vs SearchBlox Software, Inc.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Lucidworks vs SearchBlox Software, Inc. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Lucidworks and SearchBlox Software, Inc.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Lucidworks vs SearchBlox Software, Inc.',
    description: 'Detailed comparison of Lucidworks and SearchBlox Software, Inc..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/lucidworks-vs-searchblox-software-inc#article",
  "headline": "Lucidworks vs SearchBlox Software, Inc.: Comparison",
  "description": "Detailed comparison of Lucidworks and SearchBlox Software, Inc.. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "Lucidworks",
      "url": "https://useharbor.io/brands/lucidworks"
    },
    {
      "@type": "SoftwareApplication",
      "name": "SearchBlox Software, Inc.",
      "url": "https://useharbor.io/brands/searchblox-software-inc"
    }
  ]
}
...
const brand1 = {
  "slug": "lucidworks",
  "brand_name": "Lucidworks",
  "domain": "lucidworks.com",
  "category": "Enterprise Search",
  "summary": "AI-Powered Enterprise Search Insights Platform.",
  "pricing": {
    "price_model": "custom",
    "price_notes": "Pricing details are not explicitly stated; likely varies based on deployment and customization.",
    "has_free_tier": false,
    "starting_price": null
  },
  "features": [
...
const brand2 = {
  "slug": "searchblox-software-inc",
  "brand_name": "SearchBlox Software, Inc.",
  "domain": "searchblox.com",
  "category": "Enterprise Search",
  "summary": "SearchBlox provides AI-driven enterprise search solutions.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Various pricing tiers available based on server and service type.",
    "has_free_tier": false,
    "starting_price": "$24,000/year"
  },
  "features": [
    "329+ Built-in Connectors and Crawlers with Schedulers",
    "Process Structured and Unstructured Data / Documents Automatically",
    "Keyword / Lexical Search, Vector Search and SearchAI Hybrid Search",
    "Administrative Console with User Management and Security",
    "SearchAI ChatBot",
    "Integrated RAG as a Service",
    "API Access for direct integration of data ingestion, search and analytics",
    "Realtime Analytics and Insights on User Behaviors",
