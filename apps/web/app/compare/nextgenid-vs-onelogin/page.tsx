...
// Comparing: NextgenID vs OneLogin

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'NextgenID vs OneLogin (November 30, 2025) | Harbor',
  description: 'Detailed comparison of NextgenID and OneLogin. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'NextgenID vs OneLogin',
    description: 'Detailed comparison of NextgenID and OneLogin.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/nextgenid-vs-onelogin#article",
  "headline": "NextgenID vs OneLogin: Comparison",
  "description": "Detailed comparison of NextgenID and OneLogin. Features, pricing, and integrations compared side-by-side.",
