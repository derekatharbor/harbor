...
// Comparing: Bridgepointe Technologies vs Cystems Logic

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Bridgepointe Technologies vs Cystems Logic (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Bridgepointe Technologies and Cystems Logic. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Bridgepointe Technologies vs Cystems Logic',
    description: 'Detailed comparison of Bridgepointe Technologies and Cystems Logic.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bridgepointe-technologies-vs-cystems-logic#article",
  "headline": "Bridgepointe Technologies vs Cystems Logic: Comparison",
  "description": "Detailed comparison of Bridgepointe Technologies and Cystems Logic. Features, pricing, and integrations compared side-by-side.",
