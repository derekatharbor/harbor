...
// Comparing: Bitwarden vs NordPass

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Bitwarden vs NordPass (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Bitwarden and NordPass. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Bitwarden vs NordPass',
    description: 'Detailed comparison of Bitwarden and NordPass.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/bitwarden-vs-nordpass#article",
  "headline": "Bitwarden vs NordPass: Comparison",
  "description": "Detailed comparison of Bitwarden and NordPass. Features, pricing, and integrations compared side-by-side.",
