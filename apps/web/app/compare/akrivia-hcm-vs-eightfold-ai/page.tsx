...
// Generated: 2025-11-30T20:05:20.406Z
// Comparing: Akrivia HCM vs Eightfold AI

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Akrivia HCM vs Eightfold AI (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Akrivia HCM and Eightfold AI. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Akrivia HCM vs Eightfold AI',
    description: 'Detailed comparison of Akrivia HCM and Eightfold AI.',
    type: 'article',
    publishedTime: '2025-11-30T20:05:20.406Z',
    modifiedTime: '2025-11-30T20:05:20.406Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/akrivia-hcm-vs-eightfold-ai#article",
  "headline": "Akrivia HCM vs Eightfold AI: Comparison",
  "description": "Detailed comparison of Akrivia HCM and Eightfold AI. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T20:05:20.406Z",
  "dateModified": "2025-11-30T20:05:20.406Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
...
const brand2 = {
  ...
  "features": [
    ...
    "AI Interviewer for candidate screening",
    "Talent tracking system",
    "Project staffing acceleration",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T20:05:20.406Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T20:05:20.406Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
