...
// Comparing: Formerly Known as GBH Communications vs Nectar Services Corp.

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Formerly Known as GBH Communications vs Nectar Services Corp. (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Formerly Known as GBH Communications and Nectar Services Corp.. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Formerly Known as GBH Communications vs Nectar Services Corp.',
    description: 'Detailed comparison of Formerly Known as GBH Communications and Nectar Services Corp..',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/formerly-known-as-gbh-communications-vs-nectar-services-corp#article",
  "headline": "Formerly Known as GBH Communications vs Nectar Services Corp.: Comparison",
  "description": "Detailed comparison of Formerly Known as GBH Communications and Nectar Services Corp.. Features, pricing, and integrations compared side-by-side.",
