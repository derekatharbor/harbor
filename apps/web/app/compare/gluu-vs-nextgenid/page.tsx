...
// Comparing: Gluu vs NextgenID

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Gluu vs NextgenID (November 30, 2025) | Harbor',
  description: 'Detailed comparison of Gluu and NextgenID. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'Gluu vs NextgenID',
    description: 'Detailed comparison of Gluu and NextgenID.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/gluu-vs-nextgenid#article",
  "headline": "Gluu vs NextgenID: Comparison",
  "description": "Detailed comparison of Gluu and NextgenID. Features, pricing, and integrations compared side-by-side.",
