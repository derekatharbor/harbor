...
// Generated: 2025-11-30T19:36:57.407Z
// Comparing: AIDS Healthcare Foundation vs University of Maryland Baltimore Washington Medical Center

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'AIDS Healthcare Foundation vs University of Maryland Baltimore Washington Medical Center (November 30, 2025) | Harbor',
  description: 'Detailed comparison of AIDS Healthcare Foundation and University of Maryland Baltimore Washington Medical Center. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'AIDS Healthcare Foundation vs University of Maryland Baltimore Washington Medical Center',
    description: 'Detailed comparison of AIDS Healthcare Foundation and University of Maryland Baltimore Washington Medical Center.',
    type: 'article',
    publishedTime: '2025-11-30T19:36:57.407Z',
    modifiedTime: '2025-11-30T19:36:57.407Z',
  },
}
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/aids-healthcare-foundation-vs-university-of-maryland-baltimore-washington-medical-center#article",
  "headline": "AIDS Healthcare Foundation vs University of Maryland Baltimore Washington Medical Center: Comparison",
  "description": "Detailed comparison of AIDS Healthcare Foundation and University of Maryland Baltimore Washington Medical Center. Features, pricing, and integrations compared side-by-side.",
  "datePublished": "2025-11-30T19:36:57.407Z",
  "dateModified": "2025-11-30T19:36:57.407Z",
  "author": {
    "@type": "Organization",
    "name": "Harbor",
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <header className="mb-12 text-center">
            <p className="text-sm text-gray-400 mb-2">
              Last verified: <time dateTime="2025-11-30T19:36:57.407Z">November 30, 2025</time>
            </p>
          ...
          <footer className="mt-12 pt-8 border-t border-white/10 text-center text-gray-400 text-sm">
            <p>
              ...
              <br />
              Last verified: <time dateTime="2025-11-30T19:36:57.407Z">2025-11-30</time>
            </p>
          </footer>
        </div>
      </main>
