...
// Comparing: 3Insys vs Workato

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: '3Insys vs Workato (November 30, 2025) | Harbor',
  description: 'Detailed comparison of 3Insys and Workato. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: '3Insys vs Workato',
    description: 'Detailed comparison of 3Insys and Workato.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/3insys-vs-workato#article",
  "headline": "3Insys vs Workato: Comparison",
  "description": "Detailed comparison of 3Insys and Workato. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "3Insys",
      "url": "https://useharbor.io/brands/3insys"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Workato",
      "url": "https://useharbor.io/brands/workato"
    }
  ]
}
...
const brand1 = {
  ...
  "summary": "A technology solutions company focused on integration and automation for utilities.",
  "pricing": {
    "price_model": "custom",
    "price_notes": null,
    "has_free_tier": false,
...
const brand2 = {
  ...
  "domain": "workato.com",
  "category": "Integration Platform as a Service (iPaaS)",
  "summary": "The leading integration platform as a service (iPaaS) designed for the AI and Agentic Era.",
  "pricing": {
    "price_model": "unknown",
    "price_notes": null,
    "has_free_tier": false,
