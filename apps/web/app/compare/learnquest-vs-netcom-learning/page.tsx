...
// Comparing: LearnQuest vs NetCom Learning®

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'LearnQuest vs NetCom Learning® (November 30, 2025) | Harbor',
  description: 'Detailed comparison of LearnQuest and NetCom Learning®. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'LearnQuest vs NetCom Learning®',
    description: 'Detailed comparison of LearnQuest and NetCom Learning®.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/learnquest-vs-netcom-learning#article",
  "headline": "LearnQuest vs NetCom Learning®: Comparison",
  "description": "Detailed comparison of LearnQuest and NetCom Learning®. Features, pricing, and integrations compared side-by-side.",
