...
// Comparing: IndicaOnline POS Software vs Slice

import { Metadata } from 'next'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'IndicaOnline POS Software vs Slice (November 30, 2025) | Harbor',
  description: 'Detailed comparison of IndicaOnline POS Software and Slice. Features, pricing, and integrations compared side-by-side.',
  openGraph: {
    title: 'IndicaOnline POS Software vs Slice',
    description: 'Detailed comparison of IndicaOnline POS Software and Slice.',
    type: 'article',
...
const schemaOrg = {
  ...
  "@type": "Article",
  "@id": "https://useharbor.io/compare/indicaonline-pos-software-vs-slice#article",
  "headline": "IndicaOnline POS Software vs Slice: Comparison",
  "description": "Detailed comparison of IndicaOnline POS Software and Slice. Features, pricing, and integrations compared side-by-side.",
  ...
  "about": [
    {
      ...
      "name": "IndicaOnline POS Software",
      "url": "https://useharbor.io/brands/indicaonline-pos-software"
    },
    {
      "@type": "SoftwareApplication",
      "name": "Slice",
      "url": "https://useharbor.io/brands/slice"
    }
  ]
}

const brand1 = {
  "slug": "indicaonline-pos-software",
  "brand_name": "IndicaOnline POS Software",
  "domain": "indicaonline.com",
  "category": "Point of Sale (POS)",
  "summary": "A comprehensive cannabis software solution for dispensaries.",
  "pricing": {
    "price_model": "flat",
    "price_notes": "Pricing varies based on selected plan and billing frequency.",
    "has_free_tier": true,
    "starting_price": "$208.80/mo"
  },
  "features": [
    "Customer Management",
    "Inventory Management",
    "Metrc Two-Way Integration",
    "Purchasing Limits",
    "Customer Loyalty (Bonus Points)",
    "Offline Mode",
    "IndicaOnline Business Intelligence Tool",
    "E-commerce & Custom eCommerce App",
    "Digital Signage TV Menu",
    "Fleet Control Panel"
  ],
  "integrations": [
    "Springbig",
...
const brand2 = {
  ...
  "domain": "slice.com",
  "category": "Point of Sale (POS)",
  "summary": "Slice empowers independent pizzerias with technology, marketing, and support.",
  "pricing": {
    "price_model": "usage",
    "price_notes": "3% of order volume for Family Membership",
    "has_free_tier": false,
  ...
  "features": [
    ...
    "Discounted premium pizza supplies"
  ],
  "integrations": [
    "Chowly"
  ]
