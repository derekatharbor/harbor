      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-64 flex flex-col justify-center lg:border-l lg:border-white/5 lg:pl-8">
          ...
          <button
            onClick={onRescan}
            disabled={rescanning}
            className="px-6 py-3 rounded-lg bg-[#2DD4BF] hover:bg-[#2DD4BF]/90 text-[#0C1422] font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
