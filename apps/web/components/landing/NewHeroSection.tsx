      ...
      */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-48 pb-24 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          <a
            href="/brands"
            className="inline-flex items-center justify-center px-8 py-4 rounded-lg bg-white text-[#101A31] text-lg font-semibold hover:bg-white/85 transition-colors duration-200"
          >
          ...
          <a
            href="#how-it-works"
            className="inline-flex items-center justify-center px-8 py-4 rounded-lg border-2 border-white/30 text-white text-lg font-semibold hover:bg-white/10 hover:border-white/50 transition-colors duration-200"
          >
            Learn more
          </a>
        </div>
        ...
        <div className="mt-16 flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
          ...
          <div className="flex items-center gap-6">
            <span className="text-white/70 text-sm font-medium">ChatGPT</span>
            <span className="text-white/70 text-sm font-medium">Claude</span>
            <span className="text-white/70 text-sm font-medium">Gemini</span>
            <span className="text-white/70 text-sm font-medium">Perplexity</span>
          </div>
        </div>
      </div>
    </section>
